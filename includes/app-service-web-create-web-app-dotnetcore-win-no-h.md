...
En Cloud Shell, puede usar el comando [`az webapp create`](/cli/azure/webapp#az-webapp-create). En el siguiente ejemplo, reemplace `<app-name>` por un nombre único global de aplicación (los caracteres válidos son `a-z`, `0-9` y `-`). 
