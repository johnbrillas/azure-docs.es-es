...
ms.locfileid: "97820586"
---
## <a name="request-and-response-json"></a>JSON de solicitud y respuesta

Una pregunta con formato JSON de ejemplo de la API REST:
...
La pregunta incluye una propiedad que devuelve las tres respuestas principales. 

La respuesta se devuelve en un objeto JSON:
