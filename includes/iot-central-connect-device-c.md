...
ms.locfileid: "97033908"
---
## <a name="prerequisites"></a>Requisitos previos

Para completar los pasos de este artículo, necesita una aplicación de Azure IoT Central creada con la plantilla **Aplicación personalizada**. Para más información, consulte la [guía de inicio rápido para crear una aplicación](../articles/iot-central/core/quick-deploy-iot-central.md). La aplicación se debe haber creado el 14 de julio de 2020 o después.
...
En la copia del SDK de IoT de Microsoft Azure para C que descargó anteriormente, abra el archivo *azure-iot-sdk-c/iothub_client/samples/pnp/pnp_simple_thermostat/pnp_simple_thermostat.c* en un editor de texto.
...
La función `main` llama primero a `CreateAndConfigureDeviceClientHandleForPnP` para:

* Establecer el identificador del modelo `dtmi:com:example:Thermostat;1`. IoT Central usa el identificador de modelo para identificar o generar la plantilla de dispositivo específico. Para más información, consulte [¿Cómo se asocia un dispositivo a una plantilla de dispositivo?](../articles/iot-central/core/concepts-get-connected.md#associate-a-device-with-a-device-template)
...
La función `Thermostat_SendCurrentTemperature` muestra cómo el dispositivo envía la telemetría de temperatura a IoT Central:
...
La función `SendMaxTemperatureSinceReboot` envía una actualización de la propiedad `maxTempSinceLastReboot` a IoT Central:
...
La función `Thermostat_DeviceTwinCallback` controla las actualizaciones de las propiedades de escritura de IoT Central:
...
La función `Thermostat_DeviceMethodCallback` controla los comandos a los que se llama desde IoT Central:
