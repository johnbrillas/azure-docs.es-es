...
- [Área de trabajo de Azure Synapse](../get-started-create-workspace.md): necesaria para crear la base de datos, el origen de datos externo y la vista.
