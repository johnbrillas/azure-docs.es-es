...
1. En el centro de conectividad **Data** (Datos), haga clic en **Add a new resource** (Agregar un recurso) (botón con el signo más encima de **Linked** [Vinculados]) >> **Browse gallery** (Examinar la galería). 
