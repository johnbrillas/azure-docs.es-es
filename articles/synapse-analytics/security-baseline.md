...
* [Configuración de parámetros de retención de registros de un área de trabajo de Log Analytics](../azure-monitor/logs/manage-cost-storage.md#change-the-data-retention-period)
