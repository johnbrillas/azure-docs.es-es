...
Puede automatizar otras tareas de administración, por ejemplo, [administrar cuentas de usuario de Azure AD B2C con Microsoft Graph](microsoft-graph-operations.md).