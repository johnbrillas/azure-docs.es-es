...
Implemente el [código de la API](https://github.com/azure-ad-b2c/partner-integrations/tree/master/samples/Jumio/API/Jumio.Api) proporcionado en un servicio de Azure. El código se puede publicar desde Visual Studio. Para hacerlo, siga [estas instrucciones](/visualstudio/deployment/quickstart-deploy-to-azure).
