...
Una directiva personalizada es totalmente configurable y se controla mediante directivas. Una directiva personalizada orquesta la confianza entre entidades en formatos de protocolo estándar, como OpenID Connect, OAuth o SAML, y algunos no estándar, como intercambios de notificaciones de sistema a sistema basados en API REST. El marco crea experiencias propias fáciles de usar.
...
1. Incorporación de las [claves de directiva](custom-policy-get-started.md#add-signing-and-encryption-keys) y [Registro de las aplicaciones de Identity Experience Framework](custom-policy-get-started.md#register-identity-experience-framework-applications).
...
1. Después de cargar el paquete de inicio, realice una [prueba de la directiva de registro o de inicio de sesión](custom-policy-get-started.md#test-the-custom-policy).
