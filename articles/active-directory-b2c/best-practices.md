...
| Más información acerca de cómo solucionar problemas de Azure AD B2C | Obtenga información acerca de cómo [solucionar problemas de las directivas personalizadas](./troubleshoot-custom-policies.md?tabs=applications) durante el desarrollo. Obtenga información sobre el aspecto de un flujo de autenticación normal y use herramientas para detectar anomalías y errores. Por ejemplo, use [Application Insights](troubleshoot-with-application-insights.md) para revisar los registros de salida de los recorridos del usuario. |
...
| Uso de Microsoft Graph API para automatizar la administración de los inquilinos de B2C | Microsoft Graph API:<br/>Administre [Identity Experience Framework](/graph/api/resources/trustframeworkpolicy?preserve-view=true&view=graph-rest-beta) (directivas personalizadas).<br/>[Claves](/graph/api/resources/trustframeworkkeyset?preserve-view=true&view=graph-rest-beta)<br/>[Flujos de usuario](/graph/api/resources/identityuserflow?preserve-view=true&view=graph-rest-beta) |
...
| Configuración de supervisión y alertas activas | [Siga el comportamiento del usuario](./analytics-with-application-insights.md) en Azure AD B2C mediante Application Insights. |

## <a name="support-and-status-updates"></a>Actualizaciones de compatibilidad y estado
## <a name="todays-support-and-status-updates"></a>Actualizaciones de compatibilidad y estado recientes
