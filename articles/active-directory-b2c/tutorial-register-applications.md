...
En el caso de una aplicación web, debe crear un secreto de aplicación. La aplicación usará este secreto para intercambiar un código de autorización por un token de acceso.
