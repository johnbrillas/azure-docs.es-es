...
Una clase [ObjectModel](https://docs.microsoft.com/dotnet/api/microsoft.azure.objectanchors.objectmodel) representa la geometría de un objeto físico y codifica los parámetros necesarios para la detección y la estimación de la posición. Debe crearse mediante el [servicio Object Anchors](../quickstarts/get-started-model-ingestion.md). Después, una aplicación puede cargar el archivo de modelo generado mediante la API de Object Anchors y consultar la malla insertada en ese modelo para su visualización.
...
A continuación, la aplicación crea un observador de objetos y carga los modelos necesarios generados por el [servicio de ingesta de Object Anchors](../quickstarts/get-started-model-ingestion.md).
