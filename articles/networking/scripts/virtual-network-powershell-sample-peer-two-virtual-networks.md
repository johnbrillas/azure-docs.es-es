...
description: Cree y conecte dos redes virtuales en la misma región. Use el script de Azure para dos redes virtuales del mismo nivel para conectar las redes a través de Azure.
