...
1. Registre su suscripción de Azure con un proveedor de recursos mediante la [operación de registro con la API REST de Resource Manager](/rest/api/resources/providers). El nombre del proveedor para el servicio Azure Scheduler es **Microsoft.Scheduler**. 

1. Cree una colección de trabajos mediante la [operación de creación o actualización para colecciones de trabajos](/rest/api/scheduler/jobcollections) de la API REST de Scheduler. 

1. Cree un trabajo mediante la [operación de creación o actualización para trabajos](/rest/api/scheduler/jobs/createorupdate). 
