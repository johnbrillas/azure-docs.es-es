...
1. Antes de implementar el proyecto en una aplicación de funciones en Azure, debe [iniciar sesión con la CLI de Azure](/cli/azure/authenticate-azure-cli?view=azure-cli-latest).
