...
- Azure Database for MySQL es compatible con:
  ...
  - Motor de InnoDB
- Migración de la misma versión. No se admite la migración de MySQL 5.6 a Azure Database for MySQL 5.7. No se admiten migraciones con MySQL 8.0 como origen o destino.
