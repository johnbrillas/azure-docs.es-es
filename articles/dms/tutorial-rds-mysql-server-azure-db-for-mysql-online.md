...
* Asegurarse de que el servidor de origen de MySQL ejecuta una edición de comunidad de MySQL admitida. Para determinar la versión de la instancia de MySQL, en la utilidad mysql o en MySQL Workbench, ejecute el comando:
    ...
    Para más información, consulte [Versiones admitidas de servidores de Azure Database for MySQL](../mysql/concepts-supported-versions.md).
...
5. Una vez que el grupo de parámetros esté en el lugar correspondiente, conéctese a la instancia de MySQL y [establezca la retención del registro del rango](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/mysql_rds_set_configuration.html#mysql_rds_set_configuration-usage-notes.binlog-retention-hours) en al menos cinco días.
```
