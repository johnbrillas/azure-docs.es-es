...
Para permitir el acceso a una única dirección IP, proporcione la misma dirección en `--start-ip-address` y `--end-ip-address`, como en el ejemplo y reemplace la IP especificada por la suya.
```azurecli-interactive
