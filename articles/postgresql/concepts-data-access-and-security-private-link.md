...
Configure la [conexión de la puerta de enlace de VPN entre redes virtuales](../vpn-gateway/vpn-gateway-howto-vnet-vnet-resource-manager-portal.md) para establecer conectividad con una instancia de Azure Database for PostgreSQL: servidor único desde una máquina virtual de Azure de otra región o suscripción.
...
* Para configurar un firewall para Azure Database for PostgreSQL: servidor único, consulte [Compatibilidad del firewall](./concepts-firewall-rules.md).

* Para aprender a configurar un punto de conexión de servicio de red virtual para su instancia de Azure Database for PostgreSQL: servidor único, consulte [Configuración del acceso desde redes virtuales](./concepts-data-access-and-security-vnet.md).

* Para información general sobre la conectividad de Azure Database for PostgreSQL: servidor único, consulte [Arquitectura de la conectividad de Azure Database for PostgreSQL](./concepts-connectivity-architecture.md)
