---
title: 'Inicio rápido: Uso de Java y JDBC con Servidor flexible de Azure Database for PostgreSQL'
description: En esta guía de inicio rápido, aprenderá a usar Java y JDBC con un Servidor flexible de Azure Database for PostgreSQL.
author: mksuni
ms.author: sumuth
...
ms.locfileid: "98606014"
---
# <a name="quickstart-use-java-and-jdbc-with-azure-database-for-postgresql-flexible-server"></a>Inicio rápido: Uso de Java y JDBC con Servidor flexible de Azure Database for PostgreSQL

En este tema se muestra cómo crear una aplicación de ejemplo que utiliza Java y [JDBC](https://en.wikipedia.org/wiki/Java_Database_Connectivity) para almacenar y recuperar información de [Servidor flexible de Azure Database for PostgreSQL](./index.yml).
...
- Un [kit de desarrollo de Java](/azure/developer/java/fundamentals/java-jdk-long-term-support) compatible, versión 8 (incluido en Azure Cloud Shell).
...
> [!NOTE]
> Puede leer información más detallada sobre la creación de servidores de PostgreSQL en [Creación de un servidor de Azure Database for PostgreSQL mediante Azure Portal](./quickstart-create-server-portal.md).
...
El servidor PostgreSQL que creó anteriormente tiene una base de datos **postgres** vacía. Para esta guía de inicio rápido, vamos a crear una nueva base de datos llamada `demo` con estos pasos:

1. Instale la instancia local de [psql](https://www.postgresql.org/docs/current/static/app-psql.html) para conectarse a un servidor PostgreSQL de Azure. 
2. Ejecute el siguiente comando psql para conectarse a la base de datos **postgres** en el servidor PostgreSQL.
...
3. Escriba el comando siguiente en el símbolo del sistema para crear una nueva base de datos llamada **demo**:
