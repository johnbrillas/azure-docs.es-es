---
title: Copia de seguridad y restauración con la CLI de Azure en Azure Database for PostgreSQL con un único servidor
description: Aprenda a configurar la copia de seguridad y a restaurar un servidor en Azure Database for PostgreSQL con un único servidor mediante la CLI de Azure.
author: sr-msft
ms.author: srranga
...
ms.locfileid: "94659580"
---
# <a name="how-to-back-up-and-restore-a-server-in-azure-database-for-postgresql---single-server-using-the-azure-cli"></a>Copia de seguridad y restauración de un servidor de Azure Database for PostgreSQL con un único servidor mediante la CLI de Azure
...
- Necesita un [servidor y una base de datos de Azure Database for PostgreSQL](quickstart-create-server-database-azure-cli.md).
...
Para restaurar el servidor, utilice el comando [az postgres server restore](/cli/azure/postgres/server) de la CLI de Azure.
