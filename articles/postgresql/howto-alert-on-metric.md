...
10. Configure el tipo de acción **Correo electrónico/SMS/Push/Voz**.
    ...
    :::image type="content" source="./media/howto-alert-on-metric/10-action-group-type.png" alt-text="Captura de pantalla que muestra cómo agregar un nuevo grupo de acciones.":::
