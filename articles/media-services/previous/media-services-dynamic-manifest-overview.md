...
* Puede usar el mismo nombre de filtro para los filtros globales y locales. Los filtros locales tienen una mayor prioridad e invalidarán los filtros globales.
