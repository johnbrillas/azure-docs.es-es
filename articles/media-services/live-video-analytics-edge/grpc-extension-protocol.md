...
ms.locfileid: "97401634"
---
# <a name="grpc-extension-protocol"></a>Protocolo de la extensión gRPC

Live Video Analytics en IoT Edge permite ampliar las funcionalidades de procesamiento de grafos multimedia mediante un [nodo de extensión de grafos](https://review.docs.microsoft.com/en-us/azure/media-services/live-video-analytics-edge/media-graph-extension-concept?branch=release-lva-dec-update). Si usa el procesador de extensiones gRPC como nodo de extensión, la comunicación entre el módulo de Live Video Analytics y su módulo de IA o CV se realiza a través de un protocolo estructurado de alto rendimiento basado en gRPC.
