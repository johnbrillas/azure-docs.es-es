...
Puede utilizar Media Encoder Standard para generar una o varias miniaturas de la entrada de vídeo en los formatos de archivo de imagen [JPEG](https://en.wikipedia.org/wiki/JPEG) o [PNG](https://en.wikipedia.org/wiki/Portable_Network_Graphics).
