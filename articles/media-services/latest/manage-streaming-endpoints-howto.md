---
title: Administración de puntos de conexión de streaming
...
Para más información, consulte [az ams streaming-endpoint start](/cli/azure/ams/streaming-endpoint#az-ams-streaming-endpoint-start).
