...
Para obtener información detallada, consulte [Métricas de Azure Monitor](../../azure-monitor/data-platform.md) y [Registros de diagnóstico de Azure Monitor](../../azure-monitor/essentials/platform-logs-overview.md).
