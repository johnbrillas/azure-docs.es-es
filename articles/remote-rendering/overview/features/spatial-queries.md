...
* [RenderingConnection.RayCastQueryAsync() de C#](/dotnet/api/microsoft.azure.remoterendering.renderingconnection.raycastqueryasync)
* [RenderingConnection::RayCastQueryAsync() de C++](/cpp/api/remote-rendering/renderingconnection#raycastqueryasync)
