...
ms.locfileid: "102562918"
---
# <a name="quickstart-create-an-azure-private-endpoint-using-azure-powershell"></a>Inicio rápido: Creación de un punto de conexión privado de Azure mediante Azure PowerShell
