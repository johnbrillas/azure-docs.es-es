...
![Captura de pantalla que muestra la página "Reglas de pertenencia dinámica" con la acción "Agregar expresión" en la pestaña "Configurar reglas" seleccionada.](./media/groups-create-rule/update-dynamic-group-rule.png)
