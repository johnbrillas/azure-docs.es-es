...
1. Haga clic en **modificar permisos**.
    ...
    ![Captura de pantalla que muestra la página "Explorador de gráficos" con la acción "Modificar permisos" seleccionada.](./media/pim-apis/graph-explorer.png)
