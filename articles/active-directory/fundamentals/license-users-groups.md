...
1. Seleccione **Todos los productos** para ver la página **Todos los productos** y ver los números en **Asignado**, **Disponible** y **Expira próximamente** para los planes de licencias.
    ...
    > - Asignado: número de licencias asignadas a los usuarios
    > - Disponible: número de licencias disponibles para su asignación, incluidas las que expiran en breve
    > - Expira próximamente: número de licencias que expiran pronto
