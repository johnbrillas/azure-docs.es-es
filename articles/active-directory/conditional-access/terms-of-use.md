...
- Requerir a empleados o invitados que acepten sus términos de uso antes de registrar información de seguridad en Azure AD Multi-Factor Authentication (MFA).
