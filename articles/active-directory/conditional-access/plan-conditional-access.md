...
* [Cómo incluir o excluir usuarios de las directivas de acceso condicional](https://youtu.be/5DsW1hB3Jqs)
...
[Administración de directivas de acceso condicional con Microsoft Graph API](/graph/api/resources/conditionalaccesspolicy)
