...
1. En la página **Nuevo grupo**, en **Tipo de grupo**, seleccione **Seguridad**. Escriba los valores para **Nombre del grupo** y **Descripción del grupo** del nuevo grupo. 
