...
![Aprovisionamiento de objetos](media/concept-attributes/attribute-1.png)
...
> [!WARNING]
> La configuración de la sincronización en la nube crea una entidad de servicio. La entidad de servicio está visible en Azure Portal. No debe modificar las asignaciones de atributo mediante la experiencia de la entidad de servicio en Azure Portal.  Esto no se admite.
...
1. Esta consulta devuelve el esquema.
   ...
   ![Esquema devuelto](media/concept-attributes/schema-1.png)
