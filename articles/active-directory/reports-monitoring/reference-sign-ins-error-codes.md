...
Cuando se produce un error en un inicio de sesión, aparece un código de error correspondiente al problema. [Búsqueda de la descripción de un código de error](https://login.microsoftonline.com/error).
