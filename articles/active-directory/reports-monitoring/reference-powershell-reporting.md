...
ms.locfileid: "102558090"
---
# <a name="azure-ad-powershell-cmdlets-for-reporting"></a>Cmdlets de Azure AD PowerShell para informes

> [!NOTE] 
> En la actualidad, estos cmdlets de PowerShell solo funcionan con el módulo de la [versión preliminar de Azure AD](/powershell/module/azuread/?view=azureadps-2.0-preview&preserve-view=true#directory_auditing). Tenga en cuenta que no se recomienda utilizar el módulo de la versión preliminar para producción. 
