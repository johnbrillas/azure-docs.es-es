...
1. Seleccione **Organizaciones** en el panel de navegación izquierdo o seleccione el vínculo **Administrar organizaciones** en el bloque **Organizaciones**.

    ![Página Mi cuenta, con vínculos de Organizaciones resaltados](media/my-account-portal/my-account-portal-organizations.png)

1. Revise la información de la **organización principal**.

    ![Página Organizaciones](media/my-account-portal/my-account-portal-organization-page.png)

1. Revise las otras organizaciones, asegurándose de que reconoce todas las organizaciones a las que tiene acceso.
