...
Cuando esté conforme con los resultados del ciclo inicial de los usuarios de prueba, inicie las [actualizaciones incrementales](../app-provisioning/how-provisioning-works.md#incremental-cycles).
