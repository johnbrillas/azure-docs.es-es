...
1. Haga clic en **Inicio de sesión único** en Manage your SmartDraw License (Administrar su licencia de SmartDraw).
    ...
    ![Captura de pantalla que muestra el cuadro de diálogo para administrar la licencia de SmartDraw, donde puede seleccionar la opción de inicio de sesión único.](./media/smartdraw-tutorial/configure01.png)

1. En la página Configuración, siga estos pasos:

    ![Captura de pantalla que muestra la página de configuración, donde puede especificar los valores descritos.](./media/smartdraw-tutorial/configure02.png)
