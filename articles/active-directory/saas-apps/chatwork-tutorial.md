...
Para configurar y probar el inicio de sesión único de Azure AD con Chatwork, es preciso completar los siguientes bloques de creación:
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de aplicaciones de **Chatwork**, busque la sección **Administrar** y seleccione **Inicio de sesión único**.
...
Al hacer clic en el icono de Chatwork en el Panel de acceso, debería iniciar sesión automáticamente en la versión de Chatwork para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
...
- [Pruebe Chatwork con Azure AD](https://aad.portal.azure.com/)

- [¿Qué es el control de sesiones en Microsoft Cloud App Security?](/cloud-app-security/proxy-intro-aad)

- [Procedimiento para proteger Chatwork con controles y visibilidad avanzados](/cloud-app-security/proxy-intro-aad)