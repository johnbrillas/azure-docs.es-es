...
> * [Inicio de sesión único](./mixpanel-tutorial.md) en Mixpanel (recomendado)
...
3. Determine qué datos se [asignarán entre Azure AD y Mixpanel](../app-provisioning/customize-application-attributes.md). 
