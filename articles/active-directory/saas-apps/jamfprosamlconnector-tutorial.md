...
1. En Azure Portal, en la página de integración de la aplicación **Jamf Pro**, busque la sección **Administrar** y seleccione **Inicio de sesión único**.
...
* Haga clic en **Probar esta aplicación** en Azure Portal. Esta acción le redirigirá a la dirección URL de inicio de sesión de Jamf Pro, donde puede iniciar el flujo de inicio de sesión.  
...
* Haga clic en **Probar esta aplicación** en Azure Portal; debería iniciar sesión automáticamente en la instancia de Jamf Pro para la que configuró el inicio de sesión único. 
