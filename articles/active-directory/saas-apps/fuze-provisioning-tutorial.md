...
> * [Inicio de sesión único](./fuze-tutorial.md) en Fuze (recomendado)
...
3. Determine qué datos quiere [asignar entre Azure AD y Fuze](../app-provisioning/customize-application-attributes.md). 
