...
* Una vez configurado Airtable, puede aplicar el control de sesión, que protege la filtración y la infiltración de la información confidencial de la organización en tiempo real. El control de sesión procede del acceso condicional. [Aprenda a aplicar el control de sesión con Microsoft Cloud App Security](/cloud-app-security/proxy-deployment-any-app).

> [!NOTE]
> El identificador de esta aplicación es un valor de cadena fijo, por lo que solo se puede configurar una instancia en un inquilino.

## <a name="adding-airtable-from-the-gallery"></a>Adición de Airtable desde la galería
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-airtable"></a>Configuración y prueba del inicio de sesión único de Azure AD para Airtable
...
Para configurar y probar el inicio de sesión único de Azure AD con Airtable, es preciso completar los siguientes bloques de creación:
...
1. **[Configuración del inicio de sesión único en Airtable](#configure-airtable-sso)**: para configurar los valores de inicio de sesión único en la aplicación.
    * **[Creación de un usuario de prueba de Airtable](#create-airtable-test-user)**: para tener un homólogo de B.Simon en Airtable que esté vinculado a la representación del usuario en Azure AD.
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de la aplicación **Airtable**, busque la sección **Administrar** y seleccione **Inicio de sesión único**.
...
1. En la sección **Configuración básica de SAML**, el usuario no tiene que realizar ningún paso porque la aplicación ya se ha integrado previamente con Azure.
    ...
    ![Información sobre dominio y direcciones URL de inicio de sesión único de Airtable](common/preintegrated.png)

1. Haga clic en **Establecer direcciones URL adicionales** y siga este paso si desea configurar la aplicación en el modo iniciado por **SP**:

    En el cuadro de texto **URL de inicio de sesión**, escriba una dirección URL: `https://airtable.com/sso/login`
...
Al hacer clic en el icono de Airtable en el panel de acceso, debería iniciar sesión automáticamente en la instancia de Airtable para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
...
- [Prueba de Airtable con Azure AD](https://aad.portal.azure.com/)