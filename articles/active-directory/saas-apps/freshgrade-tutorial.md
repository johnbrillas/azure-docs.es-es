...
En esta sección, creará un usuario llamado Britta Simon en FreshGrade. Trabaje con el [equipo de soporte técnico de FreshGrade](mailto:support@freshgrade.com) para agregar los usuarios a la plataforma de FreshGrade. Los usuarios se tienen que crear y activar antes de usar el inicio de sesión único.
