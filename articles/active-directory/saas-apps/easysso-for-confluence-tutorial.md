...
## <a name="configure-and-test-azure-ad-sso-for-easysso-for-confluence"></a>Configuración y prueba del inicio de sesión único de Azure AD para Confluence
...
Para configurar y probar el inicio de sesión único de Azure AD con Confluence, complete los siguientes pasos:
...
1. En Azure Portal, en la página de integración de aplicaciones de **EasySSO for Confluence**, busque la sección **Administrar** y seleccione **Inicio de sesión único**.
...
1. Para automatizar la configuración en EasySSO for Confluence, debe instalar la **extensión del explorador de inicio de sesión seguro de Mis aplicaciones**. Para ello, haga clic en **Instalar la extensión**.

    ![Extensión Mis aplicaciones](common/install-myappssecure-extension.png)

2. Después de agregar la extensión al explorador, haga clic en **Configurar EasySSO for Confluence** para ir a la aplicación. Desde ahí, especifique las credenciales de administrador para iniciar sesión en Confluence. La extensión de explorador configurará automáticamente la aplicación y automatizará los pasos del 3 al 9.

    ![Configuración](common/setup-sso.png)

1. Si desea configurar EasySSO para Confluence manualmente, inicie sesión en la instancia de Atlassian Confluence con privilegios de administrador y vaya a la sección **Administración de aplicaciones**. 
...
Una vez que haya configurado EasySSO for Confluence, puede aplicar el control de sesión, que protege su organización en tiempo real frente a la filtración e infiltración de información confidencial. El control de sesión procede del acceso condicional. [Aprenda a aplicar el control de sesión con Microsoft Cloud App Security](/cloud-app-security/proxy-deployment-any-app).