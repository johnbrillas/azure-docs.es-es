...
![Captura de pantalla que muestra la sección IT (TI) con Membership type (Tipo de pertenencia), Source (Origen), Type (Tipo) y Object ID (Id. de objeto).](./media/bomgarremotesupport-tutorial/config-user-2.png)
