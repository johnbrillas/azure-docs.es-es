...
> * [Inicio de sesión único](./coda-tutorial.md) en Coda (recomendado)
...
3. Determine qué datos quiere [asignar entre Azure AD y Coda](../app-provisioning/customize-application-attributes.md).
