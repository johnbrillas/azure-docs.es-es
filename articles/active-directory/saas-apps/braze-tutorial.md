---
title: 'Tutorial: Integración del inicio de sesión único (SSO) de Azure Active Directory con Braze | Microsoft Docs'
...
En este tutorial, aprenderá a integrar Braze con Azure Active Directory (Azure AD). Al integrar Braze con Azure AD, puede hacer lo siguiente:

* Controlar en Azure AD quién tiene acceso a Braze.
* Permitir que los usuarios puedan iniciar sesión automáticamente en Braze con sus cuentas de Azure AD.
...
* Suscripción habilitada para el inicio de sesión único (SSO) en Braze.
...
Configure y pruebe el inicio de sesión único de Azure AD con Braze mediante un usuario de prueba llamado **B.Simon**. Para que el inicio de sesión único funcione, es preciso establecer una relación de vinculación entre un usuario de Azure AD y el usuario relacionado de Braze.
...
1. **[Configuración del inicio de sesión único en Braze](#configure-braze-sso)** , para configurar los valores de Inicio de sesión único en la aplicación.
    * **[Creación de un usuario de prueba de Braze](#create-braze-test-user)** , para tener un homólogo de B. Simon en Braze que esté vinculado a la representación del usuario en Azure AD.
...
1. La aplicación Braze espera las aserciones de SAML en un formato específico, que requiere que se agreguen asignaciones de atributos personalizados a la configuración de los atributos del token de SAML. La siguiente captura de muestra la lista de atributos predeterminados.

    ![imagen](common/default-attributes.png)

1. Además de lo anterior, la aplicación Braze espera que se devuelvan algunos atributos más, que se muestran a continuación, en la respuesta de SAML. Estos atributos también se rellenan previamente, pero puede revisarlos según sus requisitos.
...
En esta sección, va a permitir que B.Simon acceda a Braze mediante el inicio de sesión único de Azure.

1. En Azure Portal, seleccione sucesivamente **Aplicaciones empresariales** y **Todas las aplicaciones**.
1. En la lista de aplicaciones, seleccione **Braze**.
...
En esta sección, creará un usuario llamado B.Simon en Braze. Trabaje con el [equipo de soporte técnico de Braze](mailto:support@braze.com) para agregar los usuarios a la plataforma de Braze. Los usuarios se tienen que crear y activar antes de usar el inicio de sesión único.

## <a name="test-sso"></a>Prueba de SSO

En esta sección, probará la configuración de inicio de sesión único de Azure AD mediante el Panel de acceso.

Al hacer clic en el icono de Braze en el panel de acceso, debería iniciar sesión automáticamente en la versión de Braze para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
...
- [Pruebe Braze con Azure AD](https://aad.portal.azure.com/)