...
* Suscripción de Cerner Central con el inicio de sesión único habilitado
...
* Cerner Central admite el [**aprovisionamiento** automático de usuarios](cernercentral-provisioning-tutorial.md).
...
4. En el cuadro de búsqueda, escriba **Cerner Central**, seleccione **Cerner Central** en el panel de resultados y luego haga clic en el botón **Agregar** para agregar la aplicación.

    ![Cerner Central en la lista de resultados](common/search-new-app.png)
...
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de Cerner Central.
...
2. **[Configuración del inicio de sesión único de Cerner Central](#configure-cerner-central-single-sign-on)**: para configurar los valores de inicio de sesión único en la aplicación.
3. **[Creación de un usuario de prueba de Azure AD](#create-an-azure-ad-test-user)** , para probar el inicio de sesión único de Azure AD con Britta Simon.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)** , para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Creación de un usuario de prueba de Cerner Central](#create-cerner-central-test-user)**: para tener un homólogo de Britta Simon en Cerner Central que esté vinculado a la representación del usuario en Azure AD.
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de la aplicación **Cerner Central**, seleccione **Inicio de sesión único**.
...
4. En la página **Configurar inicio de sesión único con SAML** realice los siguientes pasos:
    ...
    ![Información sobre dominio y direcciones URL de inicio de sesión único de Cerner Central](common/idp-intiated.png)
...
### <a name="configure-cerner-central-single-sign-on"></a>Configuración del inicio de sesión único de Cerner Central
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones** y **Cerner Central**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **Cerner Central**.

    ![Vínculo a Cerner Central en la lista de aplicaciones](common/all-applications.png)
...
Al hacer clic en el icono de Cerner Central en el panel de acceso, debería iniciar sesión automáticamente en la versión de Cerner Central para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
