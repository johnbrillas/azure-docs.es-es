...
ms.locfileid: "100560053"
---
# <a name="tutorial-integrate-miro-with-azure-active-directory"></a>Tutorial: Integración de Miro con Azure Active Directory

En este tutorial, obtendrá información sobre cómo integrar Miro con Azure Active Directory (Azure AD). Al integrar Miro con Azure AD, puede hacer lo siguiente:
...
5. Haga clic en **Establecer direcciones URL adicionales** y siga este paso si desea configurar la aplicación en el modo iniciado por **SP**:
    ...
    En el cuadro de texto **URL de inicio de sesión**, escriba la dirección URL: `https://miro.com/sso/saml`

1. En la página **Configurar el inicio de sesión único con SAML**, en la sección **Certificado de firma de SAML**, busque **XML de metadatos de federación** y seleccione **Descargar** para descargar el certificado y guardarlo en su equipo.

   ![Vínculo de descarga del certificado](common/metadataxml.png)

1. En la sección **Configurar Miro**, copie las direcciones URL adecuadas según sus necesidades.
...
Para configurar el inicio de sesión único en **Miro**, es preciso enviar el **XML de metadatos de federación** descargado y las direcciones URL apropiadas copiadas de Azure Portal al equipo de soporte técnico de Miro. Dicho equipo lo configura para establecer la conexión de SSO de SAML correctamente en ambos lados.

### <a name="create-miro-test-user"></a>Creación de un usuario de prueba de Miro

En esta sección, se crea un usuario llamado B. Simon en Miro. Miro admite aprovisionamiento Just-in-Time, que se puede habilitar en función de los requisitos. No hay ningún elemento de acción para usted en esta sección. Si un usuario no existe en Miro, se crea uno nuevo cuando se intenta acceder a Miro.
...
* Haga clic en **Probar esta aplicación** en Azure Portal. Esto le redirigirá a la dirección URL de inicio de sesión de Miro, donde puede iniciar el flujo de inicio de sesión.  
...
* Haga clic en **Probar esta aplicación** en Azure Portal; debería iniciar sesión automáticamente en la instancia de Miro para la que ha configurado el inicio de sesión único. 
