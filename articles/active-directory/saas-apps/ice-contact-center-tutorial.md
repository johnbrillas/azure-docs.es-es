...
## <a name="adding-ice-contact-center-from-the-gallery"></a>Adición de ice Contact Center desde la galería
...
Para configurar y probar el inicio de sesión único de Azure AD con ice Contact Center, es preciso completar los siguientes bloques de creación:
...
Al hacer clic en el icono de ice Contact Center en el Panel de acceso, debería iniciar sesión automáticamente en la instancia de ice Contact Center para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
...
- [Pruebe ice Contact Center con Azure AD](https://aad.portal.azure.com/)

- [¿Qué es el control de sesiones en Microsoft Cloud App Security?](/cloud-app-security/proxy-intro-aad)

- [Protección de ice Contact Center con controles y visibilidad avanzados](/cloud-app-security/proxy-intro-aad)