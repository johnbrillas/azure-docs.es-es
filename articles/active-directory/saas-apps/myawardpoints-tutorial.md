...
* My Award Points Top Sub/Top Team admite el inicio de sesión único por **SP**.
...
4. En el cuadro de búsqueda, escriba **My Award Points Top Sub/Top Team**, seleccione **My Award Points Top Sub/Top Team** del panel de resultados y, a continuación, haga clic en el botón **Agregar** para agregar la aplicación.
     ...
     ![My Award Points Top Sub/Top Team en la lista de resultados](common/search-new-app.png)
...
Para que el inicio de sesión único funcione, es necesario establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de My Award Points Top Sub/Top Team.
...
2. **Configuración del inicio de sesión único de My Award Points Top Sub/Top Team**: para configurar el inicio de sesión único en la aplicación.
3. **[Creación de un usuario de prueba de Azure AD](#create-an-azure-ad-test-user)** , para probar el inicio de sesión único de Azure AD con Britta Simon.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)** , para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **Creación de un usuario de prueba de My Award Points Top Sub/Top Team**: para tener un homólogo de Britta Simon en My Award Points Top Sub/Top Team que esté vinculado a la representación del usuario de Azure AD.
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de aplicaciones **My Award Points Top Sub/Top Team**, haga clic en **Inicio de sesión único**.
...
4. En la sección **Configuración básica de SAML**, siga estos pasos:
    ...
    ![Información de inicio de sesión único de Dominio y direcciones URL de My Award Points Top Sub/Top Team](common/sp-signonurl.png)

    En el cuadro de texto **URL de inicio de sesión**, escriba una dirección URL con el siguiente patrón: `https://microsoftrr.performnet.com/biwv1auth/Shibboleth.sso/Login?providerId=<Azure AD Identifier>`

    > [!NOTE]
    > Este valor no es real. Obtendrá el valor `<Azure AD Identifier>` en los últimos pasos en este tutorial.

5. En la página **Configurar el inicio de sesión único con SAML**, en la sección **Certificado de firma de SAML**, haga clic en **Descargar** para descargar el **XML de metadatos de federación** de las opciones proporcionadas según sus requisitos y guárdelo en el equipo.

    ![Vínculo de descarga del certificado](common/metadataxml.png)

6. En la sección **Set up My Award Points Top Sub/Top Team** (Configurar My Award Points Top Sub/Top Team), copie las direcciones URL que necesite. 
    ...
    >[!NOTE]
    >Anexe el valor copiado valor del identificador de Azure AD con la URI de inicio de sesión en lugar de `<Azure AD Identifier>` en la sección **Configuración básica de SAML** de Azure Portal.

### <a name="configure-my-award-points-top-subtop-team-single-sign-on"></a>Configuración del inicio de sesión único de My Award Points Top Sub/Top Team

Para configurar el inicio de sesión único en **My Award Points Top Sub/Top Team**, es preciso enviar el **XML de metadatos de federación** descargado y las direcciones URL copiadas correspondientes desde Azure Portal al [equipo de soporte técnico de My Award Points Top Sub/Top Team](mailto:myawardpoints@biworldwide.com). Dicho equipo lo configura para establecer la conexión de SSO de SAML correctamente en ambos lados.
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones**, **My Award Points Top Sub/Top Team**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **My Award Points Top Sub/Top Team**.

    ![El vínculo de My Award Points Top Sub/Top Team en la lista de aplicaciones](common/all-applications.png)
...
### <a name="create-my-award-points-top-subtop-team-test-user"></a>Creación de un usuario de prueba de My Award Points Top Sub/Top Team
...
Al hacer clic en el icono de My Award Points Top Sub/Top Team en el Panel de acceso, debería iniciar sesión automáticamente en la instancia de My Award Points Top Sub/Top Team para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
