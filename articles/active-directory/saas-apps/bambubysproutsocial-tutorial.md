...
* Bambu by Sprout Social admite el SSO iniciado por **IDP**
...
4. En el cuadro de búsqueda, escriba **Bambu by Sprout Social**, seleccione **Bambu by Sprout Social** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.

    ![Bambu by Sprout Social en la lista de resultados](common/search-new-app.png)
...
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de Bambu by Sprout Social.
...
Para configurar el inicio de sesión único de Azure AD con Bambu by Sprout Social, siga estos pasos:

1. En el [Azure Portal](https://portal.azure.com/), en la página de integración de la aplicación **Bambu by Sprout Social**, seleccione **Inicio de sesión único**.
...
4. En la sección **Configuración básica de SAML**, el usuario no tiene que realizar ningún paso porque la aplicación ya se ha integrado previamente con Azure.
    ...
    ![Información de dominio y direcciones URL de inicio de sesión único de Bambu by Sprout Social](common/preintegrated.png)
...
### <a name="configure-bambu-by-sprout-social-single-sign-on"></a>Configuración del inicio de sesión único en Bambu by Sprout Social
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones** y, luego, **Bambu by Sprout Social**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **Bambu by Sprout Social**.

    ![Vínculo de Bambu by Sprout Social en la lista de aplicaciones](common/all-applications.png)
...
Al hacer clic en el icono de Bambu by Sprout Social en el Panel de acceso, iniciará sesión automáticamente en la aplicación Bambu by Sprout Social para la que ha configurado el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
