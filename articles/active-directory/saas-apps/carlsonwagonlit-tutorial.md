...
* Una suscripción que permita el inicio de sesión único de Carlson Wagonlit Travel
...
4. En el cuadro de búsqueda, escriba **Carlson Wagonlit Travel**, seleccione **Carlson Wagonlit Travel** en el panel de resultados y, a continuación, haga clic en el botón **Agregar** para agregar la aplicación.
    ...
    ![Carlson Wagonlit Travel en la lista de resultados](common/search-new-app.png)
...
Es decir, para que el inicio de sesión único funcione, es necesario establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de Carlson Wagonlit Travel.
...
2. **[Configuración del inicio de sesión único de Carlson Wagonlit Travel](#configure-carlson-wagonlit-travel-single-sign-on)** : para configurar los valores de Inicio de sesión único en la aplicación.
3. **[Creación de un usuario de prueba de Azure AD](#create-an-azure-ad-test-user)** , para probar el inicio de sesión único de Azure AD con Britta Simon.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)** , para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Creación de un usuario de prueba de Carlson Wagonlit Travel](#create-carlson-wagonlit-travel-test-user)** : para tener un homólogo de Britta Simon en Carlson Wagonlit Travel que esté vinculado a la representación del usuario en Azure AD.
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de aplicaciones de **Carlson Wagonlit Travel**, seleccione **Inicio de sesión único**.
...
4. En la sección **Configuración básica de SAML**, siga estos pasos:
    ...
    ![Información de dominio y direcciones URL de inicio de sesión único de Carlson Wagonlit Travel](common/idp-identifier.png)
...
### <a name="configure-carlson-wagonlit-travel-single-sign-on"></a>Configuración del inicio de sesión único de Carlson Wagonlit Travel
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones**, **Carlson Wagonlit Travel**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **Carlson Wagonlit Travel**.

    ![Vínculo de Carlson Wagonlit Travel en la lista de aplicaciones](common/all-applications.png)
...
Al hacer clic en el icono de Carlson Wagonlit Travel del panel de acceso, debería iniciar sesión automáticamente en su aplicación Carlson Wagonlit Travel para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
