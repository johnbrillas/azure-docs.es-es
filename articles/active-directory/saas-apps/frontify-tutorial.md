...
* Una vez configurado Frontify, puede aplicar el control de sesión, que protege la filtración y la infiltración de la información confidencial de la organización en tiempo real. El control de sesión procede del acceso condicional. [Aprenda a aplicar el control de sesión con Microsoft Cloud App Security](/cloud-app-security/proxy-deployment-any-app).
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de aplicaciones de **Frontify**, busque la sección **Administrar** y seleccione **Inicio de sesión único**.
...
- [Protección de Frontify con controles y visibilidad avanzados](/cloud-app-security/proxy-intro-aad)