...
* Tangoe Command Premium Mobile admite el inicio de sesión único iniciado por **SP**.
...
4. En el cuadro de búsqueda, escriba **Tangoe Command Premium Mobile**, seleccione **Tangoe Command Premium Mobile** desde el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.
    ...
    ![Tangoe Command Premium Mobile en la lista de resultados](common/search-new-app.png)
...
Para que el inicio de sesión único funcione, es necesario establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de Tangoe Command Premium Mobile.
...
2. **[Configuración del inicio de sesión único de Tangoe Command Premium Mobile](#configure-tangoe-command-premium-mobile-single-sign-on)** : para configurar los valores de inicio de sesión único en la aplicación.
3. **[Creación de un usuario de prueba de Azure AD](#create-an-azure-ad-test-user)** , para probar el inicio de sesión único de Azure AD con Britta Simon.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)** , para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Creación de un usuario de prueba de Tangoe Command Premium Mobile](#create-tangoe-command-premium-mobile-test-user)** : para tener un homólogo de Britta Simon en Tangoe Command Premium Mobile que esté vinculado a la representación del usuario en Azure AD.
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de la aplicación **Tangoe Command Premium Mobile**, seleccione **Inicio de sesión único**.
...
4. En la sección **Configuración básica de SAML**, siga estos pasos:
    ...
    ![Información de dominio y direcciones URL de inicio de sesión único de Tangoe Command Premium Mobile](common/sp-reply.png)
    ...
    > [!NOTE]
    > Estos valores no son reales. Actualice estos valores con los valores reales de URL de respuesta y URL de inicio de sesión. Póngase en contacto con el [equipo de soporte técnico de Tangoe Command Premium Mobile Client](https://www.tangoe.com/contact-us/) para obtener estos valores. También puede hacer referencia a los patrones que se muestran en la sección **Configuración básica de SAML** de Azure Portal.
...
### <a name="configure-tangoe-command-premium-mobile-single-sign-on"></a>Configuración del inicio de sesión único de Tangoe Command Premium Mobile
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones** y **Tangoe Command Premium Mobile**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **Tangoe comando Premium Mobile**.

    ![Vínculo a Tangoe Command Premium Mobile en la lista de aplicaciones](common/all-applications.png)
...
Al hacer clic en el icono de Tangoe Command Premium Mobile en el panel de acceso, debería iniciar sesión automáticamente en la versión de Tangoe Command Premium Mobile para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
