...
## <a name="configure-and-test-azure-ad-single-sign-on-for-allyio"></a>Configuración y prueba del inicio de sesión único de Azure AD para Ally.io
...
Para configurar y probar el inicio de sesión único de Azure AD con Ally.io, es preciso completar los siguientes bloques de creación:
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de aplicaciones de **Ally.io**, busque la sección **Administrar** y seleccione **Inicio de sesión único**.
...
1. Haga clic en **Establecer direcciones URL adicionales** y siga este paso si desea configurar la aplicación en el modo iniciado por **SP**:
    ...
    En el cuadro de texto **URL de inicio de sesión**, escriba una dirección URL: `https://app.ally.io/`
...
- [Pruebe Ally.io con Azure AD](https://aad.portal.azure.com/)

- [¿Qué es el control de sesiones en Microsoft Cloud App Security?](/cloud-app-security/proxy-intro-aad)

- [Protección de Ally.io con controles y visibilidad avanzados](/cloud-app-security/proxy-intro-aad)