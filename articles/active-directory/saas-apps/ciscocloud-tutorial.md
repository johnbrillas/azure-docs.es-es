...
* Suscripción habilitada para el inicio de sesión único en Cisco Cloud
...
4. En el cuadro de búsqueda, escriba **Cisco Cloud**, seleccione **Cisco Cloud** en el panel de resultados y, luego, haga clic en el botón **Agregar** para añadir la aplicación.
    ...
    ![Cisco Cloud en la lista de resultados](common/search-new-app.png)
...
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de Cisco Cloud.
...
2. **[Configuración del inicio de sesión único de Cisco Cloud](#configure-cisco-cloud-single-sign-on)** : para configurar los valores de inicio de sesión único en la aplicación.
3. **[Creación de un usuario de prueba de Azure AD](#create-an-azure-ad-test-user)** , para probar el inicio de sesión único de Azure AD con Britta Simon.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)** , para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Creación de un usuario de prueba de Cisco Cloud](#create-cisco-cloud-test-user)** : para tener un homólogo de Britta Simon en Cisco Cloud que esté vinculado a su representación en Azure AD.
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de la aplicación **Cisco Cloud**, seleccione **Inicio de sesión único**.
...
### <a name="configure-cisco-cloud-single-sign-on"></a>Configuración del inicio de sesión único de Cisco Cloud
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones** y **Cisco Cloud**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **Cisco Cloud**.

    ![Vínculo a Cisco Cloud en la lista de aplicaciones](common/all-applications.png)
...
Al hacer clic en el icono de Cisco Cloud en el panel de acceso, debería iniciar sesión automáticamente en la versión de Cisco Cloud para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
