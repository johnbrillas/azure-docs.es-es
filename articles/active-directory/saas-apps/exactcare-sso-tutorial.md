...
En esta sección, creará un usuario llamado B.Simon en ExactCare SSO. Trabaje con el [equipo de soporte técnico de ExactCare SSO](mailto:help@exactcarepharmacy.com) para agregar los usuarios a la plataforma de ExactCare SSO. Los usuarios se tienen que crear y activar antes de usar el inicio de sesión único.
