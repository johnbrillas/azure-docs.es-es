...
## <a name="configure-and-test-azure-ad-single-sign-on-for-textexpander"></a>Configuración y prueba del inicio de sesión único de Azure AD para TextExpander
...
Para configurar y probar el inicio de sesión único de Azure AD con TextExpander, es preciso completar los siguientes bloques de creación:
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de aplicaciones de **TextExpander**, busque la sección **Manage** (Administrar) y seleccione el **inicio de sesión único**.
...
Al hacer clic en el icono de TextExpander en el panel de acceso, debería iniciar sesión automáticamente en la aplicación TextExpander para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
...
- [Prueba de TextExpander con Azure AD](https://aad.portal.azure.com/)

- [¿Qué es el control de sesiones en Microsoft Cloud App Security?](/cloud-app-security/proxy-intro-aad)

- [Protección de TextExpander con controles y visibilidad avanzados](/cloud-app-security/proxy-intro-aad)