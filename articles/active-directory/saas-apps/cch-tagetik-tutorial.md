...
## <a name="configure-and-test-azure-ad-single-sign-on-for-cch-tagetik"></a>Configuración y prueba del inicio de sesión único de Azure AD para CCH Tagetik
...
Para configurar y probar el inicio de sesión único de Azure AD con CCH Tagetik, es preciso completar los siguientes bloques de creación:
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de aplicaciones de **CCH Tagetik**, busque la sección **Manage** (Administrar) y seleccione el **inicio de sesión único**.
...
Al hacer clic en el icono de CCH Tagetik en el panel de acceso, se debería iniciar sesión automáticamente en la aplicación CCH Tagetik para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
...
- [Prueba de CCH Tagetik con Azure AD](https://aad.portal.azure.com/)

- [¿Qué es el control de sesiones en Microsoft Cloud App Security?](/cloud-app-security/proxy-intro-aad)

- [Protección de CCH Tagetik con controles y visibilidad avanzados](/cloud-app-security/proxy-intro-aad)