...
> * [Inicio de sesión único](./teamviewer-tutorial.md) en TeamViewer (recomendado)
...
3. Determine qué datos se [asignarán entre Azure AD y TeamViewer](../app-provisioning/customize-application-attributes.md). 
