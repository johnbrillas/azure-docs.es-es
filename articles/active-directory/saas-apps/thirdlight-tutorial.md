...
Si desea más información acerca de la integración de aplicaciones SaaS con Azure AD, consulte [Inicio de sesión único en aplicaciones de Azure Active Directory](../manage-apps/what-is-single-sign-on.md).
...
1. En la sección de configuración de SAML2, siga estos pasos.
    ...
    ![Sección de configuración de SAML2](./media/thirdlight-tutorial/ic805844.png "Sección de configuración de SAML2")
