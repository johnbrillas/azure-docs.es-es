...
* Una suscripción habilitada para el inicio de sesión único en eLuminate

## <a name="scenario-description"></a>Descripción del escenario

En este tutorial, puede configurar y probar el inicio de sesión único de Azure AD en un entorno de prueba.

* eLuminate admite el inicio de sesión único iniciado por **SP**
...
4. En el cuadro de búsqueda, escriba **eLuminate**, seleccione **eLuminate** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.
     ...
     ![eLuminate en la lista de resultados](common/search-new-app.png)
...
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de eLuminate.
...
2. **[Configuración del inicio de sesión único en eLuminate](#configure-eluminate-single-sign-on)**: para configurar los valores de Inicio de sesión único en la aplicación.
3. **[Creación de un usuario de prueba de Azure AD](#create-an-azure-ad-test-user)** , para probar el inicio de sesión único de Azure AD con Britta Simon.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)** , para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Creación de un usuario de prueba en eLuminate](#create-eluminate-test-user)**: para tener un homólogo de Britta Simon en eLuminate que esté vinculado a su representación en Azure AD.
...
Para configurar el inicio de sesión único de Azure AD con eLuminate, siga estos pasos:

1. En [Azure Portal](https://portal.azure.com/), en la página de integración de la aplicación **eLuminate**, haga clic en **Inicio de sesión único**.
...
4. En la sección **Configuración básica de SAML**, siga estos pasos:
    ...
    ![Información de inicio de sesión único de dominio y direcciones URL de eLuminate](common/sp-identifier.png)
    ...
    b. En el cuadro de texto **Identificador (id. de entidad)** , escriba una dirección URL con el siguiente patrón: `Eluminate/ClientShortName`

    > [!NOTE]
    > Estos valores no son reales. Actualice estos valores con la dirección URL y el identificador reales de inicio de sesión. Póngase en contacto con el [equipo de soporte de cliente de eLuminate](mailto:support@intellimedia.ca) para obtener estos valores. También puede hacer referencia a los patrones que se muestran en la sección **Configuración básica de SAML** de Azure Portal.
...
### <a name="configure-eluminate-single-sign-on"></a>Configuración del inicio de sesión único en eLuminate
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones**, **eLuminate**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **eLuminate**.

    ![Vínculo a eLuminate en la lista de aplicaciones](common/all-applications.png)
...
### <a name="create-eluminate-test-user"></a>Creación de un usuario de prueba en eLuminate
