...
1. En Azure Portal, en la página de integración de aplicaciones de **Zscaler Three**, busque la sección **Administrar** y seleccione **Inicio de sesión único**.
