...
2. Haga clic en el **icono de menú** y, después, seleccione **Administration** (Administración).
    ...
    ![Captura de pantalla que muestra el icono de administración en Microsoft Digital Enterprise Server.](./media/trisotechdigitalenterpriseserver-tutorial/user1.png)

3. Seleccione **User Provider** (Proveedor de usuarios).

    ![Captura de pantalla que muestra la opción User Provider (Proveedor de usuarios) seleccionada en el menú.](./media/trisotechdigitalenterpriseserver-tutorial/user2.png)

4. En la sección **User Provider Configurations** (Configuración de proveedor de usuarios), realice los pasos siguientes:

    ![Captura de pantalla que muestra User Provider Configurations (Configuración de proveedor de usuarios), donde puede especificar los valores descritos.](./media/trisotechdigitalenterpriseserver-tutorial/user3.png)
