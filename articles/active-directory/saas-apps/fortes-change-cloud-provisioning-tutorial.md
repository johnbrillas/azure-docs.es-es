...
3. Determine qué datos quiere [asignar entre Azure AD y Fortes Change Cloud](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes). 
