...
3. En la página del cuadro de diálogo **New employee** (nuevo empleado), realice los siguientes pasos:
    ...
    1. En el cuadro de texto **Nombre**, escriba un nombre como **Britta** y un apellido como **Simon**.

    1. En el cuadro de texto **Email** (Correo electrónico), escriba la dirección de correo electrónico de un usuario, por ejemplo, **brittasimon\@contoso.com**.

    1. Haga clic en **Crear empleado**.
