---
title: 'Tutorial: Integración de Azure Active Directory con Adoddle cSaas Platform | Microsoft Docs'
...
En este tutorial, aprenderá a integrar Adoddle cSaas Platform con Azure Active Directory (Azure AD).
La integración de Adoddle cSaas Platform con Azure AD proporciona las siguientes ventajas:

* En Azure AD se puede controlar quién tiene acceso a Adoddle cSaas Platform.
* Puede permitir que los usuarios inicien sesión automáticamente en Adoddle cSaas Platform (inicio de sesión único) con su cuenta de Azure AD.
...
* Una suscripción habilitada para inicio de sesión único en Adoddle cSaas Platform
...
* Adoddle cSaas Platform admite aprovisionamiento de usuarios **Just-In-Time**

## <a name="adding-adoddle-csaas-platform-from-the-gallery"></a>Adición de Adoddle cSaas Platform desde la galería
...
**Para agregar Adoddle cSaas Platform desde la galería, realice los pasos siguientes:**
...
En esta sección, configurará y probará el inicio de sesión único de Azure AD con Adoddle cSaas Platform con un usuario de prueba llamado **Britta Simon**.
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de Adoddle cSaas Platform.
...
Para configurar el inicio de sesión único de Azure AD con Adoddle cSaas Platform, realice los pasos siguientes:

1. En [Azure Portal](https://portal.azure.com/), en la página de integración de la aplicación **Adoddle cSaas Platform**, seleccione **Inicio de sesión único**.
...
4. En la sección **Configuración básica de SAML**, el usuario no tiene que realizar ningún paso porque la aplicación ya se ha integrado previamente con Azure.
    ...
    ![Información de dominio y direcciones URL de inicio de sesión único de Adoddle cSaas Platform](common/preintegrated.png)
...
### <a name="configure-adoddle-csaas-platform-single-sign-on"></a>Configuración del inicio de sesión único de Adoddle cSaas Platform
...
En esta sección, concederá acceso a Britta Simon a Adoddle cSaas Platform para que use el inicio de sesión único de Azure.

1. En Azure Portal, seleccione sucesivamente **Aplicaciones empresariales**, **Todas las aplicaciones** y **Adoddle cSaas Platform**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **Adoddle cSaas Platform**.

    ![Vínculo a Adoddle cSaas Platform en la lista de aplicaciones](common/all-applications.png)
...
Al hacer clic en el icono de Adoddle cSaas Platform del panel de acceso, debería iniciar sesión automáticamente en la aplicación Adoddle cSaas Platform para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
