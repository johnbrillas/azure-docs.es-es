...
* Controlar en Azure AD quién tiene acceso a InformaCast.
* Permitir que los usuarios inicien sesión automáticamente en InformaCast con sus cuentas de Azure AD.
...
En esta sección, va a permitir que B.Simon acceda a InformaCast mediante el inicio de sesión único de Azure.

1. En Azure Portal, seleccione sucesivamente **Aplicaciones empresariales** y **Todas las aplicaciones**.
1. En la lista de aplicaciones, seleccione **InformaCast**.
...
## <a name="configure-informacast-sso"></a>Configuración del inicio de sesión único de InformaCast

Para configurar el inicio de sesión único en **InformaCast**, tiene que enviar la **dirección URL de metadatos de federación de aplicación** al [equipo de soporte técnico de InformaCast](mailto:support@singlewire.com). Dicho equipo lo configura para establecer la conexión de SSO de SAML correctamente en ambos lados.

### <a name="create-informacast-test-user"></a>Creación de un usuario de prueba de InformaCast

En esta sección, creará un usuario llamado Britta Simon en InformaCast. Trabaje con el [equipo de soporte técnico de InformaCast](mailto:support@singlewire.com) para agregar los usuarios a la plataforma de InformaCast. Los usuarios se tienen que crear y activar antes de usar el inicio de sesión único.
...
1. Haga clic en **Probar esta aplicación** en Azure Portal. Esta acción le redirigirá a la URL de inicio de sesión de InformaCast, desde donde puede poner en marcha el flujo de inicio de sesión.  

1. Vaya directamente a la URL de inicio de sesión de InformaCast y comience el flujo de inicio de sesión desde allí.

#### <a name="idp-initiated"></a>Iniciado por IDP:

* Haga clic en **Probar esta aplicación** en Azure Portal. Se debería iniciar sesión automáticamente en la instancia de InformaCast para la que ha configurado el inicio de sesión único. 
