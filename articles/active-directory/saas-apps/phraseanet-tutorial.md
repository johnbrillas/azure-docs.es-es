...
ms.date: 03/14/2019
ms.author: jeedes
ms.openlocfilehash: 25b93d47d093b871d654ee79dbdf810774aba871
ms.sourcegitcommit: 910a1a38711966cb171050db245fc3b22abc8c5f
ms.translationtype: HT
ms.contentlocale: es-ES
ms.lasthandoff: 03/19/2021
ms.locfileid: "92520824"
---
...
* Phraseanet admite el inicio de sesión único iniciado por **SP**
...
4. En el cuadro de búsqueda, escriba **Phraseanet**, seleccione **Phraseanet** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.
     ...
     ![Phraseanet en la lista de resultados](common/search-new-app.png)
...
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de Phraseanet.
...
2. **[Configuración del inicio de sesión único de Phraseanet](#configure-phraseanet-single-sign-on)**: para configurar los valores de Inicio de sesión único en la aplicación.
3. **[Creación de un usuario de prueba de Azure AD](#create-an-azure-ad-test-user)** , para probar el inicio de sesión único de Azure AD con Britta Simon.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)** , para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Creación de un usuario de prueba en Phraseanet](#create-phraseanet-test-user)**: para tener un homólogo de Britta Simon en Phraseanet que esté vinculado a la representación del usuario en Azure AD.
...
4. En la sección **Configuración básica de SAML**, siga estos pasos:
    ...
    ![Información de dominio y direcciones URL de inicio de sesión único de Phraseanet](common/sp-signonurl.png)

    En el cuadro de texto **URL de inicio de sesión**, escriba una dirección URL con el siguiente patrón: `https://<SUBDOMAIN>.alchemyasp.com`

    > [!NOTE]
    > Este valor no es real. Actualícelo con la dirección URL de inicio de sesión real. Póngase en contacto con el [equipo de atención al cliente de Phraseanet](mailto:support@alchemy.fr) para obtener el valor. También puede hacer referencia a los patrones que se muestran en la sección **Configuración básica de SAML** de Azure Portal.

5. En la página **Configurar el inicio de sesión único con SAML**, en la sección **Certificado de firma de SAML**, haga clic en **Descargar** para descargar el **XML de metadatos de federación** de las opciones proporcionadas según sus requisitos y guárdelo en el equipo.

    ![Vínculo de descarga del certificado](common/metadataxml.png)

6. En la sección **Set up Phraseanet** (Configurar Phraseanet), copie las direcciones URL adecuada según sus necesidades.
...
### <a name="configure-phraseanet-single-sign-on"></a>Configuración del inicio de sesión único de Phraseanet

Para configurar el inicio de sesión único en **Phraseanet**, es preciso enviar el **XML de metadatos de federación** descargado y las direcciones URL correspondientes copiadas de Azure Portal al [equipo de soporte técnico de Phraseanet](mailto:support@alchemy.fr). Dicho equipo lo configura para establecer la conexión de SSO de SAML correctamente en ambos lados.
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones**, **Phraseanet**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **Phraseanet**.

    ![Vínculo a Phraseanet en la lista de aplicaciones](common/all-applications.png)
...
### <a name="create-phraseanet-test-user"></a>Creación de un usuario de prueba de Phraseanet
...
Al hacer clic en el icono de Phraseanet en el panel de acceso y debería iniciar sesión automáticamente en la versión de Phraseanet para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
