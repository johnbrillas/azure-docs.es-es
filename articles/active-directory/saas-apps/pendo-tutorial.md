...
## <a name="adding-pendo-from-the-gallery"></a>Incorporación de Pendo desde la galería
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-pendo"></a>Configuración y prueba del inicio de sesión único de Azure AD para Pendo
...
Para configurar y probar el inicio de sesión único de Azure AD con Pendo, es preciso completar los siguientes bloques de creación:
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de aplicaciones de **Pendo**, busque la sección **Administrar** y seleccione **Inicio de sesión único**.
...
1. En la página **Configurar el inicio de sesión único con SAML**, escriba los valores de los siguientes campos:
    ...
    a. En el cuadro de texto **Identificador**, escriba una dirección URL con el patrón siguiente: `https://sso.connect.pingidentity.com/<CUSTOM_GUID>`
...
## <a name="configure-pendo-sso"></a>Configuración del inicio de sesión único de Pendo
...
Al hacer clic en el icono de Pendo en el Panel de acceso, debería iniciar sesión automáticamente en la versión de Pendo para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
...
- [Pruebe Pendo con Azure AD](https://aad.portal.azure.com/)

- [¿Qué es el control de sesiones en Microsoft Cloud App Security?](/cloud-app-security/proxy-intro-aad)

- [Protección de Pendo con controles y visibilidad avanzados](/cloud-app-security/proxy-intro-aad)