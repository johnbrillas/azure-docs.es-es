...
1. Haga clic en **Inicio de sesión único**.
    ...
    ![Captura de pantalla que muestra "Inicio de sesión único" seleccionado.](./media/screensteps-tutorial/ic778524.png "Autenticación remota")
...
1. En la sección **Crear punto de conexión de inicio de sesión único** , siga estos pasos:
    ...
    ![Creación de un punto de conexión de autenticación](./media/screensteps-tutorial/ic778526.png "Crear un punto de conexión de autenticación")
...
1. **Edite** el punto de conexión nuevo.
    ...
    ![Editar punto de conexión](./media/screensteps-tutorial/ic778528.png "Edición del extremo")
