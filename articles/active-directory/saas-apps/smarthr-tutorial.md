---
title: 'Tutorial: Integración del inicio de sesión único (SSO) de Azure Active Directory con SmartHR | Microsoft Docs'
...
## <a name="adding-smarthr-from-the-gallery"></a>Adición de SmartHR desde la galería
...
Para configurar y probar el inicio de sesión único de Azure AD con SmartHR, es preciso completar los siguientes bloques de creación:
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de aplicaciones de **SmartHR**, busque la sección **Administrar** y seleccione **Inicio de sesión único**.
...
1. En la sección **Configuración básica de SAML**, especifique los valores de los siguientes campos:
    ...
    a. En el cuadro de texto **URL de inicio de sesión**, escriba una dirección URL con el siguiente patrón: `https://<SUBDOMAIN>.smarthr.jp/external_saml/sso`

    b. En el cuadro de texto **Identificador (id. de entidad)** , escriba una dirección URL con el siguiente patrón: `https://<SUBDOMAIN>.smarthr.jp/external_saml/metadata`
...
Al hacer clic en el icono de SmartHR en el Panel de acceso, debería iniciar sesión automáticamente en la instancia de SmartHR para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
...
- [Pruebe SmartHR con Azure AD](https://aad.portal.azure.com/)

- [¿Qué es el control de sesiones en Microsoft Cloud App Security?](/cloud-app-security/proxy-intro-aad)

- [Procedimiento para proteger SmartHR con controles y visibilidad avanzados](/cloud-app-security/proxy-intro-aad)