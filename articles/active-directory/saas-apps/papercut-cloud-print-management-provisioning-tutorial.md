...
3. Determine qué datos se van a [asignar entre Azure AD y PaperCut Cloud Print Management](../app-provisioning/customize-application-attributes.md).
