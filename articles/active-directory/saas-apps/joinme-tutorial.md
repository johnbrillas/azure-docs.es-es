...
* join.me admite SSO iniciado por **IDP**
...
4. En el cuadro de búsqueda, escriba **join.me**, seleccione **join.me** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.
     ...
     ![join.me en la lista de resultados](common/search-new-app.png)
...
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de join.me.
...
2. **[Configuración del inicio de sesión único en join.me](#configure-joinme-single-sign-on)**: para configurar los valores de Inicio de sesión único en la aplicación.
3. **[Creación de un usuario de prueba de Azure AD](#create-an-azure-ad-test-user)** , para probar el inicio de sesión único de Azure AD con Britta Simon.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)** , para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Creación de un usuario de prueba en join.me](#create-joinme-test-user)**: para tener un homólogo de Britta Simon en join.me que esté vinculado a la representación del usuario en Azure AD.
...
Para configurar el inicio de sesión único de Azure AD con join.me, siga estos pasos:
...
4. En la sección **Configuración básica de SAML**, el usuario no tiene que realizar ningún paso porque la aplicación ya se ha integrado previamente con Azure.
    ...
    ![Información sobre dominio y direcciones URL de inicio de sesión único de join.me](common/preintegrated.png)
...
### <a name="configure-joinme-single-sign-on"></a>Configuración del inicio de sesión único en join.me

Para configurar el inicio de sesión único en **join.me**, debe enviar la **dirección URL de metadatos de federación de la aplicación** al [equipo de soporte técnico de join.me](https://help.join.me/s/?language). Dicho equipo lo configura para establecer la conexión de SSO de SAML correctamente en ambos lados.
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones**, **join.me**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **join.me**.

    ![Vínculo a join.me en la lista de aplicaciones](common/all-applications.png)
...
### <a name="create-joinme-test-user"></a>Creación de un usuario de prueba en join.me
...
Al hacer clic en el icono de join.me en el Panel de acceso y debería iniciar sesión automáticamente en la versión de join.me para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
