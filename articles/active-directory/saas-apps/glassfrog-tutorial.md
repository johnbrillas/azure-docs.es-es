...
4. En el cuadro de búsqueda, escriba **GitHub**, seleccione **GlassFrog** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.
     ...
     ![GlassFrog en la lista de resultados](common/search-new-app.png)
...
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de GlassFrog.
...
2. **[Configuración del inicio de sesión único en GlassFrog](#configure-glassfrog-single-sign-on)**: para configurar los valores de inicio de sesión único en la aplicación.
3. **[Creación de un usuario de prueba de Azure AD](#create-an-azure-ad-test-user)** , para probar el inicio de sesión único de Azure AD con Britta Simon.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)** , para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Creación del usuario de prueba en GlassFrog](#create-glassfrog-test-user)**: para tener un homólogo de Britta Simon en GlassFrog vinculado a la representación del usuario en Azure AD.
...
Para configurar el inicio de sesión único de Azure AD con GlassFrog, siga estos pasos:
...
4. En la sección **Configuración básica de SAML**, siga estos pasos:
    ...
    ![Información sobre dominio y direcciones URL de inicio de sesión único de GlassFrog](common/sp-signonurl.png)
...
### <a name="configure-glassfrog-single-sign-on"></a>Configuración del inicio de sesión único en GlassFrog
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones**, **GlassFrog**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **GlassFrog**.

    ![Vínculo a GlassFrog en la lista de aplicaciones](common/all-applications.png)
