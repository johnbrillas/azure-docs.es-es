...
## <a name="adding-fastly-edge-cloud-from-the-gallery"></a>Incorporación de Fastly Edge Cloud desde la galería
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-fastly-edge-cloud"></a>Configuración y prueba del inicio de sesión único de Azure AD para Fastly Edge Cloud
...
Para configurar y probar el inicio de sesión único de Azure AD con Fastly Edge Cloud, complete los siguientes bloques de creación:
...
1. **[Configuración del inicio de sesión único en Fastly Edge Cloud](#configure-fastly-edge-cloud-sso)** , para configurar los valores de Inicio de sesión único en la aplicación.
    * **[Creación de un usuario de prueba de Fastly Edge Cloud](#create-fastly-edge-cloud-test-user)** , para tener un homólogo de B.Simon en Fastly Edge Cloud vinculado a la representación del usuario en Azure AD.
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de aplicaciones de **Fastly Edge Cloud**, busque la sección **Administrar** y seleccione **Inicio de sesión único**.
...
Al hacer clic en el icono de Fastly Edge Cloud en el Panel de acceso, debería iniciar sesión automáticamente en la versión de Fastly Edge Cloud para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
...
- [Pruebe Fastly Edge Cloud con Azure AD](https://aad.portal.azure.com/)