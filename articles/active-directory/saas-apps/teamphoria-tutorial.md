...
4. Vaya a la opción **ADMIN SETTINGS** (Configuración de administración) de la barra de herramientas de la izquierda y, en la pestaña Configure (Configurar), haga clic en **SINGLE SIGN-ON** (Inicio de sesión único) para abrir la ventana de configuración de SSO.
    ...
    ![Captura de pantalla que muestra la opción ADMIN SETTINGS (Configuración de administración), donde puede seleccionar SINGLE SIGN-ON (Inicio de sesión único).](./media/teamphoria-tutorial/admin_sso_configure.png)
...
5. Haga clic en la opción **ADD NEW IDENTITY PROVIDER** (Agregar nuevo proveedor de identidades) en la esquina superior derecha para abrir el formulario para agregar la configuración de SSO.
    ...
    ![Captura de pantalla que muestra dónde seleccionar ADD NEW IDENTITY PROVIDER (Agregar nuevo proveedor de identidades).](./media/teamphoria-tutorial/add_new_identity_provider.png)

6. Escriba la información en los campos, tal como se describe a continuación:

    ![Captura de pantalla que muestra la página donde puede especificar los valores descritos.](./media/teamphoria-tutorial/Teamphoria_sso_save.png)
...
1. Haga clic en la opción **MANUAL INVITE**.
    ...
    ![Captura de pantalla que muestra la opción MANUAL INVITE (Invitación manual).](./media/teamphoria-tutorial/admin_manage_add_users.png)

1. En esta página, realizar las acciones siguientes.

    ![Captura de pantalla que muestra la página MANUAL USER INVITE (Invitación de usuario manual), donde puede escribir el nombre y la dirección de correo electrónico.](./media/teamphoria-tutorial/manual_user_invite.png)
