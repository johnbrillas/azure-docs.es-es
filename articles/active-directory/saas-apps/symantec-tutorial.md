...
2. **Configuración del inicio de sesión único de Symantec Web Security Service (WSS)**: para configurar el inicio de sesión único en la aplicación.
