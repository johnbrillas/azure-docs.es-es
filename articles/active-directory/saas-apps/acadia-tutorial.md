...
En este tutorial, aprenderá a integrar Acadia con Azure Active Directory (Azure AD).
Integrar Acadia con Azure AD le proporciona las siguientes ventajas:

* Puede controlar en Azure AD quién tiene acceso a Acadia.
* Puede permitir que los usuarios inicien sesión automáticamente en Acadia (inicio de sesión único) con sus cuentas de Azure AD.
...
Para configurar la integración de Azure AD con Acadia, necesita los siguientes elementos:

* Una suscripción de Azure AD. Si no dispone de un entorno de Azure AD, puede obtener una versión de prueba de un mes [aquí](https://azure.microsoft.com/pricing/free-trial/)
* Una suscripción habilitada para el inicio de sesión único de Acadia
...
## <a name="adding-acadia-from-the-gallery"></a>Incorporación de Acadia desde la galería
...
**Para agregar Acadia desde la galería, realice los pasos siguientes:**
...
5. **[Creación de un usuario de prueba de Acadia](#create-acadia-test-user)** : para tener un homólogo de Britta Simon en Acadia vinculado a la representación del usuario en Azure AD.
...
4. En la sección **Configuración básica de SAML**, si desea configurar la aplicación en el modo iniciado por **IDP** siga estos pasos:
    ...
    ![Captura de pantalla que muestra los elementos de pantalla necesarios para configurar la aplicación en modo iniciado por IDP.](common/idp-intiated.png)
...
5. Haga clic en **Establecer direcciones URL adicionales** y siga este paso si desea configurar la aplicación en el modo iniciado por **SP**:
    ...
    ![Información de dominio y direcciones URL de inicio de sesión único de Acadia](common/metadata-upload-additional-signon.png)
...
En esta sección, habilitará a Britta Simon para que use el inicio de sesión único de Azure concediéndole acceso a Acadia.

1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones**,  **Acadia**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **Acadia**.

    ![Vínculo a Acadia en la lista de aplicaciones](common/all-applications.png)
...
Al hacer clic en el icono de Acadia en el panel de acceso, debería iniciar sesión automáticamente en la versión de Acadia para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
