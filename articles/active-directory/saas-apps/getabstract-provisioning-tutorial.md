...
3. Determine qué datos se van a [asignar entre Azure AD y getAbstract](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes). 
