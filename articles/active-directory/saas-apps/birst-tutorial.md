...
En esta sección se crea un usuario llamado Britta Simon en Birst Agile Business Analytics. Trabaje con el [equipo de soporte técnico de Birst Agile Business Analytics](mailto:info@birst.com) para agregar los usuarios a la plataforma Birst Agile Business Analytics. Los usuarios se tienen que crear y activar antes de usar el inicio de sesión único.
