...
> * [Inicio de sesión único](https://docs.microsoft.com/azure/active-directory/saas-apps/splashtop-tutorial) en Splashtop (recomendado)
...
3. Determine qué datos quiere [asignar entre Azure AD y Splashtop](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes). 
