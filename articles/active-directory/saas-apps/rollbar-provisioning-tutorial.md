...
> * [Inicio de sesión único](./rollbar-tutorial.md) en Rollbar (recomendado)
...
3. Determine qué datos [asignar entre Azure AD y Rollbar](../app-provisioning/customize-application-attributes.md). 
