...
* JobScore admite SSO iniciado por **SP**
...
4. En el cuadro de búsqueda, escriba **JobScore**, seleccione **JobScore** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.

     ![JobScore en la lista de resultados](common/search-new-app.png)
...
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de JobScore.
...
2. **[Configuración del inicio de sesión único en JobScore](#configure-jobscore-single-sign-on)**: para configurar los valores de Inicio de sesión único en la aplicación.
3. **[Creación de un usuario de prueba de Azure AD](#create-an-azure-ad-test-user)** , para probar el inicio de sesión único de Azure AD con Britta Simon.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)** , para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Creación de un usuario de prueba en JobScore](#create-jobscore-test-user)**: para tener un homólogo de Britta Simon en JobScore que esté vinculado a la representación de ella en Azure AD.
...
Para configurar el inicio de sesión único de Azure AD con JobScore, siga estos pasos:

1. En [Azure Portal](https://portal.azure.com/), en la página de integración de la aplicación **JobScore**, haga clic en **Inicio de sesión único**.
...
6. En la sección **Set up JobScore** (Configurar JobScore), copie las direcciones URL adecuadas según sus necesidades.
...
### <a name="configure-jobscore-single-sign-on"></a>Configuración del inicio de sesión único en JobScore

Para configurar el inicio de sesión único en **JobScore**, es preciso enviar el **XML de metadatos de federación** descargado y las direcciones URL apropiadas copiadas de Azure Portal al [equipo de soporte técnico de JobScore](mailto:support@jobscore.com). Dicho equipo lo configura para establecer la conexión de SSO de SAML correctamente en ambos lados.
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones** y **JobScore**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **JobScore**.

    ![Vínculo a JobScore en la lista de aplicaciones](common/all-applications.png)
...
### <a name="create-jobscore-test-user"></a>Creación de un usuario de prueba en JobScore

En esta sección, creará un usuario llamado Britta Simon en JobScore. Trabaje con el [equipo de soporte técnico de JobScore](mailto:support@jobscore.com) para agregar los usuarios a la plataforma de JobScore. Los usuarios se tienen que crear y activar antes de usar el inicio de sesión único.

### <a name="test-single-sign-on"></a>Prueba de inicio de sesión único

En esta sección, probará la configuración de inicio de sesión único de Azure AD mediante el Panel de acceso.

Al hacer clic en el icono de JobScore en el Panel de acceso, debería iniciar sesión automáticamente en la solución JobScore para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
