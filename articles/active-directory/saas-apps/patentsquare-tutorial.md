...
* PatentSQUARE admite inicio de sesión único iniciado por **SP**
...
4. En el cuadro de búsqueda, escriba **PatentSQUARE**, seleccione **PatentSQUARE** en el panel de resultados y haga clic en el botón **Agregar** para agregar la aplicación.
     ...
     ![PatentSQUARE en la lista de resultados](common/search-new-app.png)
...
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de PatentSQUARE.
...
2. **[Configuración del inicio de sesión único de PatentSQUARE](#configure-patentsquare-single-sign-on)**: para configurar los valores de Inicio de sesión único en la aplicación.
3. **[Creación de un usuario de prueba de Azure AD](#create-an-azure-ad-test-user)** , para probar el inicio de sesión único de Azure AD con Britta Simon.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)** , para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Creación de un usuario de prueba de PatentSQUARE](#create-patentsquare-test-user)**: para tener un homólogo de Britta Simon en PatentSQUARE que esté vinculado a la representación de ella en Azure AD.
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de la aplicación **PatentSQUARE**, seleccione **Inicio de sesión único**.
...
4. En la sección **Configuración básica de SAML**, siga estos pasos:
    ...
    ![Información sobre dominio y direcciones URL de inicio de sesión único de PatentSQUARE](common/sp-identifier.png)
    ...
    b. En el cuadro de texto **Identificador (id. de entidad)** , escriba una dirección URL con el siguiente patrón: `https://<companysubdomain>.pat-dss.com:443/patlics`

    > [!NOTE]
    > Estos valores no son reales. Actualice estos valores con la dirección URL y el identificador reales de inicio de sesión. Póngase en contacto con el [equipo de atención al cliente de PatentSQUARE](https://www.panasonic.com/jp/business/its/patentsquare.html) para obtener estos valores. También puede hacer referencia a los patrones que se muestran en la sección **Configuración básica de SAML** de Azure Portal.
...
5. En la sección **Set up PatentSQUARE** (Configurar PatentSQUARE), copie las direcciones URL adecuadas según sus necesidades.
...
### <a name="configure-patentsquare-single-sign-on"></a>Configuración del inicio de sesión único de PatentSQUARE

Para configurar el inicio de sesión único en **PatentSQUARE**, es preciso enviar el **XML de metadatos de federación** descargado y las direcciones URL apropiadas copiadas de Azure Portal al [equipo de soporte técnico de PatentSQUARE](https://www.panasonic.com/jp/business/its/patentsquare.html). Dicho equipo lo configura para establecer la conexión de SSO de SAML correctamente en ambos lados.
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones**, **PatentSQUARE**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **PatentSQUARE**.

    ![El vínculo de PatentSQUARE en la lista de aplicaciones](common/all-applications.png)
...
### <a name="create-patentsquare-test-user"></a>Creación de un usuario de prueba de PatentSQUARE
