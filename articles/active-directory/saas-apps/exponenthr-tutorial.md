...
## <a name="adding-exponenthr-from-the-gallery"></a>Adición de ExponentHR desde la galería
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-exponenthr"></a>Configuración y prueba del inicio de sesión único de Azure AD para ExponentHR
...
Para configurar y probar el inicio de sesión único de Azure AD con ExponentHR, es preciso completar los siguientes bloques de creación:
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de aplicaciones de **ExponentHR**, busque la sección **Administrar** y seleccione **Inicio de sesión único**.
...
1. En la sección **Configuración básica de SAML**, especifique los valores de los siguientes campos:
    ...
    En el cuadro de texto **URL de inicio de sesión**, escriba una dirección URL con el siguiente patrón: `https://www.exponenthr.com/service/saml/login.aspx`
...
Al hacer clic en el icono de ExponentHR en el panel de acceso, debería iniciar sesión automáticamente en la versión de ExponentHR para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
...
- [Pruebe ExponentHR con Azure AD](https://aad.portal.azure.com/)