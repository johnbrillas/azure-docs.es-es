...
1. Haga clic en **Habilitar autenticación SAML**.
    ...
    ![Captura de pantalla que muestra la opción "Users & System Administration" (Administración del sistema y de usuarios) seleccionada.](./media/kintone-tutorial/ic785882.png "Autenticación SAML")
...
1. Haga clic en **Nuevo usuario**.
    ...
    ![Captura de pantalla que muestra la sección "Users" (Usuarios) con la acción "New User" (Nuevo usuario) seleccionada.](./media/kintone-tutorial/ic785889.png "Nuevos usuarios")
