...
* Learning Seat LMS admite SSO iniciado por **SP y IDP**
...
4. En el cuadro de búsqueda, escriba **Learning Seat LMS**, seleccione **Learning Seat LMS** en el panel de resultados y haga clic en el botón **Agregar** para agregar la aplicación.

     ![Learning Seat LMS en la lista de resultados](common/search-new-app.png)
...
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de Learning Seat LMS.
...
2. **[Configuración del inicio de sesión único en Learning Seat LMS](#configure-learning-seat-lms-single-sign-on)** : para configurar los valores de Inicio de sesión único en la aplicación.
3. **[Creación de un usuario de prueba de Azure AD](#create-an-azure-ad-test-user)** , para probar el inicio de sesión único de Azure AD con Britta Simon.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)** , para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Creación de un usuario de prueba en Learning Seat LMS](#create-learning-seat-lms-test-user)** : para tener un homólogo de Britta Simon en Learning Seat LMS que esté vinculado a la representación del usuario en Azure AD.
...
Para configurar el inicio de sesión único de Azure AD con Learning Seat LMS, siga estos pasos:

1. En [Azure Portal](https://portal.azure.com/), en la página de integración de la aplicación **Learning Seat LMS**, haga clic en **Inicio de sesión único**.
...
### <a name="configure-learning-seat-lms-single-sign-on"></a>Configuración del inicio de sesión único de Learning Seat LMS
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones** y **Learning Seat LMS**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **Learning Seat LMS**.

    ![Vínculo de Learning Seat LMS en la lista de aplicaciones](common/all-applications.png)
...
Al hacer clic en el icono de Learning Seat LMS en el panel de acceso, debería iniciar sesión automáticamente en la versión de Learning Seat LMS para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
