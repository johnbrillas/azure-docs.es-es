...
> * [Inicio de sesión único](./invision-tutorial.md) en InVision (obligatorio)
...
3. Determine qué datos quiere [asignar entre Azure AD e InVision](../app-provisioning/customize-application-attributes.md). 
