---
title: 'Tutorial: Integración de Azure Active Directory con Allbound SSO | Microsoft Docs'
...
En este tutorial aprenderá a integrar Allbound SSO con Azure Active Directory (Azure AD).
La integración de Allbound SSO con Azure AD le proporciona las siguientes ventajas:

* Puede controlar en Azure AD quién tiene acceso a Allbound SSO.
* Puede permitir que los usuarios inicien sesión automáticamente en Allbound (inicio de sesión único) con sus cuentas de Azure AD.
...
Para configurar la integración de Azure AD con Allbound SSO, necesita lo siguiente:
...
## <a name="adding-allbound-sso-from-the-gallery"></a>Adición de Allbound SSO desde la galería
...
**Para agregar Allbound SSO desde la galería, realice los pasos siguientes:**
...
4. En el cuadro de búsqueda, escriba **Allbound SSO**, seleccione **Allbound SSO** en el panel de resultados y, a continuación, haga clic en el botón **Agregar** para agregar la aplicación.

    ![Allbound SSO en la lista de resultados](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configuración y prueba del inicio de sesión único en Azure AD

En esta sección, configurará y probará el inicio de sesión único de Azure AD con Allbound SSO con un usuario de prueba llamado **Britta Simon**.
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de Allbound SSO.

Para configurar y probar el inicio de sesión único de Azure AD con Allbound SSO, es preciso completar los siguientes bloques de creación:

1. **[Configuración del inicio de sesión único de Azure AD](#configure-azure-ad-single-sign-on)** : para que los usuarios puedan usar esta característica.
2. **[Configuración del inicio de sesión único de Allbound SSO](#configure-allbound-sso-single-sign-on)** : para configurar los valores de Inicio de sesión único en la aplicación.
3. **[Creación de un usuario de prueba de Azure AD](#create-an-azure-ad-test-user)** , para probar el inicio de sesión único de Azure AD con Britta Simon.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)** , para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Creación de un usuario de prueba en Allbound SSO](#create-allbound-sso-test-user)** : para tener un homólogo de Britta Simon en Allbound SSO que esté vinculado a la representación de usuario en Azure AD.
...
Para configurar el inicio de sesión único de Azure AD con Allbound SSO, realice los pasos siguientes:

1. En [Azure Portal](https://portal.azure.com/), en la página de integración de la aplicación **Allbound SSO**, seleccione **Inicio de sesión único**.
...
### <a name="configure-allbound-sso-single-sign-on"></a>Configuración del inicio de sesión único de Allbound SSO
...
En esta sección, permitirá que Britta Simon use el inicio de sesión único de Azure al concederle acceso a Allbound SSO.

1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones** y **Allbound SSO**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **Allbound SSO**.

    ![Vínculo a Allbound SSO en la lista de aplicaciones](common/all-applications.png)
...
Al hacer clic en el icono de Allbound SSO en el panel de acceso, debería iniciar sesión automáticamente en la versión de Allbound SSO para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
