...
* Convercent admite el inicio de sesión único iniciado por **SP** e **IDP**
...
4. En el cuadro de búsqueda, escriba **Convercent**, seleccione **Convercent** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.

    ![Convercent en la lista de resultados](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configuración y prueba del inicio de sesión único en Azure AD

En esta sección, podrá configurar y probar el inicio de sesión único de Azure AD con Convercent con un usuario de prueba llamado **Britta Simon**. Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de Convercent.
...
2. **[Configuración del inicio de sesión único de Convercent](#configure-convercent-single-sign-on)** : para configurar los valores de Inicio de sesión único en la aplicación.
3. **[Creación de un usuario de prueba de Azure AD](#create-an-azure-ad-test-user)** , para probar el inicio de sesión único de Azure AD con Britta Simon.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)** , para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Creación de un usuario de prueba de Convercent](#create-convercent-test-user)** : para tener un homólogo de Britta Simon en Convercent que esté vinculado a la representación del usuario en Azure AD.
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de la aplicación **Convercent**, haga clic en **Inicio de sesión único**.
...
5. Haga clic en **Establecer direcciones URL adicionales** y siga este paso si desea configurar la aplicación en el modo iniciado por **SP**:
    ...
    ![Información de dominio y direcciones URL de inicio de sesión único de Convercent](common/both-advanced-urls.png)

    a. En el cuadro de texto **URL de inicio de sesión**, escriba una dirección URL con el siguiente patrón: `https://<instancename>.convercent.com/`

    b. En el cuadro de texto **Estado de la retransmisión**, escriba una dirección URL que siga este patrón: `https://<instancename>.convercent.com/`
...
### <a name="configure-convercent-single-sign-on"></a>Configuración del inicio de sesión único de Convercent
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones**, **Convercent**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **Convercent**.

    ![Vínculo a Convercent en la lista de aplicaciones](common/all-applications.png)
...
Al hacer clic en el icono de Convercent en el panel de acceso y debería iniciar sesión automáticamente en la versión de Convercent para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
