...
* Puede permitir que los usuarios inicien sesión automáticamente en IMPAC Risk Manager (inicio de sesión único) con sus cuentas de Azure AD.
...
* IMPAC Risk Manager admite SSO iniciado por **SP e IDP**
...
4. En el cuadro de búsqueda, escriba **IMPAC Risk Manager**, seleccione **IMPAC Risk Manager** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.

    ![IMPAC Risk Manager en la lista de resultados](common/search-new-app.png)
...
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de IMPAC Risk Manager.
...
2. **[Configuración del inicio de sesión único de IMPAC Risk Manager](#configure-impac-risk-manager-single-sign-on)** : para configurar los valores de Inicio de sesión único en la aplicación.
3. **[Creación de un usuario de prueba de Azure AD](#create-an-azure-ad-test-user)** , para probar el inicio de sesión único de Azure AD con Britta Simon.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)** , para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Creación de un usuario de prueba en IMPAC Risk Manager](#create-impac-risk-manager-test-user)** : para tener un homólogo de Britta Simon en IMPAC Risk Manager que esté vinculado a su representación en Azure AD.
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de la aplicación **IMPAC Risk Manager**, seleccione **Inicio de sesión único**.
...
### <a name="configure-impac-risk-manager-single-sign-on"></a>Configuración del inicio de sesión único en IMPAC Risk Manager
...
1. En Azure Portal, seleccione sucesivamente **Aplicaciones empresariales**, **Todas las aplicaciones**, **IMPAC Risk Manager**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **IMPAC Risk Manager**.

    ![Vínculo a IMPAC Risk Manager en la lista de aplicaciones](common/all-applications.png)
...
Al hacer clic en el icono de IMPAC Risk Manager en el Panel de acceso, debería iniciar sesión automáticamente en la versión de IMPAC Risk Manager para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
