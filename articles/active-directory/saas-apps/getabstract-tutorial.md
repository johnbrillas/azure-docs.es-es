...
* Puede habilitar a los usuarios para que inicien sesión automáticamente en Getabstract (inicio de sesión único) con sus cuentas de Azure AD.
...
4. En el cuadro de búsqueda, escriba **Getabstract**, seleccione **Getabstract** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.

     ![Getabstract en la lista de resultados](common/search-new-app.png)
...
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de Getabstract.
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de aplicaciones de **Getabstract**, seleccione **Inicio de sesión único**.
...
### <a name="configure-getabstract-single-sign-on"></a>Configuración del inicio de sesión único de Getabstract
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones** y **Getabstract**.
...
Al hacer clic en el icono de Getabstract en el panel de acceso, debería iniciar sesión automáticamente en la instancia de Getabstract para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
