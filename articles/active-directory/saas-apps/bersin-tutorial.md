...
* Bersin admite SSO iniciado por **SP e IDP**
...
En esta sección, podrá configurar y probar el inicio de sesión único de Azure AD con Bersin con un usuario de prueba llamado **Britta Simon**. Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de Bersin.
...
7. En la sección **Set up Bersin** (Configurar Bersin), copie las direcciones URL adecuadas según sus necesidades.
...
2. En la lista de aplicaciones, seleccione **Bersin**.
    ...
    ![Vínculo a Bersin en la lista de aplicaciones](common/all-applications.png)
...
En esta sección, creará un usuario llamado Britta Simon en Bersin. Trabaje con el [equipo de soporte técnico de Bersin](mailto:USBersinServiceClient@deloitte.com) para agregar los usuarios del dominio o la plataforma de Bersin necesarios a la lista de permitidos de la plataforma de Bersin. Si el dominio lo agrega el equipo, los usuarios se aprovisionarán automáticamente en la plataforma de Bersin. Los usuarios se tienen que crear y activar antes de usar el inicio de sesión único.

### <a name="test-single-sign-on"></a>Prueba de inicio de sesión único

En esta sección, probará la configuración de inicio de sesión único de Azure AD mediante el Panel de acceso.

Al hacer clic en el icono de Bersin del Panel de acceso, debería iniciar sesión automáticamente en la versión de Bersin para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
