...
3. Determine qué datos quiere [asignar entre Azure AD y monday.com](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes). 
