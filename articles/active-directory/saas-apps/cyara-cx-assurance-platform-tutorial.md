...
En esta sección, creará un usuario llamado Britta Simon en Cyara CX Assurance Platform. Trabaje con el [equipo de soporte técnico de Cyara CX Assurance Platform](mailto:support@cyara.com) para agregar los usuarios a Cyara CX Assurance Platform. Los usuarios se tienen que crear y activar antes de usar el inicio de sesión único.
