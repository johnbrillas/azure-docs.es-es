...
4. En el cuadro de búsqueda, escriba **Consent2Go**, seleccione **Consent2Go** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.
    ...
    ![Consent2Go en la lista de resultados](common/search-new-app.png)
...
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de Consent2Go.
...
2. **[Configuración del inicio de sesión único de Consent2Go](#configure-consent2go-single-sign-on)** : para configurar los valores de Inicio de sesión único en la aplicación.
3. **[Creación de un usuario de prueba de Azure AD](#create-an-azure-ad-test-user)** , para probar el inicio de sesión único de Azure AD con Britta Simon.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)** , para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Creación de un usuario de prueba de Consent2Go](#create-consent2go-test-user)** : para tener un homólogo de Britta Simon en Consent2Go que esté vinculado a la representación del usuario en Azure AD.
...
4. En la sección **Configuración básica de SAML**, siga estos pasos:
    ...
    ![Información de dominio y direcciones URL de inicio de sesión único de Consent2Go](common/sp-signonurl.png)

    En el cuadro de texto **URL de inicio de sesión**, escriba una dirección URL: `https://www.mcbschools.com/Login`
...
### <a name="configure-consent2go-single-sign-on"></a>Configuración del inicio de sesión único de Consent2Go
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones**, **Consent2Go**.

    ![Hoja Aplicaciones empresariales](common/enterprise-applications.png)

2. En la lista de aplicaciones, seleccione **Consent2Go**.

    ![Vínculo a Consent2Go en la lista de aplicaciones](common/all-applications.png)
...
Al hacer clic en el icono de Consent2Go en el panel de acceso y debería iniciar sesión automáticamente en la versión de Consent2Go para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
