...
4. En el cuadro de búsqueda, escriba **myPolicies**, seleccione **myPolicies** en el panel de resultados y haga clic en el botón **Agregar** para agregar la aplicación.
...
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de myPolicies.
...
2. **[Configuración del inicio de sesión único de myPolicies](#configure-mypolicies-single-sign-on)**: para configurar los valores de Inicio de sesión único en la aplicación.
3. **[Creación de un usuario de prueba de Azure AD](#create-an-azure-ad-test-user)** , para probar el inicio de sesión único de Azure AD con Britta Simon.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)** , para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Creación de un usuario de prueba de myPolicies](#create-mypolicies-test-user)**: el objetivo es tener un homólogo de Britta Simon en myPolicies que esté vinculado a la representación del usuario en Azure AD.
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de la aplicación **myPolicies**, seleccione **Inicio de sesión único**.
...
4. En la página **Configurar inicio de sesión único con SAML** realice los siguientes pasos:
    ...
    ![Información de dominio y direcciones URL de inicio de sesión único de myPolicies](common/idp-intiated.png)
...
### <a name="configure-mypolicies-single-sign-on"></a>Configuración del inicio de sesión único de myPolicies
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones**, **myPolicies**.
...
Al hacer clic en el icono de myPolicies en el Panel de acceso y debería iniciar sesión automáticamente en la versión de myPolicies para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
