...
* BitaBIZ admite el inicio de sesión único iniciado tanto por **SP como por IDP**
...
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de BitaBIZ.
...
Para configurar el inicio de sesión único de Azure AD con BitaBIZ, siga estos pasos:

1. En [Azure Portal](https://portal.azure.com/), en la página de integración de la aplicación **BitaBIZ**, haga clic en **Inicio de sesión único**.
...
4. En la sección **Configuración básica de SAML**, si quiere configurar la aplicación en modo iniciado por **IDP**, realice los siguientes pasos:
    ...
    ![Información sobre dominio y direcciones URL de inicio de sesión único de BitaBIZ](common/idp-identifier.png)

    En el cuadro de texto **Identificador**, escriba una dirección URL con el patrón siguiente: `https://www.bitabiz.com/<instanceId>`.
...
### <a name="configure-bitabiz-single-sign-on"></a>Configuración del inicio de sesión único en BitaBIZ
...
1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones** y **BitaBIZ**.
...
Al hacer clic en el icono de BitaBIZ en el Panel de acceso, debería iniciar sesión automáticamente en la instancia de BitaBIZ para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
