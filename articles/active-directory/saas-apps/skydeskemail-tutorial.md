...
1. En el menú en la parte superior, haga clic en **Setup** (Configurar) y seleccione **Org** (Organización).
    ...
    ![Captura de pantalla que muestra la opción de organización seleccionada en el menú de configuración.](./media/skydeskemail-tutorial/tutorial_skydeskemail_51.png)
  
1. En el panel izquierdo, haga clic en **Domains** (Dominios).

    ![Captura de pantalla que muestra la opción de dominios seleccionada en el panel de control.](./media/skydeskemail-tutorial/tutorial_skydeskemail_53.png)

1. Haga clic en **Add Domain** (Agregar dominio).

    ![Captura de pantalla que muestra la opción para agregar dominio seleccionada.](./media/skydeskemail-tutorial/tutorial_skydeskemail_54.png)

1. Escriba el nombre de dominio y, a continuación, compruebe el dominio.

    ![Captura de pantalla que muestra la pestaña para agregar dominio, donde puede escribir su dominio.](./media/skydeskemail-tutorial/tutorial_skydeskemail_55.png)

1. Haga clic en **SAML Authentication** (Autenticación SAML) desde el panel izquierdo.

    ![Captura de pantalla muestra la opción de autenticación SAML seleccionada en el panel de control.](./media/skydeskemail-tutorial/tutorial_skydeskemail_52.png)

1. En la página de diálogo **SAML Authentication** (Autenticación SAML), siga estos pasos:

    ![Captura de pantalla que muestra el cuadro de diálogo de detalles de autenticación de SAML, donde puede especificar los valores descritos.](./media/skydeskemail-tutorial/tutorial_skydeskemail_56.png)
    ...
    ![Captura de pantalla que muestra la dirección U R L del portal donde escribe el nombre.](./media/skydeskemail-tutorial/tutorial_skydeskemail_57.png)
...
![Captura de pantalla que muestra la opción de acceso de usuario seleccionada en el panel de control.](./media/skydeskemail-tutorial/tutorial_skydeskemail_58.png)
