...
1. En la sección **Access page** (Página de acceso), haga clic en **Setup** (Configurar).
    ...
    ![Captura de pantalla que muestra la sección "Access Page" (Página de acceso) con el botón "Setup" (Configurar).](./media/screencast-tutorial/tutorial_screencast_setup.png)
...
1. En la sección **Access URL** (Dirección URL de acceso), escriba el nombre de instancia en el cuadro de texto indicado.
    ...
    ![Captura de pantalla que muestra la sección "Access U R L" (Dirección U R L de acceso) con el cuadro de texto de nombre de instancia resaltado.](./media/screencast-tutorial/tutorial_screencast_access.png)
