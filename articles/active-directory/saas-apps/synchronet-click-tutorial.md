---
title: 'Tutorial: Integración del inicio de sesión único (SSO) de Azure Active Directory con SynchroNet CLICK | Microsoft Docs'
...
ms.locfileid: "92517861"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-synchronet-click"></a>Tutorial: Integración del inicio de sesión único (SSO) de Azure Active Directory con SynchroNet CLICK
...
## <a name="adding-synchronet-click-from-the-gallery"></a>Incorporación de SynchroNet CLICK desde la galería
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-synchronet-click"></a>Configuración y prueba del inicio de sesión único de Azure AD para SynchroNet CLICK
...
Para configurar y probar el inicio de sesión único de Azure AD con SynchroNet CLICK, es preciso completar los siguientes bloques de creación:
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de aplicaciones de **SynchroNet CLICK**, busque la sección **Administrar** y seleccione **Inicio de sesión único**.
...
Al hacer clic en el icono de SynchroNet CLICK en el Panel de acceso, debería iniciar sesión automáticamente en la versión de SynchroNet CLICK para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
...
- [Pruebe SynchroNet CLICK con Azure AD](https://aad.portal.azure.com/)

- [¿Qué es el control de sesiones en Microsoft Cloud App Security?](/cloud-app-security/proxy-intro-aad)

- [Protección de SynchroNet CLICK con controles y visibilidad avanzados](/cloud-app-security/proxy-intro-aad)