...
2. Si desea realizar pruebas en **modo iniciado por SP**:
    ...
    b. Escriba su `subdomain` en el cuadro de texto que se muestra y presione **Siguiente**. Iniciará sesión automáticamente en su aplicación **Direct**.
