...
* Una vez configurado Community Spark, puede aplicar el control de sesión, que protege la filtración y la infiltración de la información confidencial de la organización en tiempo real. El control de sesión procede del acceso condicional. [Aprenda a aplicar el control de sesión con Microsoft Cloud App Security](/cloud-app-security/proxy-deployment-any-app).
...
- [Procedimiento para proteger Community Spark con controles y visibilidad avanzados](/cloud-app-security/proxy-intro-aad)