...
description: Conozca los pasos que debe seguir en Jive y en Azure AD para aprovisionar y cancelar el aprovisionamiento de forma automática de cuentas de usuario de Azure AD a Jive.
