...
## <a name="adding-visibly-from-the-gallery"></a>Incorporación de Visibly desde la galería
...
Para configurar y probar el inicio de sesión único de Azure AD con Visibly, es preciso completar los siguientes bloques de creación:
...
Al hacer clic en el icono de Visibly en el panel de acceso, debería iniciar sesión automáticamente en la instancia de Visibly para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
...
- [Probar Visibly con Azure AD](https://aad.portal.azure.com/)
