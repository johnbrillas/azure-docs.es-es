...
## <a name="configure-and-test-azure-ad-single-sign-on-for-greenlight-integration-platform"></a>Configuración y prueba del inicio de sesión único de Azure AD para Greenlight Integration Platform
...
Para configurar y probar el inicio de sesión único de Azure AD con Greenlight Integration Platform, es preciso completar los siguientes bloques de creación:
...
1. **[Configuración del inicio de sesión único en Greenlight Integration Platform](#configure-greenlight-integration-platform-sso)** , para configurar los valores de inicio de sesión único en la aplicación.
    * **[Creación de un usuario de prueba de Greenlight Integration Platform](#create-greenlight-integration-platform-test-user)** , para tener un homólogo de B.Simon en Greenlight Integration Platform que esté vinculado a la representación Azure AD del usuario.
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de la aplicación **Greenlight Integration Platform**, busque la sección **Administrar** y seleccione **Inicio de sesión único**.
...
Al hacer clic en el icono de Greenlight Integration Platform en el panel de acceso, debería iniciar sesión automáticamente en la aplicación Greenlight Integration Platform para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
...
- [Pruebe Greenlight Integration Platform con Azure AD](https://aad.portal.azure.com/)

- [¿Qué es el control de sesiones en Microsoft Cloud App Security?](/cloud-app-security/proxy-intro-aad)

- [Cómo proteger Greenlight Integration Platform con visibilidad y controles avanzados](/cloud-app-security/proxy-intro-aad)