...
4. En la sección **Configuración básica de SAML**, si quiere configurar la aplicación en modo iniciado por **IDP**, realice los siguientes pasos:
    ...
    ![Captura de pantalla que muestra la configuración básica de SAML para escribir el valor de Dirección U R L de respuesta y seleccionar Guardar.](common/both-replyurl.png)
