...
En este tutorial, aprenderá a integrar AuditBoard con Azure Active Directory (Azure AD).
La integración de AuditBoard con Azure AD proporciona las siguientes ventajas:

* Puede controlar en Azure AD quién tiene acceso a AuditBoard.
* Puede permitir que los usuarios inicien sesión automáticamente en AuditBoard (inicio de sesión único) con sus cuentas de Azure AD.
...
## <a name="adding-auditboard-from-the-gallery"></a>Adición de AuditBoard desde la galería
...
**Para agregar AuditBoard desde la galería, realice los pasos siguientes:**
...
4. En el cuadro de búsqueda, escriba **AuditBoard**, seleccione **AuditBoard** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.

    ![AuditBoard en la lista de resultados](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configuración y prueba del inicio de sesión único en Azure AD

En esta sección, configurará y probará el inicio de sesión único de Azure AD con AuditBoard con un usuario de prueba llamado **Britta Simon**.
Para que el inicio de sesión único funcione, es preciso establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de AuditBoard.

Para configurar y probar el inicio de sesión único de Azure AD con AuditBoard, es preciso completar los siguientes bloques de creación:

1. **[Configuración del inicio de sesión único de Azure AD](#configure-azure-ad-single-sign-on)** : para que los usuarios puedan usar esta característica.
2. **[Configuración del inicio de sesión único de AuditBoard](#configure-auditboard-single-sign-on)** : para configurar los valores de Inicio de sesión único en la aplicación.
3. **[Creación de un usuario de prueba de Azure AD](#create-an-azure-ad-test-user)** , para probar el inicio de sesión único de Azure AD con Britta Simon.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)** , para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Creación de un usuario de prueba de AuditBoard](#create-auditboard-test-user)** : para tener un homólogo de Britta Simon en AuditBoard que esté vinculado a la representación del usuario en Azure AD.
...
Para configurar el inicio de sesión único de Azure AD con AuditBoard, realice los pasos siguientes:

1. En [Azure Portal](https://portal.azure.com/), en la página de integración de la aplicación **AuditBoard**, seleccione **Inicio de sesión único**.
...
### <a name="configure-auditboard-single-sign-on"></a>Configuración del inicio de sesión único de AuditBoard
...
En esta sección, habilitará a Britta Simon para que use el inicio de sesión único de Azure concediéndole acceso a AuditBoard.

1. En Azure Portal, seleccione **Aplicaciones empresariales**, **Todas las aplicaciones**, **AuditBoard**.
...
Al hacer clic en el icono de AuditBoard en el panel de acceso y debería iniciar sesión automáticamente en la versión de AuditBoard para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
