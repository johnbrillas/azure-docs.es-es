---
title: 'Tutorial: Integración del inicio de sesión único (SSO) de Azure Active Directory con IQNavigator VMS | Microsoft Docs'
...
En este tutorial, obtendrá información sobre cómo integrar IQNavigator VMS con Azure Active Directory (Azure AD). Al integrar IQNavigator VMS con Azure AD, puede hacer lo siguiente:

* Controlar en Azure AD quién tiene acceso a IQNavigator VMS.
* Permitir que los usuarios puedan iniciar sesión automáticamente en IQNavigator VMS con sus cuentas de Azure AD.
...
* Una suscripción habilitada para el inicio de sesión único (SSO) en IQNavigator VMS.
...
1. En la sección **Agregar desde la galería**, escriba **IQNavigator VMS** en el cuadro de búsqueda.
1. Seleccione **IQNavigator VMS** en el panel de resultados y, a continuación, agregue la aplicación. Espere unos segundos mientras la aplicación se agrega al inquilino.


## <a name="configure-and-test-azure-ad-single-sign-on-for-iqnavigator-vms"></a>Configuración y prueba del inicio de sesión único de Azure AD para IQNavigator VMS

Configure y pruebe el inicio de sesión único de Azure AD con IQNavigator VMS mediante un usuario de prueba llamado **B.Simon**. Para que el inicio de sesión único funcione, es preciso establecer una relación de vinculación entre un usuario de Azure AD y el usuario relacionado de IQNavigator VMS.
...
1. **[Configuración del inicio de sesión único de IQNavigator VMS](#configure-iqnavigator-vms-sso)** : para configurar los valores de inicio de sesión único en la aplicación.
    1. **[Creación de un usuario de prueba de IQNavigator VMS](#create-iqnavigator-vms-test-user)** : para tener un homólogo de B.Simon en IQNavigator VMS vinculado a la representación del usuario en Azure AD.
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de aplicaciones de **IQNavigator VMS**, busque la sección **Administrar** y seleccione **Inicio de sesión único**.
...
En esta sección, va a conceder a B.Simon acceso a IQNavigator VMS mediante el inicio de sesión único de Azure.
...
- [Pruebe IQNavigator VMS con Azure AD](https://aad.portal.azure.com/).