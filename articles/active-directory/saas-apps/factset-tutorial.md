...
* Una vez configurado FactSet, puede aplicar el control de sesión, que protege la filtración y la infiltración de la información confidencial de la organización en tiempo real. El control de sesión procede del acceso condicional. [Aprenda a aplicar el control de sesión con Microsoft Cloud App Security](/cloud-app-security/proxy-deployment-any-app).
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-factset"></a>Configuración y prueba del inicio de sesión único de Azure AD para FactSet
...
1. En [Azure Portal](https://portal.azure.com/), en la página de integración de aplicaciones de **FactSet**, busque la sección **Administrar** y seleccione **Inicio de sesión único**.
...
1. En la página **Configurar el inicio de sesión único con SAML**, escriba los valores de los siguientes campos:
    ...
    a. En el cuadro de texto **Identificador**, escriba una dirección URL: `https://login.factset.com`

    b. En el cuadro de texto **URL de respuesta**, escriba una dirección URL: `https://login.factset.com/services/saml2/`
...
Al hacer clic en el icono de FactSet en el Panel de acceso, debería iniciar sesión automáticamente en la versión de FactSet para la que configuró el inicio de sesión único. Para más información sobre el Panel de acceso, consulte [Introducción al Panel de acceso](../user-help/my-apps-portal-end-user-access.md).
...
- [Pruebe FactSet con Azure AD](https://aad.portal.azure.com/)

- [¿Qué es el control de sesiones en Microsoft Cloud App Security?](/cloud-app-security/proxy-intro-aad)

- [Protección de FactSet con controles y visibilidad avanzados](/cloud-app-security/proxy-intro-aad)