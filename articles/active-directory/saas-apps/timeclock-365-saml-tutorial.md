...
1. Para automatizar la configuración en Timeclock 365 SAML, debe instalar la **extensión del explorador de inicio de sesión seguro de Aplicaciones**. Para ello, haga clic en **Instalar la extensión**.
