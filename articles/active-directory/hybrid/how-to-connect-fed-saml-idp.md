---
title: 'Azure AD Connect: Uso de un proveedor de identidades (IdP) de SAML 2.0 para un inicio de sesión único - Azure'
...
Se recomienda importar siempre los metadatos más recientes de Azure AD al configurar el proveedor de identidades de SAML 2.0.

>[!NOTE]
>Azure AD no lee los metadatos del proveedor de identidades.
...
2. Cree una nueva entidad de seguridad de usuario:
...
Para obtener más información sobre "New-MsolUser", consulte [/previous-versions/azure/dn194096(v=azure.100)](/previous-versions/azure/dn194096(v=azure.100)).

>[!NOTE]
>El valor "UserPrincipalName" debe coincidir con el valor que se enviará para "IDPEmail" en la notificación de SAML 2.0, y el valor "ImmutableID" debe coincidir con el valor enviado en la aserción "NameID".
