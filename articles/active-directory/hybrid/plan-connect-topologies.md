...
* Un máximo de cinco inquilinos de Azure Active Directory puede tener una implementación híbrida de Exchange con la instancia local de Active Directory en el entorno local. Este escenario se describe en [Actualización del asistente para la configuración híbrida de septiembre de 2020](https://techcommunity.microsoft.com/t5/exchange-team-blog/september-2020-hybrid-configuration-wizard-update/ba-p/1687698).
* La instancia de Exchange Server que ejecuta el asistente para la configuración híbrida debe ser 2016 CU18 o 2019 CU7 o posterior.
* Cada instancia de Azure AD Connect debe ejecutarse en una máquina unida a un dominio.
* Azure AD Connect se debe configurar mediante la opción de filtrado dominio/unidad organizativa para filtrar a los usuarios desde el directorio local. El uso de esta opción garantiza que los usuarios solo aparecen en un único inquilino de Exchange en línea.
