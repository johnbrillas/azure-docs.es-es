...
En Windows 10, se recomienda usar el inicio de sesión único mediante el token de actualización principal (PRT). En Windows 7 y 8.1, se recomienda usar el inicio de sesión único de conexión directa.
