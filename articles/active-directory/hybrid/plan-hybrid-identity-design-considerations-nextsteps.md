...
* [MDM para Microsoft 365](/microsoft-365/admin/basic-mobility-security/overview) le permite administrar y proteger los dispositivos móviles cuando están conectados a su organización de Microsoft 365. Puede usar MDM para Microsoft 365 para establecer reglas de acceso y directivas de seguridad para los dispositivos, y para eliminar dispositivos móviles si se pierden o son objeto de robo.
...
* [Blog de Microsoft en la nube](https://cloudblogs.microsoft.com/)
* [Blog de Microsoft Intune](https://techcommunity.microsoft.com/t5/intune-customer-success/welcome-to-the-new-intune-customer-success-blog/ba-p/281367)
