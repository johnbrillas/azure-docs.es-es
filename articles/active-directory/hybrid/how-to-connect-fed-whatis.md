...
| [Reparación de la confianza](how-to-connect-fed-management.md#repairthetrust) |Repare la confianza actual entre AD FS local y Microsoft 365 o Azure. |
...
| [Renovación de certificados de federación para Microsoft 365 y Azure AD](how-to-connect-fed-o365-certs.md)|Renueve su certificado de Office 365 con Azure AD.|
