...
>
> 1. Vaya a la experiencia de inicio rápido <a href="https://aka.ms/aspnetcore2-1-aad-quickstart-v2/" target="_blank">Azure Portal: Registros de aplicaciones</a>.
...
> Para que el código de ejemplo de este inicio rápido funcione, agregue un **URI de redirección**  de `https://localhost:44321/` y `https://localhost:44321/signin-oidc`, y un valor para **Front-channel logout URL** (Dirección URL de cierre de sesión del canal frontal) de `https://localhost:44321/signout-oidc`. El punto de conexión de autorización emitirá los tokens de identificador de solicitud.
