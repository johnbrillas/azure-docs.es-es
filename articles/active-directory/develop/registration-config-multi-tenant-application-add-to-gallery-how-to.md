...
2. Envíe la solicitud como se describe en [Aprenda a mostrar su aplicación en la galería de aplicaciones de Azure Active Directory](./v2-howto-app-gallery-listing.md).
...
Aprenda cómo [mostrar la aplicación en la galería de aplicaciones de Azure Active Directory](./v2-howto-app-gallery-listing.md).