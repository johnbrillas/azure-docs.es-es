...
#### <a name="step-2-download-your-electron-project"></a>Paso 2: Descarga del proyecto de Electron
...
> [!div renderon="docs"]
> #### <a name="step-3-configure-your-electron-project"></a>Paso 3: Configuración del proyecto de Electron
>
