...
1. En la sección **Implicit grant and hybrid flows** (Concesión implícita y flujos híbridos), seleccione **Tokens de id.** y, luego, elija **Guardar**.
