...
1. Establezca la configuración de cifrado de tokens mediante el comando **[Set-AzureApplication](/powershell/module/azuread/set-azureadapplication?view=azureadps-2.0-preview)** .
