...
Algunas aplicaciones de Microsoft y SaaS incluyen domain_hints de forma automática (por ejemplo, `https://outlook.com/contoso.com` genera una solicitud de inicio de sesión con `&domain_hint=contoso.com` anexado), lo que puede interrumpir la implementación de credenciales administradas, como Fido.  Puede usar la [directiva Detección de dominio principal](https://docs.microsoft.com/graph/api/resources/homeRealmDiscoveryPolicy) para omitir las sugerencias de dominio que proceden de determinadas aplicaciones, o para determinados dominios, durante la implementación de credenciales administradas.  
...
El tipo de directiva es "[HomeRealmDiscoveryPolicy](https://docs.microsoft.com/graph/api/resources/homeRealmDiscoveryPolicy)".
