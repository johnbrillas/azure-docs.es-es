...
1. En la barra de búsqueda del portal, busque y seleccione la instancia de Azure Database for MySQL con la opción Servidor flexible que ha creado, como **mydemoserver**.
