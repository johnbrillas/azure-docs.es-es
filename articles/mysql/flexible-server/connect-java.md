---
title: 'Inicio rápido: Uso de Java y JDBC con Servidor flexible de Azure Database for MySQL'
description: Aprenda a usar Java y JDBC con una base de datos de Servidor flexible de Azure Database for MySQL.
author: mksuni
ms.author: sumuth
ms.service: mysql
...
ms.locfileid: "98606027"
---
# <a name="quickstart-use-java-and-jdbc-with-azure-database-for-mysql-flexible-server"></a>Inicio rápido: Uso de Java y JDBC con Servidor flexible de Azure Database for MySQL

En este tema se muestra cómo crear una aplicación de ejemplo que utiliza Java y [JDBC](https://en.wikipedia.org/wiki/Java_Database_Connectivity) para almacenar y recuperar información de [Servidor flexible de Azure Database for MySQL](./index.yml).
...
> [!NOTE]
> Puede leer información más detallada sobre la creación de servidores de MySQL en [Creación de un servidor de Azure Database for MySQL mediante Azure Portal](./quickstart-create-server-portal.md).
...
Asegúrese de escribir <YOUR-IP-ADDRESS> (su dirección IP) para acceder al servidor desde el equipo local. Este comando crea un Servidor flexible de MySQL en el nivel ampliable, adecuado para desarrollo.

El servidor MySQL que ha creado tiene una base de datos vacía llamada **flexibleserverdb**. Usaremos esta base de datos para este artículo.
