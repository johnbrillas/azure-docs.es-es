...
| Herramientas relacionadas en DSVM       | <ul><li>SQL Server Management Studio</li><li>Controladores ODBC/JDBC</li><li>pyodbc, RODBC</li><li>Apache Drill</li></ul> |
