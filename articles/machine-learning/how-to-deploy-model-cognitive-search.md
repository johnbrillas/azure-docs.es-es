...
description: Aprenda a utilizar Azure Machine Learning para implementar un modelo y utilizarlo con Cognitive Search. El modelo se utiliza como una aptitud personalizada para enriquecer la experiencia de búsqueda.
