---
title: 'ML Studio (clásico): Redes neuronales personalizadas de Net# en Azure'
...
+ La aridad de la agrupación es 3: es decir, la longitud de las tuplas `InputShape`, `KernelShape` y `Stride`.
