...
description: Aprenda a llevar los modelos de aprendizaje automático entrenados fuera de Azure a la nube de Azure con Azure Machine Learning. A continuación, implemente el modelo como un servicio web o un módulo de IoT.
...
* [Un área de trabajo de Azure Machine Learning](how-to-manage-workspace.md)
  + En los ejemplos de Python se supone que la variable `ws` está establecida en el área de trabajo de Azure Machine Learning. Para obtener más información sobre cómo conectarse al área de trabajo, consulte la documentación del SDK de [Azure Machine Learning para Python](/python/api/overview/azure/ml/#workspace).
...
* La [CLI de Azure](/cli/azure/install-azure-cli) y la [extensión de la CLI de Machine Learning](reference-azure-machine-learning-cli.md).
...
Para obtener más información, consulte la referencia [az ml model register](/cli/azure/ext/azure-cli-ml/ml/model#ext-azure-cli-ml-az-ml-model-register).
...
+ Referencia de [InferenceConfig](/python/api/azureml-core/azureml.core.model.inferenceconfig).
...
Para obtener más información sobre, consulte la referencia [LocalWebservice.deploy_configuration()](/python/api/azureml-core/azureml.core.webservice.localwebservice#deploy-configuration-port-none-).
...
Para obtener más información, consulte la referencia [Model.deploy()](/python/api/azureml-core/azureml.core.model.model#deploy-workspace--name--models--inference-config-none--deployment-config-none--deployment-target-none--overwrite-false-).
