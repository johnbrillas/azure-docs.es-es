...
Azure Container Registry (ACR) no admite actualmente caracteres Unicode en los nombres de los grupos de recursos. Para corregir este problema, use un grupo de recursos que no contenga estos caracteres.
