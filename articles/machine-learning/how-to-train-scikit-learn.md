...
Ejecute este código en cualquiera de estos entornos:
 ...
 - Su propio servidor de Jupyter Notebook
    ...
    - [Instale el SDK de Azure Machine Learning](/python/api/overview/azure/ml/install) (>= 1.13.0).
