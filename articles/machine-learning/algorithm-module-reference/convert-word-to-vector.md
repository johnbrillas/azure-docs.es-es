...
En el ejemplo siguiente se muestra cómo funciona el módulo de conversión de palabras en vectores. Usa el módulo de conversión de palabras en vectores con la configuración predeterminada en el conjunto de datos preprocesados del SP 500 de Wikipedia.
