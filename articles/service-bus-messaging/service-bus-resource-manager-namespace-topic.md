...
Para ver la plantilla completa, consulte la [Plantilla de espacio de nombres de Service Bus con un tema y una suscripción][Service Bus namespace with topic and subscription] .
