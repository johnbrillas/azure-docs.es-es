...
1. Opcionalmente, puede establecer *Query_s* para que busque una cadena o sintaxis específica. Por ejemplo, puede filtrar por *es igual a* `?api-version=2020-06-30&search=*&%24filter=HotelName`).
