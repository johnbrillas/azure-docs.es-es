...
description: Aprenda a crear y administrar objetos de búsqueda en una aplicación de .NET con C# y Microsoft.Azure.Search (versión 10) del SDK de .NET. Los fragmentos de código muestran la conexión al servicio, la creación de índices y las consultas.
manager: nitinme
author: brjohnstmsft
ms.author: brjohnst
ms.devlang: dotnet
...
En este artículo se explica cómo crear y administrar objetos de búsqueda mediante C# y la biblioteca cliente heredada, [**Microsoft.Azure.Search**](/dotnet/api/overview/azure/search/client10) (versión 10) en el SDK de Azure para .Net. 

La versión 10 es la última versión del paquete Microsoft.Azure.Search. En el futuro, el equipo del SDK de Azure implementará características nuevas en [**Azure.Search.Documents**](/dotnet/api/overview/azure/search.documents-readme).

> [!NOTE]
> Si tiene proyectos de desarrollo existentes o en proceso, puede seguir usando la versión 10. Si va a crear proyectos nuevos o quiere usar características nuevas, debe realizar la transición a la [nueva biblioteca](/dotnet/api/overview/azure/search.documents-readme).

## <a name="about-version-10"></a>Acerca de la versión 10
