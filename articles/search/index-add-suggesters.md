...
En C#, defina un [objeto SearchSuggester](/dotnet/api/azure.search.documents.indexes.models.searchsuggester). `Suggesters` es una colección de un objeto SearchIndex, pero solo puede tomar un elemento. Agregue un proveedor de sugerencias a la definición del índice.
