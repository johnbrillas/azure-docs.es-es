...
| [Expansion de puntuación de relevancia de featuresMode (versión preliminar)](index-similarity-and-scoring.md#featuresMode-param) | Consultar | Agregue este parámetro de consulta para expandir una puntuación de relevancia y mostrar más detalles: la puntuación de similitud por campo, la frecuencia de los términos por campo y el número de tokens únicos coincidentes por campo. <br/><br/>Los algoritmos de puntuación personalizados pueden utilizar esta información. *El aprendizaje para clasificar* los algoritmos es una funcionalidad de puntuación personalizada avanzada que se puede implementar al proporcionar los detalles de puntuación de relevancia. Para obtener un ejemplo que muestra esta funcionalidad, consulte [Adición de aprendizaje automático (LearnToRank) a la relevancia de búsqueda](https://github.com/Azure-Samples/search-ranking-tutorial). | Versión preliminar pública. </br> Use la [API REST de búsqueda 2020-06-30-Preview](/rest/api/searchservice/index-preview) o la API REST 2019-05-06-Preview. |
...
## <a name="2019-feature-announcements"></a>2019: Anuncios de características
