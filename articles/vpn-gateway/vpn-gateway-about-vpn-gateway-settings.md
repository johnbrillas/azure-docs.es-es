...
description: Obtenga información sobre los recursos de VPN Gateway y sobre la configuración de una red virtual creada en el modelo de implementación de Resource Manager.
