...
- [Creación de una instancia de VPN Gateway basada en rutas mediante Azure Portal](./tutorial-create-gateway-portal.md)
...
- [Integraciones de ejemplo de Azure Policy para la red virtual](../virtual-network/policy-reference.md)
