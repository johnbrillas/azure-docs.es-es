...
Si no tiene una red virtual clásica y lleva a cabo estos pasos como ejercicio, puede crear una red virtual según [este artículo](/previous-versions/azure/virtual-network/virtual-networks-create-vnet-classic-pportal) y los valores de configuración de [ejemplo](#values) indicados anteriormente.
...
### <a name="3-create-the-virtual-network-gateway"></a><a name="classicgw"></a>3. Creación de la puerta de enlace de red virtual
