---
title: 'Ejemplos de la CLI de Azure: Azure App Configuration'
description: Información acerca de scripts de ejemplo proporcionados para Azure App Configuration
...
ms.locfileid: "96929130"
---
# <a name="azure-cli-samples"></a>Ejemplos de la CLI de Azure

En la tabla siguiente se incluyen vínculos a scripts de Bash para Azure App Configuration creados con la CLI de Azure.
