...
Para ver un ejemplo rápido, eche un vistazo a [Uso de Event Grid para las notificaciones de cambio de datos](./howto-app-configuration-event.md). 
...
- [Uso de Event Grid para las notificaciones de cambios de datos](./howto-app-configuration-event.md)