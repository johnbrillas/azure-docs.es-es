---
title: Notas de la versión de Azure Stack Edge Pro 2012
description: Aquí se describen las incidencias críticas pendientes y las resoluciones de Azure Stack Edge Pro versión 2012.
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge
...
ms.locfileid: "97364541"
---
# <a name="azure-stack-edge-2012-release-notes"></a>Notas de la versión de Azure Stack Edge 2012

En las notas de la versión siguientes se identifican las incidencias críticas pendientes e incidencias resueltas de la versión 2012 de los dispositivos Azure Stack Edge. Estas notas de la versión se aplican a los dispositivos de Azure Stack Edge Pro con GPU, Azure Stack Edge Pro R y Azure Stack Edge Mini R. Las características y las incidencias que corresponden a un modelo específico se indican siempre que proceda.
...
Este artículo se aplica a la versión **Azure Stack Edge 2012**, correspondiente al número de versión de software **2.2.1438.2470**.

## <a name="whats-new"></a>Novedades

Ya están disponibles las siguientes características nuevas en la versión 2012 de Azure Stack Edge. 
...
## <a name="known-issues-in-2012-release"></a>Problemas conocidos de la versión 2012

En la tabla siguiente se proporciona un resumen de los problemas conocidos de la versión 2012.
