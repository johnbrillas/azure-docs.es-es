...
| Dynamics 365 for Customer Engagement | Revise las [directrices y el proceso de publicación](/dynamics365/customer-engagement/developer/publish-app-appsource).<br/>Para publicar una oferta en el Centro de partners, consulte [Creación de una nueva oferta de Dynamics 365 for Customer Engagement y Power Apps](./partner-center-portal/create-new-customer-engagement-offer.md).  |
