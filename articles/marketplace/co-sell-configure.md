...
Debe aportar documentos auxiliares que proporcionen detalles sobre su oferta. Los equipos de ventas de Microsoft usan esta información para evaluar si la oferta satisface las necesidades de los clientes con el fin de recomendarla y venderla. Cuanta más información proporcione, más datos tendrán los equipos de ventas de Microsoft para comprender y promocionar el producto.
...
| :------------------- | :-------------------|
| *Página de descripción de la solución u oferta (obligatorio)* | Dé a conocerse entre clientes potenciales con una página profesional que presenta la propuesta de valor de su solución.<br><br>Puede usar una de las plantillas pertinentes para proporcionar una descripción lista para el cliente de su oferta:<br><ul><li> [Plantilla de una página de Microsoft Azure](https://aka.ms/Customer-One-Pager_MicrosoftAzure)</li><li>[Plantilla de una página de Microsoft Dynamics 365](https://aka.ms/Customer-One-Pager_MicrosoftDynamics365)</li> <li>[Plantilla de una página de Microsoft 365](https://aka.ms/Customer-One-Pager_MicrosoftOffice365) </li><li>[Plantilla de una página de Windows 10](https://aka.ms/Customer-One-Pager_Windows)</li></ul> <br> Los equipos de ventas de Microsoft pueden compartir esta información con los clientes para ayudar a determinar si su oferta puede ser un buen ajuste, así como para asegurarse de que está lista para el cliente. |
| *Presentación de la solución u oferta (obligatorio)* | Puede usar la [plantilla de presentación de cliente](https://aka.ms/GTMServices_CustomerPresentation) para crear su presentación. Esta presentación debe hacer referencia al [diagrama de arquitectura de referencia](reference-architecture-diagram.md). El objetivo de esta presentación de diapositivas es lanzar la oferta y su propuesta de valor. Tras asegurarse de que la oferta está lista para el cliente, los equipos de ventas de Microsoft pueden compartir esta presentación con los clientes para articular el valor que su empresa y Microsoft aportan al implementar una solución conjunta. La presentación debe hablar de qué hace la oferta, cómo puede ayudar a los clientes, para qué sectores es pertinente y cómo se compara con las soluciones de la competencia. |
...
- Después de crear los documentos, arrástrelos al cuadro correspondiente en **Documentos**, o bien seleccione **explora tus archivos** para cargar un documento desde el equipo.

    [![Muestra la sección de documentación para la venta conjunta de la pestaña Venta conjunta con Microsoft.](./media/co-sell/co-sell-documents-section.png)](./media/co-sell/co-sell-documents-section.png#lightbox)
...
1. Abra el archivo .csv en una aplicación, como Microsoft Excel, y luego rellene cada fila con información sobre el contacto.
    ...
    ***Tabla 3: Descripción de los roles***
    ...
    - Países o regiones (obligatorio): al rellenar la plantilla, use los [códigos de país y región de venta conjunta](commercial-marketplace-co-sell-countries.md) de dos letras. Si el contacto cubre todos los países y regiones, use el código de tres letras "OOO". Si un contacto cubre más de un país o región, escriba cada uno de los códigos de dos letras separados por una coma. Por ejemplo, escriba "US, CA, FR" sin comillas en la plantilla.
        ...
        Los países y regiones deben reflejar el territorio de cada contacto. Los equipos de ventas de Microsoft y los revendedores del canal usan estos datos para solicitar información o colaborar en las ventas en el país o región específicos.
