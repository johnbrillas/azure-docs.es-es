...
- El grupo [iniciativa predeterminada](#azure-security-center-initiatives) muestra todas las definiciones de Azure Policy que forman parte de la iniciativa predeterminada de [Azure Security Center](./index.yml).
