...
En esta tabla se muestran [métricas de almacenamiento de tablas](../../azure-monitor/essentials/metrics-supported.md#microsoftstoragestorageaccountstableservices).
