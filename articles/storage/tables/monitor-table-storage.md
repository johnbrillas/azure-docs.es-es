...
Azure Table Storage recopila los mismos tipos de datos de supervisión que otros recursos de Azure, que se describen en [Supervisión de datos de recursos de Azure](../../azure-monitor/insights/monitor-azure-resource.md#monitoring-data). 
...
Para más información sobre cómo archivar registros de recursos en Azure Storage, consulte [Registros de recursos de Azure](../../azure-monitor/platform/resource-logs.md#send-to-azure-storage).
...
Para más información sobre el envío de registros de recursos a Event Hubs, consulte [Registros de recursos de Azure](../../azure-monitor/platform/resource-logs.md#send-to-azure-event-hubs).
...
Para obtener una lista de todas las métricas compatibles de Azure Monitor, lo que incluye Azure Table Storage, vea [Métricas compatibles con Azure Monitor](../../azure-monitor/platform/metrics-supported.md).
...
Puede mostrar la definición de la métrica de la cuenta de almacenamiento o el servicio Table Storage. Use el comando [az monitor metrics list-definitions](/cli/azure/monitor/metrics#az-monitor-metrics-list-definitions).
...
Puede leer los valores de métricas de la cuenta de almacenamiento o el servicio Table Storage. Use el comando [az monitor metrics list](/cli/azure/monitor/metrics#az-monitor-metrics-list).
...
Puede acceder y leer los datos de registro que se envían al centro de eventos mediante las herramientas de supervisión y administración de eventos y de información de seguridad. Para más información, consulte [Registros de recursos de Azure](../../azure-monitor/platform/resource-logs.md#send-to-azure-event-hubs).
...
Para más información, consulte [Transmisión de datos de supervisión de Azure a un centro de eventos y asociados externos](../../azure-monitor/platform/stream-monitoring-data-event-hubs.md).

Los datos se almacenan en la tabla **StorageTableLogs**. 

#### <a name="sample-kusto-queries"></a>Ejemplos de consultas de Kusto

Estas son algunas consultas que puede escribir en la barra **Búsqueda de registros** para ayudarle a supervisar su instancia de Table Storage. Estas consultas funcionan con el [nuevo lenguaje](../../azure-monitor/log-query/log-query-overview.md).
