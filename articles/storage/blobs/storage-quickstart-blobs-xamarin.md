...
* Visual Studio con la [carga de trabajo de desarrollo para dispositivos móviles para .NET](/xamarin/get-started/installation/?pivots=windows) instalada o [Visual Studio para Mac](/visualstudio/mac/installation?view=vsmac-2019)
