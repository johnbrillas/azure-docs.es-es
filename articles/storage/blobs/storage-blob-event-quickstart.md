...
![Captura de pantalla del visor de Azure Event Grid que muestra los datos de eventos que se han enviado a la aplicación web.](./media/storage-blob-event-quickstart/view-results.png)
