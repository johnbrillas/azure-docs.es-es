...
Para más información sobre el uso de AzCopy para copiar datos de blobs, consulte [Transferencia de datos con AzCopy y Blob Storage](../common/storage-use-azcopy-v10.md#transfer-data).
