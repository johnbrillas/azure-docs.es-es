...
Blobfuse admite la instalación en Ubuntu 14.04, 16.04, 18.04 y 20.04. Ejecute este comando para asegurarse de que tiene una de estas versiones implementadas:
```
lsb_release -a
```
