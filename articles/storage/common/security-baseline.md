...
- [Configuración del firewall de Azure Storage](./storage-network-security.md#change-the-default-network-access-rule)
...
- [Descripción de los puntos de conexión privados para Azure Storage](./storage-private-endpoints.md#known-issues)
...
- [Habilitación de Advanced Threat Protection](./azure-defender-storage-configure.md?tabs=azure-portal)
...
- [Configuración de Advanced Threat Protection para Azure Storage](./azure-defender-storage-configure.md)
...
- [Ejemplos de Azure Policy para el almacenamiento](../../governance/policy/samples/built-in-policies.md#storage)

- [Ejemplos de Azure Policy para las redes](../../governance/policy/samples/built-in-policies.md#network)
...
- [Registro y revisión de datos](./storage-analytics-logging.md#how-logs-are-stored)
...
- [Configuración de Advanced Threat Protection para Azure Storage](./azure-defender-storage-configure.md?tabs=azure-portal)
...
- [Introducción a Privileged Identity Management](../../active-directory/privileged-identity-management/index.yml)
...
- [Configuración de Advanced Threat Protection para la cuenta de Azure Storage](./azure-defender-storage-configure.md)
...
- [Asignación de roles de Azure a una cuenta de Azure Storage](./storage-auth-aad-rbac-portal.md#assign-azure-roles-using-the-azure-portal)
...
- [Configuración del acceso condicional para bloquear el acceso a ARM](../../role-based-access-control/conditional-access-azure-management.md)
...
- [Establecimiento y administración de directivas de inmutabilidad para el almacenamiento de blobs](../blobs/storage-blob-immutability-policies-manage.md?tabs=azure-portal)
...
- [Restauración de certificados de Key Vault](/powershell/module/azurerm.keyvault/restore-azurekeyvaultcertificate)

- [Restauración de claves de Key Vault](/powershell/module/azurerm.keyvault/restore-azurekeyvaultkey)

- [Restauración de cuentas de Storage de Key Vault](/powershell/module/az.keyvault/backup-azkeyvaultmanagedstorageaccount)

- [Restauración de secretos de Key Vault](/powershell/module/azurerm.keyvault/restore-azurekeyvaultsecret)
...
- [Eliminación temporal de blobs de Azure Storage](../blobs/soft-delete-blob-overview.md?tabs=azure-portal)
