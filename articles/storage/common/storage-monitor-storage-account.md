...
1. En la sección **SUPERVISIÓN** de la hoja de menú, seleccione **Diagnósticos**.
    ...
    ![Captura de pantalla que resalta la opción Configuración de diagnóstico (clásica) en la sección Supervisión (clásica).](./media/storage-monitor-storage-account/storage-enable-metrics-00.png)
