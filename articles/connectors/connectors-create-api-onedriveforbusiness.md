---
title: Conexión con OneDrive para la Empresa
description: Cargar y administrar archivos con las API REST de OneDrive para la Empresa y Azure Logic Apps
services: logic-apps
...
Vea los desencadenadores y las acciones definidos en Swagger y vea también todos los límites en los [detalles del conector](/connectors/onedriveforbusinessconnector/).
