...
description: En este artículo se describe cómo utilizar la API REST de Azure para analizar la seguridad de máquinas virtuales con la vista de grupos de seguridad.
