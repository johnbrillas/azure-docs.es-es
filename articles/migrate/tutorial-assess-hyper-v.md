---
title: Evaluación de máquinas virtuales de Hyper-V para la migración a máquinas virtuales Azure con Azure Migrate
description: Aprenda a evaluar máquinas virtuales de Hyper-V para la migración a máquinas virtuales Azure con Azure Migrate.
author: rashi-ms
ms.author: rajosh
ms.manager: abhemraj
ms.topic: tutorial
...
En este artículo, se explica cómo evaluar los servidores detectados desde el entorno de Hyper-V para la migración a Azure mediante la herramienta Azure Migrate: Discovery and assessment.
...
- Antes de seguir este tutorial para evaluar los servidores para la migración a máquinas virtuales Azure, asegúrese de que ha detectado los servidores que desea evaluar:
    - Para detectar los servidores mediante el dispositivo de Azure Migrate, [siga este tutorial](tutorial-discover-hyper-v.md). 
...
1. En **Assessment properties** (Propiedades de la evaluación)  > **Propiedades de destino**:
 ...
 1. En **Tamaño de VM**:
     - En **Criterio de tamaño**, selecciónelo si desea basar la evaluación en los datos o metadatos de configuración del servidor, o bien en datos del rendimiento. Si utiliza datos de rendimiento:
