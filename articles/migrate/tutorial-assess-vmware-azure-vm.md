---
title: Valoración de las máquinas virtuales de VMware para la migración a máquinas virtuales de Azure con Server Assessment en Azure Migrate
description: Obtenga información sobre cómo valorar las máquinas virtuales de VMware para la migración a máquinas virtuales de Azure con Server Assessment.
author: rashi-ms
ms.author: rajosh
ms.manager: abhemraj
ms.topic: tutorial
...
En este artículo se muestra cómo valorar las máquinas virtuales (VM) de VMware detectadas para preparar la migración a máquinas virtuales de Azure mediante la herramienta Azure Migrate: Server Assessment.
