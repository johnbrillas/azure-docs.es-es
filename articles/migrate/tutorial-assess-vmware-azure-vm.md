---
title: Evaluación de servidores de VMware para migrarlos a Azure con Azure Migrate
description: Obtenga información sobre cómo valorar los servidores de VMware para la migración a máquinas virtuales de Azure con Azure Migrate.
author: rashi-ms
ms.author: rajosh
ms.manager: abhemraj
ms.topic: tutorial
...
ms.locfileid: "104780654"
---
# <a name="tutorial-assess-vmware-vms-for-migration-to-azure-vms"></a>Tutorial: Evaluación de máquinas virtuales de VMware para la migración a máquinas virtuales de Azure
...
En este artículo se explica cómo evaluar los servidores detectados desde el entorno de VMware como preparación para la migración a máquinas virtuales de Azure mediante la herramienta Azure Migrate: Discovery and assessment.
...
2. En **Azure Migrate: Discovery and assessment**, haga clic en **Assess** (Evaluar) y seleccione **Azure VM** (Máquina virtual de Azure).
...
4. En **Origen de detección**:
    ...
    - Si ha detectado servidores que usan el dispositivo, seleccione **Servers discovered from Azure Migrate appliance** (Servidores detectados desde el dispositivo de Azure Migrate).
    - Si ha detectado servidores que usan un archivo CSV importado, seleccione **Imported servers** (Servidores importados). 
...
1. Una vez creada la evaluación, la puede consultar en **Servers** > **Azure Migrate: Discovery and assessment** > **Assessments** (Servidores > Azure Migrate: Discovery and assessment > Evaluaciones).
...
1. En **Windows, Linux and SQL Server** > **Azure Migrate: Discovery and assessment** (Windows, Linux y SQL Server > Azure Migrate: Discovery and assessment), haga clic en el número que aparece junto a la **evaluación de máquina virtual de Azure**.
