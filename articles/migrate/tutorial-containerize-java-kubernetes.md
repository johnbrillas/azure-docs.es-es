---
title: Inclusión en contenedores de aplicaciones web de Java y migración a Azure Kubernetes Service
description: Obtenga información sobre cómo incluir en contenedores las aplicaciones web de Java y cómo migrarlas a Azure Kubernetes Service.
services: ''
author: rahugup
manager: bsiva
ms.topic: tutorial
