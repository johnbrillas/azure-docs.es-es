...
En este artículo se muestra cómo valorar instancias de Amazon Web Services (AWS) para la migración a Azure mediante la herramienta Azure Migrate: Server Assessment.
...
- Asegúrese de que las instancias de AWS no ejecuten Windows Server 2003 ni SUSE Linux. No se admite la valoración en estas máquinas.
...
1. En la página **Servidores** > **Servidores Windows y Linux**, haga clic en **Evaluar y migrar servidores**.
   ...
   ![Ubicación del botón Evaluar y migrar servidores](./media/tutorial-assess-aws/assess.png)

2. En **Azure Migrate: Server Assessment, haga clic en **Valorar**.

    ![Ubicación del botón Evaluar](./media/tutorial-assess-aws/assess-servers.png)
...
6. Haga clic en **View all** (Ver todo) para revisar la configuración de la valoración.
    ...
    ![Ubicación del botón Ver todo para revisar las propiedades de valoración](./media/tutorial-assess-aws/assessment-name.png)
...
8. En **Tamaño de VM**:
    ...
    - En **Factor de confort**, indique el búfer que desee usar durante la valoración. Tiene en cuenta problemas como el uso estacional, el historial de rendimiento corto y los posibles aumentos en el uso futuro. Por ejemplo, si usa un factor de confort de dos: **Detalles** | **Utilización** | **Agregar factor de confort (2,0)** IOPS de lectura | 100 | 200 IOPS de escritura | 100 | 200 de rendimiento de lectura | 100 Mbps | 200 Mbps de rendimiento de escritura | 100 Mbps | 200 Mbps
...
10. Haga clic en **Guardar** si realiza cambios.
    ...
    ![Propiedades de la evaluación](./media/tutorial-assess-aws/assessment-properties.png)
