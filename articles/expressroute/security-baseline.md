...
* [Descripción de los requisitos de puerta de enlace de Azure ExpressRoute](../vpn-gateway/vpn-gateway-about-vpn-gateway-settings.md#requirements)
...
* [Habilitación de la auditoría en Azure Sentinel](../sentinel/resources.md)
...
* [Descripción del cifrado punto a punto en Azure ExpressRoute](./expressroute-about-encryption.md)

* [Configuración de MACsec en puertos de ExpressRoute Direct](./expressroute-howto-macsec.md)

* [Línea de base de seguridad de Azure para Key Vault](../key-vault/general/security-baseline.md)
...
* [Procedimiento para crear una instancia de Key Vault para almacenar los secretos de MACsec en un nuevo grupo de recursos](./expressroute-howto-macsec.md)
...
* [Procedimiento para probar la conectividad de circuitos de Azure ExpressRoute después de configurar MACsec](./expressroute-howto-macsec.md)
