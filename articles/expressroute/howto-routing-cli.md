---
title: 'Tutorial: Configuración del emparejamiento de un circuito ExpressRoute: CLI de Azure'
description: En este tutorial se muestra cómo crear y aprovisionar las configuraciones entre emparejamientos privados, públicos y de Microsoft de un circuito ExpressRoute. Este artículo también muestra cómo comprobar el estado, actualizar, o eliminar configuraciones entre pares en el circuito.
...
ms.locfileid: "101715537"
---
# <a name="tutorial-create-and-modify-peering-for-an-expressroute-circuit-using-cli"></a>Tutorial: Creación y modificación del emparejamiento de un circuito ExpressRoute mediante la CLI
...
Puede configurar el emparejamiento privado de Azure y de Microsoft para un circuito ExpressRoute. El emparejamiento se puede configurar en el orden que elija. Pero tiene que asegurarse de que completa cada configuración entre pares de una en una. Para más información sobre los emparejamientos y dominios de enrutamiento, vea [Dominios de enrutamiento de ExpressRoute](expressroute-circuit-peerings.md).
...
1. Instale la versión más reciente de la CLI de Azure. Use la versión más reciente de la interfaz de la línea de comandos (CLI) de Azure.
...
4. Establezca la configuración del emparejamiento de Microsoft para el circuito. Asegúrese de que tiene la siguiente información antes de continuar:
   ...
   * Una subred /30 para el vínculo principal. El bloque de direcciones debe ser un prefijo de IPv4 público válido que sea de su propiedad y esté registrado en un Registro regional de Internet (RIR) o un Registro de enrutamiento de Internet (IRR).
   * Una subred /30 para el vínculo secundario. El bloque de direcciones debe ser un prefijo de IPv4 público válido que sea de su propiedad y esté registrado en un Registro regional de Internet (RIR) o un Registro de enrutamiento de Internet (IRR).
...
1. Establecimiento de la configuración entre pares privados de Azure para el circuito. Asegúrese de que tiene los elementos siguientes antes de continuar con los siguientes pasos:
...
Una vez configurado el emparejamiento privado de Azure, puede vincular conmutadores virtuales al circuito; para ello, vea: 

> [!div class="nextstepaction"]
> [Vinculación de redes virtuales a circuitos ExpressRoute](howto-linkvnet-cli.md)
