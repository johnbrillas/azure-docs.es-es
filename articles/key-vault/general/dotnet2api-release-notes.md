...
description: Aprenda a actualizar aplicaciones escritas para versiones anteriores de Azure Key Vault para que funcionen con la versión 2.0 de la biblioteca de Azure Key Vault para C# y .NET.
services: key-vault
author: msmbaldwin
manager: rkarlin
editor: bryanla
