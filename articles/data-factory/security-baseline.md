...
* [Configuración y administración de la autenticación de Azure Active Directory con Azure SQL Database](../azure-sql/database/authentication-aad-configure.md)
...
* [Autorización del acceso a recursos de Event Hubs mediante Azure Active Directory](../event-hubs/authorize-access-azure-active-directory.md)
...
* [Configuración y administración de la autenticación de Azure Active Directory con SQL](../azure-sql/database/authentication-aad-configure.md?tabs=azure-powershell)

* [Habilitación de la autenticación de Azure Active Directory para Azure-SSIS Integration Runtime](./enable-aad-authentication-azure-ssis-ir.md)
