...
En la sección ***\*source\**** de la actividad de copia se admiten las siguientes propiedades. Obtenga más información del [comportamiento del conector XML](#xml-connector-behavior).
