...
Para encontrar la versión de PowerShell que se ejecuta localmente, use el cmdlet **"Get-Module -ListAvailable Az"** . Para realizar la actualización, consulte [Instalación del módulo de Azure PowerShell](/powershell/azure/azurerm/install-azurerm-ps). Para más información, consulte [Instalación y configuración de Azure PowerShell](/powershell/azure/azurerm/overview).

Si usa PowerShell en macOS, siga los pasos descritos en [Instalación de PowerShell en macOS](/powershell/scripting/install/installing-powershell-core-on-macos).