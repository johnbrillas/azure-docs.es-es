---
title: Codificación de mensajes EDIFACT
description: Valide EDI y genere XML con el codificador de mensajes EDIFACT para Azure Logic Apps con Enterprise Integration Pack
services: logic-apps
