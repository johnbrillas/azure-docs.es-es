...
![Flujo para generar certificados X509CA](./media/iot-hub-x509ca-concept/csr-flow.png)
...
![Jerarquía de la cadena de certificados](./media/iot-hub-x509ca-concept/cert-chain-hierarchy.png)
...
![Cadena de confianza de los certificados de una empresa a los certificados de otra empresa](./media/iot-hub-x509ca-concept/cert-mfr-chain.png)
...
![Flujo de un certificado a otro, desafío de prueba de posesión desde el concentrador](./media/iot-hub-x509ca-concept/device-pop-flow.png)
