...
* [Azure Functions](../azure-functions/index.yml). Consulte el tema sobre el [procesamiento de datos de IoT Hub con Azure Functions](https://azure.microsoft.com/resources/samples/functions-js-iot-hub-processing/).
