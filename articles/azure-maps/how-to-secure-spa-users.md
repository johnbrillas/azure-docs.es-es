...
7. Configure el control de acceso basado en roles de Azure (Azure RBAC) para usuarios o grupos. Consulte las [secciones siguientes para habilitar Azure RBAC](#grant-role-based-access-for-users-to-azure-maps).
