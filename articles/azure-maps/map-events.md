...
description: Obtenga información sobre los eventos que se desencadenan cuando los usuarios interactúan con mapas. Vea una lista de todos los eventos de mapa admitidos. Vea cómo usar el SDK web de Azure Maps para controlar eventos.
author: anastasia-ms
ms.author: v-stharr
ms.date: 09/10/2019
ms.topic: conceptual
...
ms.locfileid: "92890792"
---
# <a name="interact-with-the-map"></a>Interacción con el mapa

En este artículo se muestra cómo usar la [clase de eventos de mapa](/javascript/api/azure-maps-control/atlas.map#events). La propiedad resalta los eventos en el mapa y en diferentes capas del mapa. También puede resaltar eventos cuando se interactúa con un marcador HTML.
