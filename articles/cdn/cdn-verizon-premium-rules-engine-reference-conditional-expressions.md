...
Para obtener más información sobre las expresiones del motor de reglas de Verizon Premium, vea [Expresiones condicionales independientes](https://docs.vdms.com/cdn/index.html#Whats_New/Whats-New-RE.htm#RuleSetup).
