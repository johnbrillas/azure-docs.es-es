...
description: Aprenda a crear una aplicación de consola de node.js sencilla que muestre cómo automatizar la creación y administración de perfiles y puntos de conexión de Azure CDN.
services: cdn
...
![Crear punto de conexión](./media/cdn-app-dev-node/cdn-create-endpoint.png)
