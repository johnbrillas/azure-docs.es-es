...
description: Use este tutorial para aprender a usar PowerShell para administrar aspectos de los perfiles de punto de conexión de Azure Content Delivery Network y los puntos de conexión.
services: cdn
documentationcenter: ''
author: asudbring
manager: danielgi
