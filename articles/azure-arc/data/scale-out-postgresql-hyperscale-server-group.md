...
```
> [!NOTE]
> Si ha creado un grupo de servidores de la versión 11 de PostgreSQL y no de la versión 12, ejecute el siguiente comando en su lugar: _kubectl get postgresql-11_.
