...
- Realice un [inicio rápido de Form Recognizer](quickstarts/client-library.md) para empezar a escribir una aplicación de procesamiento de recibos con Form Recognizer en el lenguaje de su elección.
