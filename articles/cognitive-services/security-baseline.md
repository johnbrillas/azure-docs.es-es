...
* [Configuración de redes virtuales de Azure Cognitive Services](./cognitive-services-virtual-networks.md?tabs=portal)
...
* [Descripción de la seguridad de los contenedores de Azure Cognitive Services](./cognitive-services-container-support.md#azure-cognitive-services-container-security)
...
* [Regeneración de claves de acceso de Azure Cache for Redis](../azure-cache-for-redis/cache-configure.md#settings)
...
* [Autenticación de solicitudes en Cognitive Services](./authentication.md#authenticate-with-azure-active-directory)
...
* [Lista de servicios que cifran información en reposo](./encryption/cognitive-services-encryption-keys-portal.md)
...
* [Creación de un recurso de Cognitive Services con una plantilla de Azure Resource Manager](./create-account-resource-manager-template.md?tabs=portal)
...
**Guía**: use Azure DevOps para almacenar y administrar de forma segura sus plantillas de Azure Resource Manager. Para proteger los recursos que administra en Azure DevOps, puede conceder o denegar permisos a usuarios específicos, grupos de seguridad integrados o grupos definidos en Azure Active Directory (Azure AD) si se integran con Azure DevOps, o en Active Directory si se integran con TFS.  Use el control de acceso basado en rol de Azure para proteger las claves administradas por el cliente. Habilite la eliminación temporal y la protección de purga en Key Vault para proteger las claves contra la eliminación accidental o malintencionada. 
