...
Para el código que se muestra aquí, necesita **remote-conversation versión 1.8.0**, compatible solo con Java (1.8.0 o superior) en Windows y Linux. 

### <a name="obtaining-the-async-conversation-client-sdk"></a>Obtención del SDK del cliente de conversación asincrónico
