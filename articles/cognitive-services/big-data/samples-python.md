---
title: 'Cognitive Services para macrodatos: ejemplos de Python'
...
ms.locfileid: "94363262"
---
# <a name="python-samples-for-cognitive-services-for-big-data"></a>Ejemplos de Python para Cognitive Services para macrodatos
...
1. Siga los pasos descritos en [Introducción](getting-started.md) para configurar el entorno de Azure Databricks y Cognitive Services. En este tutorial se muestra cómo instalar MMLSpark y cómo crear el clúster de Spark en Databricks.
...
[Computer Vision](../computer-vision/index.yml) analiza las imágenes para identificar estructuras como caras, objetos y descripciones en lenguaje natural. En este ejemplo, se etiqueta una lista de imágenes. Las etiquetas son descripciones de una sola palabra de las cosas que hay en la imagen, como objetos reconocibles, personas, escenarios y acciones.
...
## <a name="speech-to-text-sample"></a>Ejemplo de Speech to Text
...
## <a name="arbitrary-web-apis"></a>API web arbitrarias

Con HTTP en Spark, se puede usar cualquier servicio web en la canalización de macrodatos. En este ejemplo, usamos la [API de World Bank](http://api.worldbank.org/v2/country/) para obtener información sobre varios países de todo el mundo.
...
* [Receta: detección de anomalías](./recipes/anomaly-detection.md)
* [Receta: explorador de arte](./recipes/art-explorer.md)