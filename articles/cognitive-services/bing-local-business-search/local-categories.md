---
title: Categorías de búsqueda en Bing Local Business Search API
titleSuffix: Azure Cognitive Services
description: Utilice este artículo para obtener información acerca de cómo especificar las categorías de búsqueda en el punto de conexión de Bing Local Business Search API.
...
## <a name="sub-categories"></a>Subcategorías
Las subcategorías se pasan de la misma forma que `localCategories`. Las subcategorías son categorías más específicas. Se consideran categorías subordinadas en el sentido de que, si se especificara una categoría C junto con una de sus subcategorías S en la misma lista delimitada por comas, se obtendrían los mismos resultados que si se especificara solo la categoría C.

### <a name="eat-drink"></a>Comer y beber
...
## <a name="examples-of-local-categories-search"></a>Ejemplos de búsquedas con LocalCategories

En los siguientes ejemplos, los resultados se obtienen en función del parámetro `localCategories`:
...
La siguiente consulta limita el número de resultados de 'hospital' a los tres primeros resultados devueltos por Bing Local Business Search API:

`https://api.cognitive.microsoft.com/localbusinesses/v7.0/search?&q=&mkt=en-US&localCategories=Hospitals&count=3&offset=0`

El siguiente ejemplo de respuesta JSON contiene tres hospitales situados en el área de Seattle y alrededores:
...
- [Límites de búsquedas geográficas](specify-geographic-search.md)
- [Consultas y respuestas](local-search-query-response.md)
- [Guía de inicio rápido de C#](quickstarts/local-quickstart.md)