...
description: Use este inicio rápido para empezar a enviar solicitudes en Java a Bing Local Business Search API, que es un servicio de Azure Cognitive Services.
