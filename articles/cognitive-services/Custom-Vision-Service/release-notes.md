...
description: Obtenga la información más reciente sobre las nuevas versiones del equipo de Custom Vision.
...
- Se han introducido las API 3.0. Se ha anunciado la próxima entrada en desuso de las API anteriores a 3.0 el 1 de octubre de 2019. Vea los [inicios rápidos](./quickstarts/image-classification.md) de la documentación para obtener ejemplos sobre cómo empezar a trabajar.
