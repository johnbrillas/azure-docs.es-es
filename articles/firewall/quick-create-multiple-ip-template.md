...
description: En este inicio rápido, aprenderá a usar una plantilla de Azure Resource Manager para crear una instancia de Azure Firewall con varias direcciones IP públicas.
services: firewall
author: vhorne
ms.service: firewall
ms.topic: quickstart
