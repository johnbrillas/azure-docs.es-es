...
* Obtenga más información sobre el [uso de Windows PowerShell para StorSimple para administrar el dispositivo StorSimple](./storsimple-8000-windows-powershell-administration.md).
