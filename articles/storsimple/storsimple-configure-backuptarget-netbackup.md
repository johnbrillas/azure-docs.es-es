...
description: Obtenga información sobre la configuración del destino de copia de seguridad de StorSimple con Veritas NetBackup y los procedimientos recomendados para la integración de ambas soluciones.
services: storsimple
documentationcenter: ''
author: harshakirank
manager: matd
...
![Diagrama que muestra una arquitectura en la que las copias de seguridad y restauraciones iniciales tienen como destino un volumen de alto rendimiento.](./media/storsimple-configure-backup-target-using-netbackup/secondarybackuptargetlogicaldiagram.png)
