---
title: Instalación y funcionamiento seguros de un dispositivo de la serie StorSimple 8000
...
* No quite las cubiertas del PCM. Existe peligro de descargas eléctricas en su interior. Para devolver el PCM y obtener un reemplazo, [póngase en contacto con el servicio de soporte técnico de Microsoft](./storsimple-8000-contact-microsoft-support.md).
