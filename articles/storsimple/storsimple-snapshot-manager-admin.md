...
| Montaje de volúmenes<br>Ver información acerca de volúmenes<br>Eliminar un volumen<br>Volver a examinar volúmenes<br>Configuración y copia de seguridad de un volumen básico<br>Configurar y realizar copia de seguridad de un volumen reflejado dinámico |[Uso de Administrador de instantáneas StorSimple para ver y administrar volúmenes](storsimple-snapshot-manager-manage-volumes.md) |
