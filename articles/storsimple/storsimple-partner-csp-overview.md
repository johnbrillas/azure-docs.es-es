...
description: Obtenga información introductoria sobre StorSimple y el programa de soluciones en la nube (CSP) para asociados de StorSimple.
services: storsimple
...
Para más información sobre StorSimple para CSP, visite la página de [introducción a Azure CSP](/azure/cloud-solution-provider/overview/azure-csp-overview).
