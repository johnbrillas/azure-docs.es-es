...
Para implementar una solución de recuperación ante desastres con un solo clic que usa Azure Site Recovery para recursos compartidos de archivos hospedados en el almacenamiento de StorSimple, se deben cumplir los siguientes requisitos previos:
   ...
   - [Almacén de los servicios de Azure Site Recovery](../site-recovery/hyper-v-vmm-azure-tutorial.md) creado en una suscripción de Microsoft Azure
...
1. Cree recursos compartidos de archivos con volúmenes extraídos del almacenamiento de StorSimple. Para obtener más información, consulte [Uso del servicio StorSimple Manager para administrar volúmenes](./index.yml).
...
Consulte la [documentación de Azure Site Recovery](../site-recovery/index.yml) para empezar a trabajar con Azure Site Recovery antes de proteger la máquina virtual de servidor de archivos.
...
1. [Habilite la protección de la máquina virtual](../site-recovery/hyper-v-azure-tutorial.md) de la máquina virtual de servidor de archivos desde el portal de Azure Site Recovery.
