---
title: Hardware para interfaces de StorSimple de 10 GbE | Microsoft Docs
...
## <a name="list-of-devices-tested-by-oem-provider-mellanox"></a>Lista de dispositivos probados por el proveedor OEM (Mellanox)
