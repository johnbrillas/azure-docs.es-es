---
title: 'Creación de una red virtual para aplicaciones multinivel: ejemplo de script de Azure PowerShell'
description: 'Creación de una red virtual para aplicaciones multinivel: ejemplo de script de Azure PowerShell.'
