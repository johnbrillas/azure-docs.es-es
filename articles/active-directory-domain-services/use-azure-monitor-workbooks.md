...
Para obtener más información sobre cómo editar y administrar libros, vea [Información general sobre los libros de Azure Monitor](../azure-monitor/visualize/workbooks-overview.md).
