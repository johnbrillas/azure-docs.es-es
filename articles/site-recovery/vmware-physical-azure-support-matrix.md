...
Debian | Debian 7/Debian 8 (incluye compatibilidad para todas las versiones 7. *x*, 8. *x*); Debian 9 (incluye compatibilidad con las versiones 9.1 a 9.13. Debian 9.0 es incompatible). [(Revise las versiones de kernel compatibles)](#debian-kernel-versions)
