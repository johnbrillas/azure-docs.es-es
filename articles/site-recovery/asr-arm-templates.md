...
|---|---|
|**De Azure a Azure** | |
| [Creación de un almacén de Recovery Services](https://docs.microsoft.com/azure/site-recovery/quickstart-create-vault-template)| Cree un almacén de Recovery Services. El almacén se puede usar con Azure Backup y Azure Site Recovery. |
