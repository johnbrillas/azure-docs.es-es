...
En la [API REST](/rest/api/azureresourcegraph/resourcegraph(2019-04-01)/resources/resources), el control es **$top** y forma parte de **QueryRequestOptions**.
