...
description: Asignación de controles del ejemplo de plano técnico IRS 1075. Cada control se corresponde a una o varias definiciones de Azure Policy que ayudan en la evaluación.
ms.date: 01/08/2021
ms.topic: sample
