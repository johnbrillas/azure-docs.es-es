...
Ahora que ha revisado la asignación de controles del plano técnico de nivel de impacto alto de FedRAMP, consulte los siguientes artículos para obtener información sobre el plano técnico y cómo se implementa este ejemplo:
