...
Para implementar los ejemplos de plano técnico Canada Federal PBMM, se deben realizar los siguientes pasos:
...
Ahora que ha revisado los pasos para implementar el ejemplo Canada Federal PBMM, consulte los siguientes artículos para obtener información general y sobre la asignación de controles:

> [!div class="nextstepaction"]
> [Planos técnicos Canada Federal PBMM: introducción](./index.md)
> [Planos técnicos Canada Federal PBMM: asignación de controles](./control-mapping.md)
