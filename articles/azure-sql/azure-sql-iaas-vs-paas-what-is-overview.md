...
- Solucionar posibles amenazas en tiempo real con [detección de amenazas avanzada](../security/fundamentals/threat-detection.md#threat-protection-features-other-azure-services) inteligente y alertas proactivas de evaluación de vulnerabilidades. 
