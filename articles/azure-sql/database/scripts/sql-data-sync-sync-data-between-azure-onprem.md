---
title: 'PowerShell: Sincronización de datos entre SQL Database y SQL Server'
description: Use un script de ejemplo de Azure PowerShell para sincronizar datos entre Azure SQL Database y SQL Server.
...
En este ejemplo de Azure PowerShell se configura Data Sync para sincronizar datos entre Azure SQL Database y SQL Server. 
...
- Crear una base de datos en una instancia de SQL Server como una base de datos miembro.
...
Para más información sobre Azure SQL Database, consulte:
