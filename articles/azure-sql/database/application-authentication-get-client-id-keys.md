...
Para crear y administrar Azure SQL Database desde el código, debe registrar la aplicación en el dominio de Azure Active Directory (Azure AD) en la suscripción donde se han creado los recursos de Azure.
