...
Además, las transacciones distribuidas de Managed Instance están disponibles en [Transact-SQL](/sql/t-sql/language-elements/begin-distributed-transaction-transact-sql).
