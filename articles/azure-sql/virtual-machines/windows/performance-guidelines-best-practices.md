...
La [serie M](/azure/virtual-machines/m-series) ofrece recuentos de núcleos virtuales y memoria para algunas de las cargas de trabajo de SQL Server más grandes.  
...
Por ejemplo, [Standard_M64ms](/azure/virtual-machines/m-series) tiene una proporción de memoria a núcleo virtual de 28.
...
Por ejemplo, [M64-32ms](../../../virtual-machines/constrained-vcpu.md) solo requiere la concesión de licencias de 32 núcleos virtuales de SQL Server con la memoria, E/S y el rendimiento de [M64ms](/azure/virtual-machines/m-series), y [M64-16ms](../../../virtual-machines/constrained-vcpu.md) solo requiere la concesión de licencias de 16 núcleos virtuales.  Aunque [M64-16ms](../../../virtual-machines/constrained-vcpu.md) supone un cuarto del costo de las licencias de SQL Server de M64ms, el costo de proceso de la máquina virtual será el mismo.
