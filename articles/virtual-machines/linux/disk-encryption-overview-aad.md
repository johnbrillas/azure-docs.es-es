...
description: Este artículo complementa el artículo sobre Azure Disk Encryption para máquinas virtuales Linux con requisitos adicionales y requisitos previos para Azure Disk Encryption con Azure AD.
author: msmbaldwin
