...
Si realiza un reinicio desde Azure Portal, Azure PowerShell, la interfaz de línea de comandos o la API de REST, el evento se encontrará en el [registro de actividad de Azure](../../azure-monitor/essentials/platform-logs-overview.md).
