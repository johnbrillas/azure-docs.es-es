...
Instale la versión más reciente de la [CLI de Azure clásica](/cli/azure/install-classic-cli) e inicie sesión en su cuenta de Azure. Asegúrese de que está en modo de Resource Manager (`azure config mode arm`).
