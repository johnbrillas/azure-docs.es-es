...
Con el [centro de administración de Microsoft](https://docs.microsoft.com/microsoft-365/admin/admin-overview/about-the-admin-center?view=o365-worldwide&preserve-view=true) puede confirmar si un usuario tiene asignada una licencia admitida de Windows 10.
