...
Otro comando _ *crm** obtiene la configuración del clúster completa en un editor, por lo que se puede editar. Después de guardar los cambios, el clúster inicia las acciones apropiadas:
