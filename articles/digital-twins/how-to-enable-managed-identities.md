---
title: Habilitación de una identidad administrada para eventos de enrutamiento (versión preliminar)
titleSuffix: Azure Digital Twins
description: Vea cómo habilitar una identidad asignada por el sistema para Azure Digital Twins y úsela para reenviar eventos.
author: baanders
ms.author: baanders
ms.date: 1/21/2021
ms.topic: how-to
...
En esta sección, usará [Azure Portal](https://portal.azure.com) para agregar una identidad administrada por el sistema a una instancia de Azure Digital Twins que ya existe.
...
1. En la página **Agregar asignación de roles** siguiente, rellene los valores:
    ...
    * **Select**: aquí, seleccionará la identidad administrada de la instancia de Azure Digital Twins a la que se asigna el rol. El nombre de la identidad administrada coincide con el de la instancia, por lo que debe buscar el nombre de la instancia de Azure Digital Twins. Cuando seleccione el resultado, la identidad de la instancia aparecerá en la sección **Miembros seleccionados**.
