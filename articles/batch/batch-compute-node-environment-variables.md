...
| AZ_BATCH_CERTIFICATES_DIR       | Un directorio en el [directorio de trabajo de la tarea](files-and-directories.md) en el que se almacenan los certificados para nodos de proceso de Linux. Esta variable de entorno no se aplica a los nodos de ejecución de Windows.                                                  | Todas las tareas.   |  /mnt/batch/tasks/workitems/batchjob001/job-1/task001/certs |
| AZ_BATCH_HOST_LIST              | La lista de nodos que se asignan a una [tarea de varias instancias](batch-mpi.md) en el formato `nodeIP,nodeIP`. | Tareas principales y secundarias de varias instancias. | `10.0.0.4,10.0.0.5` |
| AZ_BATCH_IS_CURRENT_NODE_MASTER | Especifica si el nodo actual es el nodo maestro de una [tarea de varias instancias](batch-mpi.md). Los valores posibles son `true` y `false`.| Tareas principales y secundarias de varias instancias. | `true` |
...
| AZ_BATCH_NODE_LIST              | La lista de nodos que se asignan a una [tarea de varias instancias](batch-mpi.md) en el formato `nodeIP;nodeIP`. | Tareas principales y secundarias de varias instancias. | `10.0.0.4;10.0.0.5` |
