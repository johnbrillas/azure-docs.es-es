---
title: Almacenamiento de datos de salida en Azure Storage con la biblioteca de convenciones de archivo
...
Esta biblioteca está disponible en [NuGet][nuget_package]. La biblioteca permite extender las clases [CloudJob][net_cloudjob] y [CloudTask][net_cloudtask] con nuevos métodos. Consulte también la [documentación de referencia](/dotnet/api/microsoft.azure.batch.conventions.files) de la biblioteca de convenciones de archivo.
