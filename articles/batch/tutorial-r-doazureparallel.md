...
* Aumente el valor de `taskSlotsPerNode` a *2* para aprovechar ambos núcleos en cada nodo.
...
La salida muestra el número de "trabajos de ejecución" de doAzureParallel. Este número es el número de nodos multiplicado por el valor de `taskSlotsPerNode`. Si modificó la configuración del clúster descrita anteriormente, el número es *10*.
...
![La captura de pantalla muestra un histograma de los precios de cierre.](media/tutorial-r-doazureparallel/closing-prices-local.png)
