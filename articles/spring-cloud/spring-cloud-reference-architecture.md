...
Azure Spring Cloud requiere tráfico de administración para la salida de Azure cuando se implementa en un entorno seguro. Para ello, debe permitir las reglas de red y de aplicación enumeradas en [Responsabilidades del cliente para ejecutar Azure Spring Cloud en una red virtual](/azure/spring-cloud/spring-cloud-vnet-customer-responsibilities).
