...
1. Cree una solicitud de soporte técnico en Azure Portal.
   ...
   ![Portal de Azure Data Lake Analytics: ayuda y soporte técnico](./media/data-lake-analytics-quota-limits/data-lake-analytics-quota-help-support.png)
...
5. En la página del problema, explique el límite de aumento que quiere pedir y los **detalles** de por qué necesita esta capacidad adicional.
   ...
   ![Detalles de la solicitud de soporte técnico de Azure Data Lake Analytics](./media/data-lake-analytics-quota-limits/data-lake-analytics-quota-support-request-details.png)
