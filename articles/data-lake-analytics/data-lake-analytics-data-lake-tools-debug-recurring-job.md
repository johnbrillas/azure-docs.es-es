...
ms.locfileid: "92219180"
---
# <a name="troubleshoot-an-abnormal-recurring-job"></a>Solución de problemas de un trabajo periódico anómalo

En este artículo se explica cómo usar las [Herramientas de Azure Data Lake para Visual Studio](https://aka.ms/adltoolsvs) para solucionar problemas de trabajos periódicos. Obtenga más información sobre la canalización y los trabajos periódicos en el [blog de Azure Data Lake y Azure HDInsight](/archive/blogs/azuredatalake/managing-pipeline-recurring-jobs-in-azure-data-lake-analytics-made-easy).
