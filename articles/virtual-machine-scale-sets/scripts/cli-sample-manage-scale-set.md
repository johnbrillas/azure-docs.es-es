...
Para usar el disco expandido, expanda la partición subyacente. Para más información, consulte [Expansión de una partición de disco y del sistema de archivos](/azure/virtual-machines/linux/expand-disks#expand-a-disk-partition-and-filesystem).
