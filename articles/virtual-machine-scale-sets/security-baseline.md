...
* [Redes para conjuntos de escalado de máquinas virtuales de Azure](./virtual-machine-scale-sets-networking.md)
...
* [Creación de un conjunto de escalado que hace referencia a una instancia de Application Gateway](./virtual-machine-scale-sets-networking.md#create-a-scale-set-that-references-an-application-gateway)
...
* [Más información sobre las plantillas de conjuntos de escalado de máquinas virtuales](./virtual-machine-scale-sets-mvss-start.md)
...
* [Azure Disk Encryption para Virtual Machine Scale Sets](./disk-encryption-overview.md)
...
* [Actualizaciones automáticas del sistema operativo en conjuntos de escalado de máquinas virtuales de Azure](./virtual-machine-scale-sets-automatic-upgrade.md)
...
* [Uso de Virtual Machine Scale Sets con la extensión de DSC de Azure](./virtual-machine-scale-sets-dsc.md)
...
* [¿Cómo se puede crear una instantánea de una instancia de un conjunto de escalado de máquinas virtuales y de un disco administrado?](./virtual-machine-scale-sets-faq.md#how-do-i-take-a-snapshot-of-a-virtual-machine-scale-set-instance)
...
* [Restauración de un disco y creación de una máquina virtual recuperada en Azure](../backup/tutorial-restore-disk.md)
...
* [Habilitar el cifrado de disco para Azure Virtual Machine Scale Sets](./disk-encryption-overview.md)
...
* [Introducción a la protección de purga y eliminación temporal en Azure Key Vault](../key-vault/general/soft-delete-overview.md)
