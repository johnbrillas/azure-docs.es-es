...
**Guía**: Azure Cloud Shell es una experiencia de línea de comandos basada en explorador que utiliza la misma autorización que para acceder a Azure Portal; en este caso, cualquier autenticación multifactor necesaria para conectarse a Azure Portal también será necesaria en Cloud Shell.
