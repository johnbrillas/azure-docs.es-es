...
description: En este artículo se indican las especificaciones de los orígenes de datos actualmente admitidos de Azure Data Catalog.
author: JasonWHowell
ms.author: jasonh
...
<table>
    ...
    <tr>
      ...
      <td>✓</td>
      <td>Excel, Power BI Desktop</td>
      <td>Oracle 10 y versiones posteriores.</td>
    </tr>
    <tr>
    ...
    <tr>
      <td>Tabla de Azure Synapse Analytics</td>
      <td>✓</td>
      <td>✓</td>
      <td>✓</td>
    ...
    <tr>
      <td>Vista de Azure Synapse Analytics</td>
      <td>✓</td>
      <td>✓</td>
      <td>✓</td>
      <td>Excel, Power BI Desktop, SQL Server Data Tools</td>
    ...
    <tr>
      ...
      <td>✓</td>
      <td></td>
      <td>Solo son compatibles las colecciones heredadas de Azure DocumentDB y las colecciones de SQL API de Azure Cosmos DB. Aún no se admiten las API de Cosmos DB más recientes. Elija Azure DocumentDB en la lista Origen de datos.</td>
    </tr>
    <tr>
