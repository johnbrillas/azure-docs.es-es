...
- Haber completado el tutorial [Creación y conexión de una aplicación cliente a una aplicación de Azure IoT Central (JavaScript)](./tutorial-connect-device.md).
