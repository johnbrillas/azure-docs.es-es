...
Para obtener más información sobre cómo consultar datos de Log Analytics, vea [Introducción a las consultas en Log Analytics](/azure/azure-monitor/log-query/get-started-queries).
