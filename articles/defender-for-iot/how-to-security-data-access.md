...
Para obtener más información sobre cómo consultar datos de Log Analytics, vea [Introducción a las consultas en Log Analytics](../azure-monitor/logs/get-started-queries.md).
