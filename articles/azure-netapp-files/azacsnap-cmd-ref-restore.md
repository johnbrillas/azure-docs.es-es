...
- `--dbsid <SAP HANA SID>` es el SID de SAP HANA que se selecciona del archivo de configuración al que se van a aplicar los comandos de restauración de volumen.
