...
- Debe tener una suscripción a [Azure AD Premium P2](https://azure.microsoft.com/pricing/details/active-directory/) para ingerir los registros de inicio de sesión en Azure Sentinel. Se pueden aplicar cargos adicionales por gigabyte para Azure Monitor (Log Analytics) y Azure Sentinel.
...
1. Active las casillas que se encuentran junto a los tipos de registros que quiere transmitir a Azure Sentinel y haga clic en **Conectar**. Estos son los tipos de registro entre los que puede elegir:

    - **Registros de inicio de sesión**: información sobre el uso de aplicaciones administradas y actividades de inicio de sesión de usuario.
