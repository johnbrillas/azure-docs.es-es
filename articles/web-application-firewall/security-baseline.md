...
- [Directivas de WAF sobre Application Gateway](/cli/azure/network/application-gateway/waf-policy?view=azure-cli-latest) 

- [Directivas de WAF sobre Front Door](/cli/azure/ext/front-door/network/front-door/waf-policy?view=azure-cli-latest)
...
- [Conectar datos del firewall de aplicaciones web de Microsoft a Azure Sentinel](../sentinel/connect-azure-waf.md)
...
- [Habilitación de la configuración de diagnóstico para el registro de actividad de Azure](../azure-monitor/index.yml) 
...
- [Introducción a la integración entre Application Gateway y Azure Security Center](../security-center/security-center-partner-integration.md)
...
- [Documentación de Azure Policy](../governance/policy/index.yml)
