...
description: Agregue etiquetas a los recursos que implemente en su plantilla de Azure Resource Manager (ARM). Las etiquetas permiten organizar los recursos de manera lógica.
author: mumian
ms.date: 03/27/2020
ms.topic: tutorial
ms.author: jgao
...
ms.locfileid: "96930949"
---
# <a name="tutorial-add-tags-in-your-arm-template"></a>Tutorial: Incorporación de etiquetas en la plantilla de Resource Manager

En este tutorial, aprenderá a agregar etiquetas a los recursos de su plantilla de Azure Resource Manager (ARM). Las [etiquetas](../management/tag-resources.md) le ayudan a organizar los recursos de forma lógica. Los valores de la etiqueta se muestran en los informes de costos. Este tutorial se realiza en **8 minutos**.
