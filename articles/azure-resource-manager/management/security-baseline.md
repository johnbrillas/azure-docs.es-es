...
**Guía**: use RBAC de Azure Active Directory (Azure AD) para controlar el acceso a datos y recursos; para otros fines, use métodos de control de acceso específicos del servicio.
