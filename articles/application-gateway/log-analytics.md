...
description: En este artículo se muestra cómo usar Azure Log Analytics para examinar los registros del firewall de aplicaciones web (WAF) de Application Gateway.
