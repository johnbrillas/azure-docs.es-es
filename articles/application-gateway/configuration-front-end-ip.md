...
Para obtener más información, vea las [preguntas más frecuentes sobre Application Gateway](application-gateway-faq.yml#how-do-i-use-application-gateway-v2-with-only-private-frontend-ip-address).
