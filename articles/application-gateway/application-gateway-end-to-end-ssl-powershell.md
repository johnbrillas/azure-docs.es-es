...
7. Cargue el certificado que se usará en los recursos del grupo de back-end habilitado para TLS.
   ...
   Para más información sobre SNI en Application Gateway, consulte [Introducción a la terminación TLS y a TLS de extremo a extremo con Application Gateway](ssl-overview.md).
...
Para más información sobre la protección de la seguridad de las aplicaciones web con el firewall de aplicaciones web mediante Application Gateway, consulte [Información general sobre el firewall de aplicaciones web](../web-application-firewall/ag/ag-overview.md).
