...
description: Obtenga información sobre cómo usar un script de Azure PowerShell para integrar el almacén de claves con la puerta de enlace de aplicación para los certificados de terminación TLS/SSL.
