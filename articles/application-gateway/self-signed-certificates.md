...
Para obtener instrucciones de enlace TLS, consulte [Configuración de SSL en IIS 7](/iis/manage/configuring-security/how-to-set-up-ssl-on-iis#create-an-ssl-binding-1).
