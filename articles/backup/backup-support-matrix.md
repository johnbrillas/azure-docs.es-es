...
| ---------------------- | ------------------------------------------------------------ | ----------------- |
| Azure VM               | Compatible con máquinas virtuales de Azure tanto con discos administrados como no administrados. No se admite para máquinas virtuales clásicas. | Todas las regiones públicas de Azure.  |
