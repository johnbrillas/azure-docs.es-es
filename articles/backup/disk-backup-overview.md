...
Azure Disk Backup es una solución sin agente y coherente ante los bloqueos que usa [instantáneas incrementales](https://docs.microsoft.com/azure/virtual-machines/windows/disks-incremental-snapshots) y ofrece las siguientes ventajas:
