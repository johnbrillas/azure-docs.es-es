...
| **Versiones de HANA**          | SDC en HANA 1.x, MDC en HANA 2.x <= SPS04 rev. 53, SPS05 (aún pendiente de validación para los escenarios habilitados para el cifrado)      |                                                            |
