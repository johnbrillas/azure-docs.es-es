...
>
> Para lograr los mejores rendimientos de copia de seguridad, se recomienda implementar MABS V3 con almacenamiento en capas en Windows Server 2019. Consulte el artículo de DPM "[Configuración de MBS con el almacenamiento en capas](/system-center/dpm/add-storage#set-up-mbs-with-tiered-storage)" para obtener los pasos de configuración del almacenamiento en capas.
...
> [!NOTE]
>
> - Agregue solo un disco al grupo para mantener el recuento de columnas en 1. Luego puede agregar los discos según sea necesario.
