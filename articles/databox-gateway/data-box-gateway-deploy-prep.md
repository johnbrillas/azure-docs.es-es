...
5. En la pestaña **Aspectos básicos**:
   ...
   ![Entrada con el detalle de proyecto e instancia para un pedido de Data Box Gateway](media/data-box-gateway-deploy-prep/data-box-gateway-basics.png)
