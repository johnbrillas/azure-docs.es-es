...
### <a name="controls"></a>Controles  
 Esta plantilla no puede utilizar los [controles de página](api-management-page-controls.md).  
...
##  <a name="subscriptions"></a><a name="Subscriptions"></a> Suscripciones  
...
##  <a name="applications"></a><a name="Applications"></a> Aplicaciones  
...
##  <a name="update-account-info"></a><a name="UpdateAccountInfo"></a> Update account info  
...
### <a name="data-model"></a>Modelo de datos  
 Entidad [Información de cuenta de usuario](api-management-template-data-model-reference.md#UserAccountInfo).  
