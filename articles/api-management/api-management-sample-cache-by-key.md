...
description: Aprenda a almacenar en caché elementos en función de la clave en Azure API Management. Puede modificar la clave mediante el uso de encabezados de solicitud.
