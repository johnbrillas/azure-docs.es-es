...
![Captura de pantalla que muestra dónde se cambia la configuración en el portal para desarrolladores heredado.](./media/modify-developer-portal-style/developer_portal.png)
