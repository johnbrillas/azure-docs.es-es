...
description: Obtenga información sobre cómo configurar la directiva de límite de frecuencia con Azure PowerShell. Consulte un script de ejemplo y los recursos adicionales disponibles.
