...
"502 Puerta de enlace no válida" y "503 Servicio no disponible" son errores comunes de su aplicación hospedada en [Azure App Service](./overview.md). Este artículo le ayuda a solucionar estos errores.
