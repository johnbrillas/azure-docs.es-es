...
| [`az cosmosdb create`](/cli/azure/cosmosdb#az-cosmosdb-create) | Crea una cuenta de Cosmos DB. |
| [`az cosmosdb list-connection-strings`](/cli/azure/cosmosdb#az-cosmosdb-list-connection-strings) | Devuelve las cadenas de conexión de la cuenta de Cosmos DB especificada. |
