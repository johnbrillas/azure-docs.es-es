...
description: Configure un entorno de automatización para conectar y configurar una VPN o SD-WAN CPE local, o un dispositivo de rama, para Azure Virtual WAN.
