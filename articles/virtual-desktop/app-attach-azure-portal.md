...
Después de deshabilitar las actualizaciones automáticas, debe habilitar Hyper-V, ya que va a usar el comando `Mount-VHD` para agregar valores al "stage" y Dismount-VHD para quitarlos del "stage".
