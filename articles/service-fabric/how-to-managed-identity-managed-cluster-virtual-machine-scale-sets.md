...
Por último, agregue las propiedades `vmManagedIdentity` y `userAssignedIdentities` a la definición de tipo de nodo del clúster administrado. Asegúrese de usar la versión **2021-01-01-Preview** u otra posterior para `apiVersion`.
