...
Puede empezar creando la estructura de directorios del modo descrito en [Empaquetado de una aplicación de Azure Service Fabric](./service-fabric-package-apps.md).
