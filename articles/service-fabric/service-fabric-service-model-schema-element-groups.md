---
title: Grupos de elementos del esquema XML del modelo de servicio de Azure Service Fabric
description: Describe los grupos de elementos del esquema XML del modelo de servicio de Service Fabric.
ms.topic: reference
ms.date: 12/10/2018
...
ms.locfileid: "84700875"
---
<!-- This article was generated by the Python script found in the service-fabric-service-model-schema.md file -->

# <a name="service-fabric-service-model-xml-schema-elements"></a>Elementos del esquema XML del modelo de servicio de Service Fabric
