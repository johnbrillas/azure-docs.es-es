---
title: Equilibrio del clúster de Azure Service Fabric
...
* Cluster Resource Manager puede reconocer y controlar la agrupación en subclústeres (una situación que a veces surge cuando se usan restricciones de selección de ubicación y de equilibrio). Para más información sobre cómo la agrupación en subclústeres puede afectar al equilibrio y cómo puede controlarlo, consulte [esta información](cluster-resource-manager-subclustering.md)
