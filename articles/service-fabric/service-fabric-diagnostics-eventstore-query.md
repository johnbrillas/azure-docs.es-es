...
También puede consultar EventStore mediante programación, a través de la [biblioteca de clientes de Service Fabric](/dotnet/api/overview/azure/service-fabric#client-library).
