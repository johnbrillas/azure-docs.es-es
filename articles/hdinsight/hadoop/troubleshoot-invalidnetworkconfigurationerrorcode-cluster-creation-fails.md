...
Otra causa de este código de error `InvalidNetworkConfigurationErrorCode` podría ser el uso del parámetro en desuso `EnableVmProtection` en PowerShell o un runbook de Azure.
