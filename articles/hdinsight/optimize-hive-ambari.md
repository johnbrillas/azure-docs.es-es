...
* `hive.compute.query.using.stats`
    ...
    :::image type="content" source="./media/optimize-hive-ambari/hive-compute-query-using-stats.png" alt-text="Apache Hive: consulta de proceso con estadísticas" border="true":::
