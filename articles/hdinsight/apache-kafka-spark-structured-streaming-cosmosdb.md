...
![Diagrama de clústeres Spark y Kafka en una red virtual de Azure](./media/apache-kafka-spark-structured-streaming-cosmosdb/apache-spark-kafka-vnet.png)
