...
En este artículo se proporcionan scripts de ejemplo para tareas comunes. En todos los ejemplos, actualice las variables con los valores adecuados y, después, ejecute el comando.
...
### <a name="create-a-cluster-with-the-enterprise-security-package-esp"></a>Creación de un clúster con Enterprise Security Package (ESP)
...
### <a name="create-a-kafka-cluster-with-disk-encryption"></a>Creación de un clúster de Kafka con [cifrado de disco](./disk-encryption.md)
...
### <a name="create-a-cluster-with-azure-data-lake-storage-gen2"></a>Creación de un clúster con Azure Data Lake Storage Gen2
...
### <a name="create-a-cluster-with-configuration-from-json-string"></a>Creación de un clúster con configuración a partir de una cadena JSON
...
### <a name="create-a-cluster-with-configuration-from-a-local-file"></a>Creación de un clúster con configuración a partir de un archivo local
...
### <a name="create-an-application-with-a-script-uri-and-specified-edge-node-size"></a>Creación de una aplicación con un identificador URI de un script y el tamaño de nodo perimetral especificado
...
### <a name="create-an-application-with-https-endpoint"></a>Creación de una aplicación con un punto de conexión HTTPS
