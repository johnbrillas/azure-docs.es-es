...
1. Escriba o seleccione los siguientes valores:
    ...
    :::image type="content" source="./media/quickstart-resource-manager-template/resource-manager-template-hive.png" alt-text="Implementación de HBase de plantilla de Resource Manager" border="true":::
...
[Eliminar HBase de plantilla de Resource Manager](./media/quickstart-resource-manager-template/azure-portal-delete-hive.png)
