...
* Bytes de salida por segundo: (reemplace `your_kafka_cluster_name` por el nombre del clúster).
    ...
    :::image type="content" source="./media/apache-kafka-log-analytics-operations-management/apache-kafka-cpu-usage.png" alt-text="Apache Kafka: uso de la CPU de Log Analytics" border="true":::
