...
:::image type="content" source="./media/apache-kafka-introduction/kafka-cluster-diagram.png" alt-text="Diagrama de configuración del clúster de Kafka" border="false":::
