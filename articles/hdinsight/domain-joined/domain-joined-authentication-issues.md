...
* Si tiene una [máquina Windows unida a un dominio](../../active-directory-domain-services/tutorial-create-management-vm.md), puede usar las herramientas estándar de AD de Windows para examinar. Esto requiere una cuenta profesional en el dominio.
