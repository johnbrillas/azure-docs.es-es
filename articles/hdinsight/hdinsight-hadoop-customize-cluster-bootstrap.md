...
> [!IMPORTANT]  
> Es posible que tenga que usar el parámetro `Spark2Defaults` con [Add-AzHDInsightConfigValue](/powershell/module/az.hdinsight/add-azhdinsightconfigvalue). Puede pasar valores vacíos al parámetro, como se muestra en el ejemplo de código siguiente.
...
Vea [SDK de Azure HDInsight para .NET](/dotnet/api/overview/azure/hdinsight).
...
:::image type="content" source="./media/hdinsight-hadoop-customize-cluster-bootstrap/hdinsight-customize-cluster-bootstrap-arm.png" alt-text="Hadoop personaliza la plantilla de Azure Resource Manager de arranque del clúster":::

Ejemplo de fragmento de código de plantilla de Resource Manager para cambiar la configuración en spark2-defaults para limpiar periódicamente los registros de eventos del almacenamiento.  
...
* [Instalación y uso de Apache Giraph en clústeres de HDInsight](./hdinsight-hadoop-hue-linux.md).
