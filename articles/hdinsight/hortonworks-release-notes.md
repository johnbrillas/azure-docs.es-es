---
title: Notas de la versión de Hortonworks asociadas a las versiones de Azure HDInsight
...
## <a name="current-versions"></a>Versiones actuales
...
* [Componentes de Apache Hadoop en HDInsight](./hdinsight-component-versioning.md)
