...
- Un token de acceso de usuario. Consulte [Inicio rápido: Creación y administración de tokens de acceso](https://docs.microsoft.com/azure/communication-services/quickstarts/access-tokens?pivots=programming-language-javascript) o [Creación de un servicio de autenticación de confianza mediante Azure Functions](https://docs.microsoft.com/azure/communication-services/tutorials/trusted-service-tutorial) para obtener instrucciones.
...
Los desarrolladores de Windows pueden seguir el tutorial [Configuración del entorno de desarrollo de Node.js directamente en Windows](https://docs.microsoft.com/windows/nodejs/setup-on-windows) para configurar Node, nvm y npm. 
