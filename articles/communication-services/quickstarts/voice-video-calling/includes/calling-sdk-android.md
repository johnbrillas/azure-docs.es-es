...
La llamada entrante se puede obtener mediante la suscripción al evento `CallsUpdated` en el objeto `callAgent` y el recorrido en bucle por las llamadas agregadas:
