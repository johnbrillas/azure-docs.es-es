...
La actualización de los tokens de acceso es tan fácil como llamar a `issueToken` con la misma identidad que se usó para emitir los tokens. También debe proporcionar los `scopes` de los tokens actualizados. 
