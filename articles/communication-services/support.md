...
Si no encuentra una respuesta a su problema mediante la búsqueda, puede enviar una nueva pregunta a Microsoft Q&A. Al crear una pregunta, asegúrese de usar la [etiqueta de Azure Communication Services](https://docs.microsoft.com/answers/topics/azure-communication-services.html).
