...
* Actualmente no se admite el aislamiento de red para el almacén analítico de Azure Cosmos DB mediante puntos de conexión privados administrados en Azure Synapse Analytics.
