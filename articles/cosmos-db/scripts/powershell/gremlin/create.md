...
| [New-AzCosmosDBGremlinConflictResolutionPolicy](/powershell/module/az.cosmosdb/new-azcosmosdbgremlinconflictresolutionpolicy) | Crea una directiva de resolución de conflictos de escritura de Gremlin API. |
