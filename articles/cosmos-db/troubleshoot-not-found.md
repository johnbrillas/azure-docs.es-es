...
Se ha insertado un elemento en Cosmos DB con un [carácter no válido](/dotnet/api/microsoft.azure.documents.resource.id?preserve-view=true&view=azure-dotnet#remarks) en el identificador de elemento.
