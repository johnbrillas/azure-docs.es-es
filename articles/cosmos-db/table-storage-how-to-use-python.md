...
description: Almacene datos estructurados en la nube mediante Azure Table Storage o Table API de Azure Cosmos DB con Python.
...
Se recomienda que consulte la [referencia de la API del SDK de Azure Cosmos DB para Python](/python/api/overview/azure/cosmosdb) mientras trabaja con los escenarios de este ejemplo.
...
* Una [cuenta de Azure Storage](../storage/common/storage-account-create.md) o una [cuenta de Azure Cosmos DB](https://azure.microsoft.com/try/cosmosdb/).
...
> [!NOTE]
> El siguiente fragmento de código funciona solo con Azure Storage. Emulador de Storage no lo admite.
...
* [Uso de Python en Visual Studio (Windows)](/visualstudio/python/overview-of-python-tools-for-visual-studio)
