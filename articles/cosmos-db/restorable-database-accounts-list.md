---
title: Enumeración de cuentas de base de datos restaurables mediante la API REST de Azure Cosmos DB
description: Enumera todas las cuentas de base de datos de Azure Cosmos DB restaurables disponibles en una suscripción.
author: kanshiG
...
ms.locfileid: "99537584"
---
# <a name="list-restorable-database-accounts-using-azure-cosmos-db-rest-api"></a>Enumeración de cuentas de base de datos restaurables mediante la API REST de Azure Cosmos DB
...
| properties.restorableLocations |[RestorableLocationResource](#restorablelocationresource)[]| Lista de regiones desde las que se puede restaurar la cuenta de base de datos. |
...
* [Cuentas de base de datos restaurables: enumerar por ubicación](restorable-database-accounts-list-by-location.md).
