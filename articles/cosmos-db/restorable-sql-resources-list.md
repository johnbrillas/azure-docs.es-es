---
title: Lista de recursos de la API de SQL restaurables de Azure Cosmos DB mediante la API de REST
description: Devuelve una lista de las combinaciones de base de datos y contenedor que existen en la cuenta en la marca de tiempo y ubicación especificadas. Esto ayuda en escenarios para validar los recursos existentes en una marca de tiempo y ubicación determinadas.
author: kanshiG
...
ms.locfileid: "99537296"
---
# <a name="list-restorable-sql-api-resources-in-azure-cosmos-db-using-rest-api"></a>Lista de recursos de la API de SQL restaurables de Azure Cosmos DB mediante la API de REST
...
| --- | --- | --- |
| 200 OK | [RestorableSqlResourcesListResult](#restorablesqlresourceslistresult)| La operación se ha completado correctamente. |
...
|Definición  | Descripción| | --- || --- | | [DatabaseRestoreResource](#databaserestoreresource) | Bases de datos específicas que se van a restaurar. | | [DefaultErrorResponse](#defaulterrorresponse) | Respuesta de error del servicio. | | [ErrorResponse](#errorresponse) | Respuesta de error. | | [RestorableSqlResourcesListResult](#restorablesqlresourceslistresult) | Respuesta de la operación de lista que contiene los recursos de SQL restaurables. |
...
| **Nombre** | **Tipo** | **Descripción** |
| --- | --- | --- |
| collectionNames |string[]| Los nombres de las colecciones disponibles para restaurar. |
...
Respuesta de la operación de lista, que contiene los recursos de SQL restaurables.

| **Nombre** | **Tipo** | **Descripción** |
| --- | --- | --- |
| valor |[DatabaseRestoreResource](#databaserestoreresource)[]| Lista de recursos de SQL restaurables, incluidos los nombres de base de datos y colección. |

## <a name="next-steps"></a>Pasos siguientes

* [Enumerar bases de datos restaurables](restorable-sql-databases-list.md) en la API de Azure Cosmos SQL mediante la API de REST.
