---
title: Azure Cloud Services (soporte extendido) - Esquema NetworkTrafficRules definición de Azure Cloud Services | Microsoft Docs
description: Información relacionada con el esquema de sondeo del equilibrador de carga para Cloud Services (soporte extendido)
ms.topic: article
...
ms.locfileid: "98744095"
---
# <a name="azure-cloud-services-extended-support-definition-loadbalancerprobe-schema"></a>Esquema LoadBalancerProbe de definición de Azure Cloud Services (soporte extendido)
