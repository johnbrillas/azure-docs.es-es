...
## <a name="create-a-cloud-service-with-a-single-role-and-windows-azure-diagnostics-extension"></a>Creación de una instancia de Azure Cloud Services con un único rol y la extensión de Windows Azure Diagnostics
