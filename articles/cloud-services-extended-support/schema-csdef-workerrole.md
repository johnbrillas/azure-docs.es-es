...
description: Información relacionada con el esquema de rol de trabajo de Cloud Services (soporte extendido)
ms.topic: article
...
|vmsize|string|Opcional. Establezca este valor para cambiar el tamaño de la máquina virtual que se asigna a este rol. El valor predeterminado es `Small`. Para obtener una lista de tamaños posibles de máquina virtual y sus atributos, consulte los [tamaños de máquina virtual para Cloud Services](available-sizes.md).|
