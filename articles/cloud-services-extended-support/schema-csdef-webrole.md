---
title: Esquema de rol de trabajo (soporte extendido) de definición de Azure Cloud Services | Microsoft Docs
description: Información relacionada con el rol web de Cloud Services (soporte extendido)
ms.topic: article
...
ms.locfileid: "98744071"
---
# <a name="azure-cloud-services-extended-support-definition-webrole-schema"></a>Esquema de rol web de definición de Azure Cloud Services (soporte extendido)
...
|vmsize|string|Opcional. Establezca este valor para cambiar el tamaño de la máquina virtual que se asigna al rol. El valor predeterminado es `Small`. Para más información, consulte los [tamaños de máquina virtual para Cloud Services](available-sizes.md).|  
...
| Atributo | Tipo | Descripción |  
| --------- | ---- | ----------- |  
|xpath|string|Opcional. Ruta de acceso de ubicación de la configuración de implementación de la instancia. Para más información, vea las [variables de configuración con XPath](../cloud-services/cloud-services-role-config-xpath.md).<br /><br /> Debe incluir un atributo de valor o un elemento `RoleInstanceValue`.|  
