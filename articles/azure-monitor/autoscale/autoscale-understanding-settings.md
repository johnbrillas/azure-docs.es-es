...
| perfil | name | Nombre del perfil. Puede elegir cualquier nombre que le ayude a identificar el perfil. |
...
* [Introducción a la escalabilidad automática](./autoscale-overview.md)
