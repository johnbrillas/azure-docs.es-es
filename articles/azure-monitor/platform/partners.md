...
[Documentación de Circonus](https://docs.circonus.com/circonus/agents/cloud-agent/azure/)
...
[Integración de Grafana con Azure Monitor](./grafana-plugin.md)
...
[Integración del agente Telegraf de InfluxData con Azure Monitor](./collect-custom-metrics-linux-telegraf.md) 
...
[Documentación de signalfx](https://docs.signalfx.com/en/latest/getting-started/send-data.html#connect-to-azure)
...
- [Transmitir el registro de actividad a un servicio que no es de Microsoft](./activity-log.md#legacy-collection-methods)
- [Transmisión de los registros de recursos a un servicio que no es de Microsoft](./resource-logs.md#send-to-azure-event-hubs)
