...
Costo de exportación: se paga como se indica en la sección de registros de plataforma de la [página Precios de Azure Monitor.](https://azure.microsoft.com/pricing/details/monitor/) 
