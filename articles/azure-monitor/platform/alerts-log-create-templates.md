---
title: Creación de una alerta de registro con una plantilla de Azure Resource Manager | Microsoft Docs
description: Aprenda a usar una plantilla de Resource Manager para crear una alerta de registro.
author: yanivlavi
ms.author: yalavi
ms.topic: conceptual
ms.date: 09/22/2020
...
> [!IMPORTANT]
> Si usa una consulta entre recursos en la alerta de registros, el uso de [authorizedResources](/rest/api/monitor/scheduledqueryrules/createorupdate#source) es obligatorio y el usuario debe acceder a la lista de los recursos indicados.
