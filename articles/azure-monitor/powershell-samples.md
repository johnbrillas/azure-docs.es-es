...
`Get-AzAlertRule` es compatible con otros parámetros. Consulte [Get AlertRule](/previous-versions/azure/mt282459(v=azure.100)) para obtener más información.
