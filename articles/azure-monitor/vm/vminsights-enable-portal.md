...
- [Cree y configure un área de trabajo de Log Analytics](../insights/vminsights-configure-workspace.md). Como alternativa, puede crear un área de trabajo durante este proceso.
...
![Habilitar Azure Monitor para VM para una máquina virtual](media/vminsights-enable-portal/enable-vminsights-vm-portal.png)
...
![Habilitar el procesamiento de implementación de supervisión de Azure Monitor para VM](media/vminsights-enable-portal/onboard-vminsights-vm-portal-status.png)
