---
title: Ejemplos de conversión del diseñador de vistas de Azure Monitor en libros
description: Ejemplos de la transición desde vistas a libros en Azure Monitor.
author: austonli
ms.author: aul
ms.topic: conceptual
ms.date: 02/07/2020
...
ms.locfileid: "102043361"
---
# <a name="view-designer-conversion-examples"></a>Ejemplos de conversión del diseñador de vistas

Para replicar el libro con pestañas del diseñador de vistas, copie y pegue el código siguiente en el Editor avanzado, indicado por el símbolo </> en la barra de herramientas.

![Barra de herramientas Editor avanzado](media/view-designer-conversion-examples/toolbar.png)

Es posible que los usuarios tengan que actualizar la configuración de consulta y las suscripciones a sus propios recursos accesibles
