...
Actualmente no hay ninguna interfaz de usuario en el portal para crear recursos de plantillas de libro; la única manera de crearlos es [a través de implementaciones de plantilla de Azure Resource Manager (plantilla de Resource Manager)](../visualize/workbooks-automate.md). Por eso, la manera más fácil de trasladar una plantilla es reutilizar la plantilla de ARM anterior y actualizarla para que se implemente en la nueva región.
