...
Configure los contadores de rendimiento en el [menú Datos en Configuración avanzada](../agents/agent-data-sources.md#configuring-data-sources) para el área de trabajo de Log Analytics.
