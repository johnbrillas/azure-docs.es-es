...
![Introducción a Logic Apps](media/logs-export-logic-app/logic-app-overview.png)
...
![Selección de la actividad Analizar JSON](media/logs-export-logic-app/select-parse-json.png)
