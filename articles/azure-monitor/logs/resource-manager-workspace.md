...
En el ejemplo siguiente, se agrega una recopilación de [eventos de Windows](../agents/data-sources-windows-events.md) a un área de trabajo existente.
...
En el ejemplo siguiente, se agrega una recopilación de [eventos de syslog](../agents/data-sources-syslog.md) a un área de trabajo existente.
...
En el ejemplo siguiente, se agrega una recopilación de [contadores de rendimiento de Windows](../agents/data-sources-performance-counters.md) a un área de trabajo existente.
...
En el ejemplo siguiente, se agrega una recopilación de [contadores de rendimiento de Linux](../agents/data-sources-performance-counters.md) a un área de trabajo existente.
...
En el ejemplo siguiente, se agrega una recopilación de [registros personalizados](../agents/data-sources-custom-logs.md) a un área de trabajo existente.
...
En el ejemplo siguiente, se agrega una recopilación de [registros de IIS](../agents/data-sources-iis-logs.md) a un área de trabajo existente.
