...
1. Descargue el [archivo YAML ConfigMap de plantilla](https://aka.ms/container-azm-ms-agentconfig) y guárdelo como container-azm-ms-agentconfig.yaml. 
