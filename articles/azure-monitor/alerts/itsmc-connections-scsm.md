...
2. En **ORÍGENES DE DATOS DEL ÁREA DE TRABAJO**, haga clic en **Conexiones de ITSM**.
    ...
    ![Nueva conexión](media/itsmc-connections-scsm/add-new-itsm-connection.png)
...
![Conexión de Service Manager](media/itsmc-connections-scsm/service-manager-connection.png)
...
3. En **Conexiones híbridas**, haga clic en **Configure los puntos de conexión de la conexión híbrida**.
    ...
    ![Redes de conexión híbrida](media/itsmc-connections-scsm/itsmc-hybrid-connection-networking-and-end-points.png)
4. En la hoja **Conexiones híbridas**, haga clic en **Agregar conexión híbrida**.

    ![Adición de conexión híbrida](media/itsmc-connections-scsm/itsmc-new-hybrid-connection-add.png)

5. En la hoja **Agregar conexiones híbridas**, haga clic en **Crear conexión híbrida nueva**.

    ![Conexión híbrida nueva](media/itsmc-connections-scsm/itsmc-create-new-hybrid-connection.png)
...
6. Escriba los valores siguientes:
   ...
   - **Name**: especifique un nombre para la instancia de Service Bus si lo está creando.
     ...
     ![Valores de la conexión híbrida](media/itsmc-connections-scsm/itsmc-new-hybrid-connection-values.png)
...
7. Cuando se crea la conexión híbrida, seleccione la conexión y haga clic en **Agregar conexión híbrida seleccionada**.
    ...
    ![Conexión híbrida nueva](media/itsmc-connections-scsm/itsmc-new-hybrid-connection-added.png)
...
![conexión híbrida correcta](media/itsmc-connections-scsm/itsmc-hybrid-connection-listener-set-up-successful.png)
> [!NOTE]
> 
...
![Prueba de conexión híbrida](media/itsmc-connections-scsm/itsmc-hybrid-connection-test.png)
