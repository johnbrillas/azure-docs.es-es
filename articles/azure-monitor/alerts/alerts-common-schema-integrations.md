...
* Configuración de reglas de alerta ([métrica](../alerts/alerts-metric.md), [registro](./alerts-log.md), [registro de actividad](./alerts-activity-log.md))
