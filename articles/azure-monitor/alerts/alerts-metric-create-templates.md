...
3. Para el parámetro `metricName`, consulte las métricas disponibles en [Métricas compatibles de Azure Monitor](../platform/metrics-supported.md).
