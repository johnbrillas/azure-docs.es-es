---
title: Ejemplos de plantillas de Resource Manager para áreas de trabajo de Log Analytics
description: Plantillas de ejemplo de Azure Resource Manager para implementar áreas de trabajo de Log Analytics y configurar orígenes de datos en Azure Monitor.
ms.subservice: logs
ms.topic: sample
author: bwren
ms.author: bwren
...
## <a name="collect-windows-events"></a>Recopilación de eventos de Windows
En el ejemplo siguiente, se agrega una recopilación de [eventos de Windows](../platform/data-sources-windows-events.md) a un área de trabajo existente.
...
## <a name="collect-syslog"></a>Recopilación de syslog
En el ejemplo siguiente, se agrega una recopilación de [eventos de syslog](../platform/data-sources-syslog.md) a un área de trabajo existente.
...
## <a name="collect-windows-performance-counters"></a>Recopilación de contadores de rendimiento de Windows
En el ejemplo siguiente, se agrega una recopilación de [contadores de rendimiento de Windows](../platform/data-sources-performance-counters.md) a un área de trabajo existente.
...
## <a name="collect-linux-performance-counters"></a>Recopilación de contadores de rendimiento de Linux
En el ejemplo siguiente, se agrega una recopilación de [contadores de rendimiento de Linux](../platform/data-sources-performance-counters.md) a un área de trabajo existente.
...
## <a name="collect-custom-logs"></a>Recopilación de registros personalizados
En el ejemplo siguiente, se agrega una recopilación de [registros personalizados](../platform/data-sources-custom-logs.md) a un área de trabajo existente.

### <a name="notes"></a>Notas

- La configuración de delimitadores y extracciones puede resultar compleja. Para obtener ayuda, puede definir un registro personalizado mediante Azure Portal y, después, recuperar su configuración mediante [Get-AzOperationalInsightsDataSource](/powershell/module/az.operationalinsights/get-azoperationalinsightsdatasource) con **Tipo** establecido en **CustomLog**.
...
## <a name="collect-iis-log"></a>Recopilación de registros de IIS
En el ejemplo siguiente, se agrega una recopilación de [registros de IIS](../platform/data-sources-iis-logs.md) a un área de trabajo existente.
...
* [Más información sobre las áreas de trabajo de Log Analytics](../learn/quick-create-workspace.md).
* [Más información sobre los orígenes de datos de agente](../platform/agent-data-sources.md).
