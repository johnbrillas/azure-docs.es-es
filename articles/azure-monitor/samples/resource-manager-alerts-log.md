...
Este artículo incluye ejemplos de [plantillas de Azure Resource Manager](../../azure-resource-manager/templates/template-syntax.md) para crear y configurar alertas de consulta de registros en Azure Monitor. Cada ejemplo incluye un archivo de plantilla y un archivo de parámetros con valores de ejemplo para la plantilla.
...
En el ejemplo siguiente se crea una [regla de alerta para número de resultados](../platform/alerts-unified-log.md#count-of-the-results-table-rows).

### <a name="notes"></a>Notas

- En este ejemplo se incluye una [carga de webhook](../platform/alerts-log-webhook.md). Si la regla de alerta no debe desencadenar un webhook, quite el elemento **customWebhookPayload**.
...
En el ejemplo siguiente se crea una [regla de alerta de medición de métricas](../platform/alerts-unified-log.md#calculation-of-measure-based-on-a-numeric-column-such-as-cpu-counter-value).
...
## <a name="template-for-all-resource-types-from-version-2020-05-01-preview"></a>Plantilla para todo tipo de recursos (a partir de la versión 2020-05-01-preview)
...
* [Más información sobre reglas de alertas](../platform/alerts-overview.md).
