...
## <a name="diagnostic-setting-for-recovery-services-vault"></a>Configuración de diagnóstico para el almacén de Recovery Services
En el ejemplo siguiente se crea una configuración de diagnóstico para un almacén de Azure Recovery Services; para ello, se agrega a la plantilla un recurso de tipo `microsoft.recoveryservices/vaults/providers/diagnosticSettings`. Este ejemplo especifica el modo de recopilación tal como se describe en [Registros de recursos de Azure](../platform/resource-logs.md#send-to-log-analytics-workspace). Especifique `Dedicated` o `AzureDiagnostics` para la propiedad `logAnalyticsDestinationType`.
...
## <a name="diagnostic-setting-for-log-analytics-workspace"></a>Configuración de diagnóstico para el área de trabajo de Log Analytics
En el ejemplo siguiente se crea una configuración de diagnóstico para un área de trabajo de Log Analytics mediante la adición de un recurso de tipo `Microsoft.OperationalInsights/workspaces/providers/diagnosticSettings` a la plantilla. Este ejemplo envía datos de auditoría sobre las consultas ejecutadas en el área de trabajo a la misma área de trabajo.
...
## <a name="diagnostic-setting-for-azure-storage"></a>Configuración de diagnóstico para Azure Storage
En el ejemplo siguiente se crea una configuración de diagnóstico para cada punto de conexión de servicio de almacenamiento que está disponible en la cuenta de almacenamiento. Se aplica una configuración a cada servicio de almacenamiento individual que está disponible en la cuenta. Los servicios de almacenamiento que están disponibles dependen del tipo de cuenta de almacenamiento. Esta plantilla crea una configuración de diagnóstico para un servicio de almacenamiento en la cuenta solo si este existe para la cuenta. Para cada servicio disponible, la configuración de diagnóstico habilita las métricas de transacciones y la recopilación de registros de recursos para las operaciones de lectura, escritura y eliminación.
