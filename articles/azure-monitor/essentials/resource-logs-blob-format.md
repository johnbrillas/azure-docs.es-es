...
* Este cambio afecta a los tipos de datos siguientes:
  ...
  * [Métricas de recursos de Azure que se exportan mediante la configuración de diagnóstico](../essentials/diagnostic-settings.md).
...
![Hoja Registros de diagnóstico de Azure Monitor](media/resource-logs-blob-format/portal-diag-settings.png)
...
![Cuenta de almacenamiento habilitada](media/resource-logs-blob-format/portal-storage-enabled.png)
