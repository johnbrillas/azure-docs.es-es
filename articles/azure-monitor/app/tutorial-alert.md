...
Cree un [recurso de Application Insights](../app/create-new-resource.md).
...
6. Seleccione que el valor de ubicaciones con error sea mayor o igual a 3. Cree un [grupo de acciones](../alerts/action-groups.md) para configurar quiénes reciben notificaciones al superarse el umbral de alerta.
