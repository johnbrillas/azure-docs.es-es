...
En el caso de Python, se puede usar [Procesadores de telemetría de Python para OpenCensus](api-filtering-sampling.md#opencensus-python-telemetry-processors).
