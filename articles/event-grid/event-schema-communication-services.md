...
| Título | Descripción |
| --- | --- |
| [Cómo controlar eventos SMS en Communication Services](../communication-services/quickstarts/telephony-sms/handle-sms-events.md) | Control de todos los eventos SMS que recibe Communication Services mediante WebHook. |
...
| Título | Descripción |
|---------|---------|
| [Inicio rápido: Control de eventos SMS](../communication-services/quickstarts/telephony-sms/handle-sms-events.md) | Muestra cómo suscribirse a eventos SMS mediante Event Grid.   |
