...
En la mayoría de los casos no es necesario crear un recurso de conexión, ya que se crea con la creación de una [cuenta de ejecución](automation-security-overview.md).
